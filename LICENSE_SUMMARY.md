...
* If you use AdvancedDLSupport outside of direct use via OpenTK<sup>[<a href="LICENSE_GRANT.pdf">2</a>]</sup>, follow its license<sup>[<a href="https://github.com/Firwood-Software/AdvanceDLSupport/blob/master/LICENSE">3</a>]</sup> (LGPLv3).
