...
module Vector3d =
    ...
    module Multiplication =
        ...
        [<Property>]
        let ``Matrix4x3d-Vector3d multiplication is the same as vector/column multiplication and summation`` (a : Matrix4x3d, b : Vector3d) =
            let res = a * b
            let c1 = b.X * a.M11 + b.Y * a.M12 + b.Z * a.M13
            let c2 = b.X * a.M21 + b.Y * a.M22 + b.Z * a.M23
        ...
        [<Property>]
        let ``Matrix4x3-Vector3 multiplication is consistent across overloads`` (a : Matrix4x3d, b : Vector3d) =
            let r1 = a * b;
            let r2 = Vector3d.TransformFourDimensionsColumn(a, b);
            let r3 = Vector3d.TransformFourDimensionsColumn(&a, &b);
