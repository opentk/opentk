...
module Vector2d =
    ...
    module Multiplication =
        ...
        let ``Vector2d-Matrix2x3d multiplication is consistent across overloads`` (a : Matrix2x3d, b : Vector2d) =
            let r1 = b * a;
            let r2 = Vector2d.TransformThreeDimensions(b, a);
            let r3 = Vector2d.TransformThreeDimensions(&b, &a);
        ...
        let ``Vector2d-Matrix2x4d multiplication is consistent across overloads`` (a : Matrix2x4d, b : Vector2d) =
            let r1 = b * a;
            let r2 = Vector2d.TransformFourDimensions(b, a);
            let r3 = Vector2d.TransformFourDimensions(&b, &a);
