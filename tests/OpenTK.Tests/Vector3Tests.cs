...
namespace OpenTK.Tests
{
    public class Vector3Tests
    {
        ...
        public void Vector3_Index_NegativeExceptin()
        {
            ...
            Assert.True(negativeIndexExceptionFound);
        }
        ...
        public void Vector3_Index_LargeIndexExceptin()
        {
            ...
            Assert.True(largeIndexExceptionFound);
        }
        ...
        public void Vector3_Length()
        {
            ...
            Assert.Equal((float)System.Math.Sqrt(X * X + Y * Y + Z * Z), U.Length);
        }
        ...
        public void Vector3_LengthFast()
        {
            float X = 1, Y = 2, Z = 2;
            Vector3 U = new Vector3(X, Y, Z);
            Assert.Equal(1.0f / MathHelper.InverseSqrtFast(X * X + Y * Y + Z * Z), U.LengthFast);
        }
        ...
        public void Vector3_Normalized()
        {
            ...
            Assert.Equal(U.X / length, V.X);
            Assert.Equal(U.Y / length, V.Y);
            Assert.Equal(U.Z / length, V.Z);
        }
        ...
        public void Vector3_NormalizeFast_Instance()
        {
            ...
            Assert.Equal(U.X * scale, V.X);
            Assert.Equal(U.Y * scale, V.Y);
            Assert.Equal(U.Z * scale, V.Z);
        }
        ...
        public void Vector3_Add()
        {
            ...
            Assert.Equal(T.X + U.X, V.X);
            Assert.Equal(T.Y + U.Y, V.Y);
            Assert.Equal(T.Z + U.Z, V.Z);
        }
        ...
        public void Vector3_Multiply_Scalar()
        {
            ...
            Assert.Equal(U.X * scalar, V.X);
            Assert.Equal(U.Y * scalar, V.Y);
            Assert.Equal(U.Z * scalar, V.Z);
        }
        ...
        public void Vector3_Divide_Scalar()
        {
            ...
            Assert.True(Math.Abs((U.X / scalar) - V.X) < 1e-5);
            Assert.True(Math.Abs((U.Y / scalar) - V.Y) < 1e-5);
            Assert.True(Math.Abs((U.Z / scalar) - V.Z) < 1e-5);
        }
        ...
        public void Vector3_Normalize()
        {
            ...
            float length = U.Length;
            Assert.True(Math.Abs((U.X / length) - V.X) < 1e-5);
            Assert.True(Math.Abs((U.Y / length) - V.Y) < 1e-5);
            Assert.True(Math.Abs((U.Z / length) - V.Z) < 1e-5);
        }
