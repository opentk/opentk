...
module Vector2 =
    ...
    module Multiplication =
        ...
        let ``Vector2-Matrix2x3 multiplication is consistent across overloads`` (a : Matrix2x3, b : Vector2) =
            let r1 = b * a;
            let r2 = Vector2.TransformThreeDimensions(b, a);
            let r3 = Vector2.TransformThreeDimensions(&b, &a);
        ...
        let ``Vector2-Matrix2x4 multiplication is consistent across overloads`` (a : Matrix2x4, b : Vector2) =
            let r1 = b * a;
            let r2 = Vector2.TransformFourDimensions(b, a);
            let r3 = Vector2.TransformFourDimensions(&b, &a);
