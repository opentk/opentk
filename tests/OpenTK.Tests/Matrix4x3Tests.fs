...
module Matrix4x3 =
    ...
    module Multiplication =
        //
        [<Property>]
        let ``Matrix4x3-Matrix3x2 multiplication is done by row/column multiplication and summation`` (a, b, c, d, e, f, g, h, i, j, k, l) =
            let A = Matrix4x3(a, b, c, d, e, f, g, h, i, j, k, l)
            let B = Matrix3x2(a, b, c, d, e, f)
        ...
        [<Property>]
        let ``Matrix4x3-Matrix3 is done by row/column multiplication and summation`` (a, b, c, d, e, f, g, h, i, j, k, l) =
            let A = Matrix4x3(a, b, c, d, e, f, g, h, i, j, k, l)
