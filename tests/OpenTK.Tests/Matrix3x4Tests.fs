...
module Matrix3x4 =
    ...
    module Multiplication =
        //
        [<Property>]
        let ``Matrix3x4-Matrix4x2 multiplication is done by row/column multiplication and summation`` (a, b, c, d, e, f, g, h, i, j, k, l) =
            let A = Matrix3x4(a, b, c, d, e, f, g, h, i, j, k, l)
