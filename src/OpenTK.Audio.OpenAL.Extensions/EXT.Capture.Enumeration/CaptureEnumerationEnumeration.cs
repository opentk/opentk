...
using OpenTK.Audio.OpenAL.Extensions.EXT.Capture.Enumeration;

namespace OpenTK.Audio.OpenAL.Extensions.Enumeration
{
    /// <summary>
    ...
    public abstract class CaptureEnumerationEnumeration : ContextExtensionBase, ICaptureEnumerationContextState
    {
        ...
        /// <inheritdoc cref="GetStringList(OpenTK.OpenAL.Device*,OpenTK.Audio.OpenAL.Extensions.EXT.Capture.Enumeration.GetCaptureContextStringList)"/>
