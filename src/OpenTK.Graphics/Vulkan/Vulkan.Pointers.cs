...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public static unsafe partial class VkPointers
    {
        ...
        public static delegate* unmanaged<VkDevice, VkImage, int, VkSemaphore, VkFence, VkResult> _vkAcquireImageOHOS_fnptr = &vkAcquireImageOHOS_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkAcquireImageOHOS_Lazy(VkDevice device, VkImage image, int nativeFenceFd, VkSemaphore semaphore, VkFence fence)
        {
            _vkAcquireImageOHOS_fnptr = (delegate* unmanaged<VkDevice, VkImage, int, VkSemaphore, VkFence, VkResult>)VKLoader.GetInstanceProcAddress("vkAcquireImageOHOS");
        ...
        public static delegate* unmanaged<VkDevice, uint, VkBindBufferMemoryInfo*, VkResult> _vkBindBufferMemory2KHR_fnptr = &vkBindBufferMemory2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkBindBufferMemory2KHR_Lazy(VkDevice device, uint bindInfoCount, VkBindBufferMemoryInfo* pBindInfos)
        {
            _vkBindBufferMemory2KHR_fnptr = (delegate* unmanaged<VkDevice, uint, VkBindBufferMemoryInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkBindBufferMemory2KHR");
            return _vkBindBufferMemory2KHR_fnptr(device, bindInfoCount, pBindInfos);
        }
        public static delegate* unmanaged<VkDevice, uint, VkBindDataGraphPipelineSessionMemoryInfoARM*, VkResult> _vkBindDataGraphPipelineSessionMemoryARM_fnptr = &vkBindDataGraphPipelineSessionMemoryARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkBindDataGraphPipelineSessionMemoryARM_Lazy(VkDevice device, uint bindInfoCount, VkBindDataGraphPipelineSessionMemoryInfoARM* pBindInfos)
        {
            _vkBindDataGraphPipelineSessionMemoryARM_fnptr = (delegate* unmanaged<VkDevice, uint, VkBindDataGraphPipelineSessionMemoryInfoARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkBindDataGraphPipelineSessionMemoryARM");
        ...
        public static delegate* unmanaged<VkDevice, uint, VkBindImageMemoryInfo*, VkResult> _vkBindImageMemory2KHR_fnptr = &vkBindImageMemory2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkBindImageMemory2KHR_Lazy(VkDevice device, uint bindInfoCount, VkBindImageMemoryInfo* pBindInfos)
        {
            _vkBindImageMemory2KHR_fnptr = (delegate* unmanaged<VkDevice, uint, VkBindImageMemoryInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkBindImageMemory2KHR");
        ...
        public static delegate* unmanaged<VkDevice, uint, VkBindTensorMemoryInfoARM*, VkResult> _vkBindTensorMemoryARM_fnptr = &vkBindTensorMemoryARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkBindTensorMemoryARM_Lazy(VkDevice device, uint bindInfoCount, VkBindTensorMemoryInfoARM* pBindInfos)
        {
            _vkBindTensorMemoryARM_fnptr = (delegate* unmanaged<VkDevice, uint, VkBindTensorMemoryInfoARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkBindTensorMemoryARM");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkBeginCustomResolveInfoEXT*, void> _vkCmdBeginCustomResolveEXT_fnptr = &vkCmdBeginCustomResolveEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBeginCustomResolveEXT_Lazy(VkCommandBuffer commandBuffer, VkBeginCustomResolveInfoEXT* pBeginCustomResolveInfo)
        {
            _vkCmdBeginCustomResolveEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBeginCustomResolveInfoEXT*, void>)VKLoader.GetInstanceProcAddress("vkCmdBeginCustomResolveEXT");
        ...
        {
            _vkCmdBeginPerTileExecutionQCOM_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPerTileBeginInfoQCOM*, void>)VKLoader.GetInstanceProcAddress("vkCmdBeginPerTileExecutionQCOM");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingInfo*, void> _vkCmdBeginRenderingKHR_fnptr = &vkCmdBeginRenderingKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBeginRenderingKHR_Lazy(VkCommandBuffer commandBuffer, VkRenderingInfo* pRenderingInfo)
        {
            _vkCmdBeginRenderingKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdBeginRenderingKHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkRenderPassBeginInfo*, VkSubpassBeginInfo*, void> _vkCmdBeginRenderPass2KHR_fnptr = &vkCmdBeginRenderPass2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBeginRenderPass2KHR_Lazy(VkCommandBuffer commandBuffer, VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassBeginInfo* pSubpassBeginInfo)
        {
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkBindDescriptorSetsInfo*, void> _vkCmdBindDescriptorSets2_fnptr = &vkCmdBindDescriptorSets2_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBindDescriptorSets2_Lazy(VkCommandBuffer commandBuffer, VkBindDescriptorSetsInfo* pBindDescriptorSetsInfo)
        {
            _vkCmdBindDescriptorSets2_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBindDescriptorSetsInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdBindDescriptorSets2");
            _vkCmdBindDescriptorSets2_fnptr(commandBuffer, pBindDescriptorSetsInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkBindDescriptorSetsInfo*, void> _vkCmdBindDescriptorSets2KHR_fnptr = &vkCmdBindDescriptorSets2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBindDescriptorSets2KHR_Lazy(VkCommandBuffer commandBuffer, VkBindDescriptorSetsInfo* pBindDescriptorSetsInfo)
        {
            _vkCmdBindDescriptorSets2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBindDescriptorSetsInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdBindDescriptorSets2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, ulong, VkIndexType, void> _vkCmdBindIndexBuffer2_fnptr = &vkCmdBindIndexBuffer2_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBindIndexBuffer2_Lazy(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, ulong size, VkIndexType indexType)
        {
            _vkCmdBindIndexBuffer2_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, ulong, VkIndexType, void>)VKLoader.GetInstanceProcAddress("vkCmdBindIndexBuffer2");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkTileMemoryBindInfoQCOM*, void> _vkCmdBindTileMemoryQCOM_fnptr = &vkCmdBindTileMemoryQCOM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBindTileMemoryQCOM_Lazy(VkCommandBuffer commandBuffer, VkTileMemoryBindInfoQCOM* pTileMemoryBindInfo)
        {
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, uint, VkBuffer*, ulong*, ulong*, ulong*, void> _vkCmdBindVertexBuffers2EXT_fnptr = &vkCmdBindVertexBuffers2EXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBindVertexBuffers2EXT_Lazy(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, ulong* pOffsets, ulong* pSizes, ulong* pStrides)
        {
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkBlitImageInfo2*, void> _vkCmdBlitImage2KHR_fnptr = &vkCmdBlitImage2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBlitImage2KHR_Lazy(VkCommandBuffer commandBuffer, VkBlitImageInfo2* pBlitImageInfo)
        {
            _vkCmdBlitImage2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBlitImageInfo2*, void>)VKLoader.GetInstanceProcAddress("vkCmdBlitImage2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkClusterAccelerationStructureCommandsInfoNV*, void> _vkCmdBuildClusterAccelerationStructureIndirectNV_fnptr = &vkCmdBuildClusterAccelerationStructureIndirectNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBuildClusterAccelerationStructureIndirectNV_Lazy(VkCommandBuffer commandBuffer, VkClusterAccelerationStructureCommandsInfoNV* pCommandInfos)
        {
            _vkCmdBuildClusterAccelerationStructureIndirectNV_fnptr = (delegate* unmanaged<VkCommandBuffer, VkClusterAccelerationStructureCommandsInfoNV*, void>)VKLoader.GetInstanceProcAddress("vkCmdBuildClusterAccelerationStructureIndirectNV");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkBuildPartitionedAccelerationStructureInfoNV*, void> _vkCmdBuildPartitionedAccelerationStructuresNV_fnptr = &vkCmdBuildPartitionedAccelerationStructuresNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdBuildPartitionedAccelerationStructuresNV_Lazy(VkCommandBuffer commandBuffer, VkBuildPartitionedAccelerationStructureInfoNV* pBuildInfo)
        {
            _vkCmdBuildPartitionedAccelerationStructuresNV_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBuildPartitionedAccelerationStructureInfoNV*, void>)VKLoader.GetInstanceProcAddress("vkCmdBuildPartitionedAccelerationStructuresNV");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, VkConvertCooperativeVectorMatrixInfoNV*, void> _vkCmdConvertCooperativeVectorMatrixNV_fnptr = &vkCmdConvertCooperativeVectorMatrixNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdConvertCooperativeVectorMatrixNV_Lazy(VkCommandBuffer commandBuffer, uint infoCount, VkConvertCooperativeVectorMatrixInfoNV* pInfos)
        {
            _vkCmdConvertCooperativeVectorMatrixNV_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, VkConvertCooperativeVectorMatrixInfoNV*, void>)VKLoader.GetInstanceProcAddress("vkCmdConvertCooperativeVectorMatrixNV");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCopyBufferInfo2*, void> _vkCmdCopyBuffer2KHR_fnptr = &vkCmdCopyBuffer2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdCopyBuffer2KHR_Lazy(VkCommandBuffer commandBuffer, VkCopyBufferInfo2* pCopyBufferInfo)
        {
            _vkCmdCopyBuffer2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCopyBufferInfo2*, void>)VKLoader.GetInstanceProcAddress("vkCmdCopyBuffer2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCopyBufferToImageInfo2*, void> _vkCmdCopyBufferToImage2KHR_fnptr = &vkCmdCopyBufferToImage2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdCopyBufferToImage2KHR_Lazy(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2* pCopyBufferToImageInfo)
        {
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCopyImageInfo2*, void> _vkCmdCopyImage2KHR_fnptr = &vkCmdCopyImage2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdCopyImage2KHR_Lazy(VkCommandBuffer commandBuffer, VkCopyImageInfo2* pCopyImageInfo)
        {
            _vkCmdCopyImage2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCopyImageInfo2*, void>)VKLoader.GetInstanceProcAddress("vkCmdCopyImage2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCopyImageToBufferInfo2*, void> _vkCmdCopyImageToBuffer2KHR_fnptr = &vkCmdCopyImageToBuffer2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdCopyImageToBuffer2KHR_Lazy(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2* pCopyImageToBufferInfo)
        {
        ...
        {
            _vkCmdCopyMemoryIndirectKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCopyMemoryIndirectInfoKHR*, void>)VKLoader.GetInstanceProcAddress("vkCmdCopyMemoryIndirectKHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCopyMemoryToImageIndirectInfoKHR*, void> _vkCmdCopyMemoryToImageIndirectKHR_fnptr = &vkCmdCopyMemoryToImageIndirectKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdCopyMemoryToImageIndirectKHR_Lazy(VkCommandBuffer commandBuffer, VkCopyMemoryToImageIndirectInfoKHR* pCopyMemoryToImageIndirectInfo)
        {
            _vkCmdCopyMemoryToImageIndirectKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCopyMemoryToImageIndirectInfoKHR*, void>)VKLoader.GetInstanceProcAddress("vkCmdCopyMemoryToImageIndirectKHR");
        ...
        [UnmanagedCallersOnly]
        private static void vkCmdCopyTensorARM_Lazy(VkCommandBuffer commandBuffer, VkCopyTensorInfoARM* pCopyTensorInfo)
        {
            _vkCmdCopyTensorARM_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCopyTensorInfoARM*, void>)VKLoader.GetInstanceProcAddress("vkCmdCopyTensorARM");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkDecompressMemoryInfoEXT*, void> _vkCmdDecompressMemoryEXT_fnptr = &vkCmdDecompressMemoryEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDecompressMemoryEXT_Lazy(VkCommandBuffer commandBuffer, VkDecompressMemoryInfoEXT* pDecompressMemoryInfoEXT)
        {
            _vkCmdDecompressMemoryEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkDecompressMemoryInfoEXT*, void>)VKLoader.GetInstanceProcAddress("vkCmdDecompressMemoryEXT");
            _vkCmdDecompressMemoryEXT_fnptr(commandBuffer, pDecompressMemoryInfoEXT);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkMemoryDecompressionMethodFlagBitsEXT, ulong, ulong, uint, uint, void> _vkCmdDecompressMemoryIndirectCountEXT_fnptr = &vkCmdDecompressMemoryIndirectCountEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDecompressMemoryIndirectCountEXT_Lazy(VkCommandBuffer commandBuffer, VkMemoryDecompressionMethodFlagBitsEXT decompressionMethod, ulong indirectCommandsAddress, ulong indirectCommandsCountAddress, uint maxDecompressionCount, uint stride)
        {
            _vkCmdDecompressMemoryIndirectCountEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkMemoryDecompressionMethodFlagBitsEXT, ulong, ulong, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdDecompressMemoryIndirectCountEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, uint, uint, uint, uint, uint, void> _vkCmdDispatchBaseKHR_fnptr = &vkCmdDispatchBaseKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDispatchBaseKHR_Lazy(VkCommandBuffer commandBuffer, uint baseGroupX, uint baseGroupY, uint baseGroupZ, uint groupCountX, uint groupCountY, uint groupCountZ)
        {
            _vkCmdDispatchBaseKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, uint, uint, uint, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdDispatchBaseKHR");
            _vkCmdDispatchBaseKHR_fnptr(commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkDataGraphPipelineSessionARM, VkDataGraphPipelineDispatchInfoARM*, void> _vkCmdDispatchDataGraphARM_fnptr = &vkCmdDispatchDataGraphARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDispatchDataGraphARM_Lazy(VkCommandBuffer commandBuffer, VkDataGraphPipelineSessionARM session, VkDataGraphPipelineDispatchInfoARM* pInfo)
        {
            _vkCmdDispatchDataGraphARM_fnptr = (delegate* unmanaged<VkCommandBuffer, VkDataGraphPipelineSessionARM, VkDataGraphPipelineDispatchInfoARM*, void>)VKLoader.GetInstanceProcAddress("vkCmdDispatchDataGraphARM");
            _vkCmdDispatchDataGraphARM_fnptr(commandBuffer, session, pInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, ulong, ulong, VkDispatchGraphCountInfoAMDX*, void> _vkCmdDispatchGraphAMDX_fnptr = &vkCmdDispatchGraphAMDX_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDispatchGraphAMDX_Lazy(VkCommandBuffer commandBuffer, ulong scratch, ulong scratchSize, VkDispatchGraphCountInfoAMDX* pCountInfo)
        {
            _vkCmdDispatchGraphAMDX_fnptr = (delegate* unmanaged<VkCommandBuffer, ulong, ulong, VkDispatchGraphCountInfoAMDX*, void>)VKLoader.GetInstanceProcAddress("vkCmdDispatchGraphAMDX");
            _vkCmdDispatchGraphAMDX_fnptr(commandBuffer, scratch, scratchSize, pCountInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, ulong, ulong, VkDispatchGraphCountInfoAMDX*, void> _vkCmdDispatchGraphIndirectAMDX_fnptr = &vkCmdDispatchGraphIndirectAMDX_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDispatchGraphIndirectAMDX_Lazy(VkCommandBuffer commandBuffer, ulong scratch, ulong scratchSize, VkDispatchGraphCountInfoAMDX* pCountInfo)
        {
            _vkCmdDispatchGraphIndirectAMDX_fnptr = (delegate* unmanaged<VkCommandBuffer, ulong, ulong, VkDispatchGraphCountInfoAMDX*, void>)VKLoader.GetInstanceProcAddress("vkCmdDispatchGraphIndirectAMDX");
            _vkCmdDispatchGraphIndirectAMDX_fnptr(commandBuffer, scratch, scratchSize, pCountInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, ulong, ulong, ulong, void> _vkCmdDispatchGraphIndirectCountAMDX_fnptr = &vkCmdDispatchGraphIndirectCountAMDX_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDispatchGraphIndirectCountAMDX_Lazy(VkCommandBuffer commandBuffer, ulong scratch, ulong scratchSize, ulong countInfo)
        {
            _vkCmdDispatchGraphIndirectCountAMDX_fnptr = (delegate* unmanaged<VkCommandBuffer, ulong, ulong, ulong, void>)VKLoader.GetInstanceProcAddress("vkCmdDispatchGraphIndirectCountAMDX");
        ...
        {
            _vkCmdDispatchTileQCOM_fnptr = (delegate* unmanaged<VkCommandBuffer, VkDispatchTileInfoQCOM*, void>)VKLoader.GetInstanceProcAddress("vkCmdDispatchTileQCOM");
        ...
        [UnmanagedCallersOnly]
        private static void vkCmdDrawIndexedIndirectCountAMD_Lazy(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, VkBuffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride)
        {
            _vkCmdDrawIndexedIndirectCountAMD_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, VkBuffer, ulong, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdDrawIndexedIndirectCountAMD");
            _vkCmdDrawIndexedIndirectCountAMD_fnptr(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, VkBuffer, ulong, uint, uint, void> _vkCmdDrawIndexedIndirectCountKHR_fnptr = &vkCmdDrawIndexedIndirectCountKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDrawIndexedIndirectCountKHR_Lazy(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, VkBuffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride)
        {
            _vkCmdDrawIndexedIndirectCountKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, VkBuffer, ulong, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdDrawIndexedIndirectCountKHR");
        ...
        [UnmanagedCallersOnly]
        private static void vkCmdDrawIndirectCountAMD_Lazy(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, VkBuffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride)
        {
            _vkCmdDrawIndirectCountAMD_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, VkBuffer, ulong, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdDrawIndirectCountAMD");
            _vkCmdDrawIndirectCountAMD_fnptr(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, VkBuffer, ulong, uint, uint, void> _vkCmdDrawIndirectCountKHR_fnptr = &vkCmdDrawIndirectCountKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdDrawIndirectCountKHR_Lazy(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, VkBuffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride)
        {
            _vkCmdDrawIndirectCountKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkBuffer, ulong, VkBuffer, ulong, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdDrawIndirectCountKHR");
        ...
        [UnmanagedCallersOnly]
        private static void vkCmdEndPerTileExecutionQCOM_Lazy(VkCommandBuffer commandBuffer, VkPerTileEndInfoQCOM* pPerTileEndInfo)
        {
            _vkCmdEndPerTileExecutionQCOM_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPerTileEndInfoQCOM*, void>)VKLoader.GetInstanceProcAddress("vkCmdEndPerTileExecutionQCOM");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingEndInfoKHR*, void> _vkCmdEndRendering2EXT_fnptr = &vkCmdEndRendering2EXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdEndRendering2EXT_Lazy(VkCommandBuffer commandBuffer, VkRenderingEndInfoKHR* pRenderingEndInfo)
        {
            _vkCmdEndRendering2EXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingEndInfoKHR*, void>)VKLoader.GetInstanceProcAddress("vkCmdEndRendering2EXT");
            _vkCmdEndRendering2EXT_fnptr(commandBuffer, pRenderingEndInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingEndInfoKHR*, void> _vkCmdEndRendering2KHR_fnptr = &vkCmdEndRendering2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdEndRendering2KHR_Lazy(VkCommandBuffer commandBuffer, VkRenderingEndInfoKHR* pRenderingEndInfo)
        {
            _vkCmdEndRendering2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingEndInfoKHR*, void>)VKLoader.GetInstanceProcAddress("vkCmdEndRendering2KHR");
            _vkCmdEndRendering2KHR_fnptr(commandBuffer, pRenderingEndInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, void> _vkCmdEndRenderingKHR_fnptr = &vkCmdEndRenderingKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdEndRenderingKHR_Lazy(VkCommandBuffer commandBuffer)
        {
            _vkCmdEndRenderingKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, void>)VKLoader.GetInstanceProcAddress("vkCmdEndRenderingKHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkSubpassEndInfo*, void> _vkCmdEndRenderPass2KHR_fnptr = &vkCmdEndRenderPass2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdEndRenderPass2KHR_Lazy(VkCommandBuffer commandBuffer, VkSubpassEndInfo* pSubpassEndInfo)
        {
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, VkGeneratedCommandsInfoEXT*, void> _vkCmdExecuteGeneratedCommandsEXT_fnptr = &vkCmdExecuteGeneratedCommandsEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdExecuteGeneratedCommandsEXT_Lazy(VkCommandBuffer commandBuffer, int isPreprocessed, VkGeneratedCommandsInfoEXT* pGeneratedCommandsInfo)
        {
            _vkCmdExecuteGeneratedCommandsEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, VkGeneratedCommandsInfoEXT*, void>)VKLoader.GetInstanceProcAddress("vkCmdExecuteGeneratedCommandsEXT");
        ...
        [UnmanagedCallersOnly]
        private static void vkCmdInitializeGraphScratchMemoryAMDX_Lazy(VkCommandBuffer commandBuffer, VkPipeline executionGraph, ulong scratch, ulong scratchSize)
        {
            _vkCmdInitializeGraphScratchMemoryAMDX_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPipeline, ulong, ulong, void>)VKLoader.GetInstanceProcAddress("vkCmdInitializeGraphScratchMemoryAMDX");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkSubpassBeginInfo*, VkSubpassEndInfo*, void> _vkCmdNextSubpass2KHR_fnptr = &vkCmdNextSubpass2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdNextSubpass2KHR_Lazy(VkCommandBuffer commandBuffer, VkSubpassBeginInfo* pSubpassBeginInfo, VkSubpassEndInfo* pSubpassEndInfo)
        {
            _vkCmdNextSubpass2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkSubpassBeginInfo*, VkSubpassEndInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdNextSubpass2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkDependencyInfo*, void> _vkCmdPipelineBarrier2KHR_fnptr = &vkCmdPipelineBarrier2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPipelineBarrier2KHR_Lazy(VkCommandBuffer commandBuffer, VkDependencyInfo* pDependencyInfo)
        {
            _vkCmdPipelineBarrier2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkDependencyInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdPipelineBarrier2KHR");
            _vkCmdPipelineBarrier2KHR_fnptr(commandBuffer, pDependencyInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkGeneratedCommandsInfoEXT*, VkCommandBuffer, void> _vkCmdPreprocessGeneratedCommandsEXT_fnptr = &vkCmdPreprocessGeneratedCommandsEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPreprocessGeneratedCommandsEXT_Lazy(VkCommandBuffer commandBuffer, VkGeneratedCommandsInfoEXT* pGeneratedCommandsInfo, VkCommandBuffer stateCommandBuffer)
        {
            _vkCmdPreprocessGeneratedCommandsEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkGeneratedCommandsInfoEXT*, VkCommandBuffer, void>)VKLoader.GetInstanceProcAddress("vkCmdPreprocessGeneratedCommandsEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkPushConstantsInfo*, void> _vkCmdPushConstants2_fnptr = &vkCmdPushConstants2_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushConstants2_Lazy(VkCommandBuffer commandBuffer, VkPushConstantsInfo* pPushConstantsInfo)
        {
            _vkCmdPushConstants2_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPushConstantsInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushConstants2");
            _vkCmdPushConstants2_fnptr(commandBuffer, pPushConstantsInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkPushConstantsInfo*, void> _vkCmdPushConstants2KHR_fnptr = &vkCmdPushConstants2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushConstants2KHR_Lazy(VkCommandBuffer commandBuffer, VkPushConstantsInfo* pPushConstantsInfo)
        {
        ...
        [UnmanagedCallersOnly]
        private static void vkCmdPushDescriptorSet_Lazy(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint set, uint descriptorWriteCount, VkWriteDescriptorSet* pDescriptorWrites)
        {
            _vkCmdPushDescriptorSet_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPipelineBindPoint, VkPipelineLayout, uint, uint, VkWriteDescriptorSet*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushDescriptorSet");
            _vkCmdPushDescriptorSet_fnptr(commandBuffer, pipelineBindPoint, layout, set, descriptorWriteCount, pDescriptorWrites);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetInfo*, void> _vkCmdPushDescriptorSet2_fnptr = &vkCmdPushDescriptorSet2_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushDescriptorSet2_Lazy(VkCommandBuffer commandBuffer, VkPushDescriptorSetInfo* pPushDescriptorSetInfo)
        {
            _vkCmdPushDescriptorSet2_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushDescriptorSet2");
            _vkCmdPushDescriptorSet2_fnptr(commandBuffer, pPushDescriptorSetInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetInfo*, void> _vkCmdPushDescriptorSet2KHR_fnptr = &vkCmdPushDescriptorSet2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushDescriptorSet2KHR_Lazy(VkCommandBuffer commandBuffer, VkPushDescriptorSetInfo* pPushDescriptorSetInfo)
        {
            _vkCmdPushDescriptorSet2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushDescriptorSet2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkDescriptorUpdateTemplate, VkPipelineLayout, uint, void*, void> _vkCmdPushDescriptorSetWithTemplate_fnptr = &vkCmdPushDescriptorSetWithTemplate_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushDescriptorSetWithTemplate_Lazy(VkCommandBuffer commandBuffer, VkDescriptorUpdateTemplate descriptorUpdateTemplate, VkPipelineLayout layout, uint set, void* pData)
        {
            _vkCmdPushDescriptorSetWithTemplate_fnptr = (delegate* unmanaged<VkCommandBuffer, VkDescriptorUpdateTemplate, VkPipelineLayout, uint, void*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushDescriptorSetWithTemplate");
            _vkCmdPushDescriptorSetWithTemplate_fnptr(commandBuffer, descriptorUpdateTemplate, layout, set, pData);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetWithTemplateInfo*, void> _vkCmdPushDescriptorSetWithTemplate2_fnptr = &vkCmdPushDescriptorSetWithTemplate2_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushDescriptorSetWithTemplate2_Lazy(VkCommandBuffer commandBuffer, VkPushDescriptorSetWithTemplateInfo* pPushDescriptorSetWithTemplateInfo)
        {
            _vkCmdPushDescriptorSetWithTemplate2_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetWithTemplateInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushDescriptorSetWithTemplate2");
            _vkCmdPushDescriptorSetWithTemplate2_fnptr(commandBuffer, pPushDescriptorSetWithTemplateInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetWithTemplateInfo*, void> _vkCmdPushDescriptorSetWithTemplate2KHR_fnptr = &vkCmdPushDescriptorSetWithTemplate2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdPushDescriptorSetWithTemplate2KHR_Lazy(VkCommandBuffer commandBuffer, VkPushDescriptorSetWithTemplateInfo* pPushDescriptorSetWithTemplateInfo)
        {
            _vkCmdPushDescriptorSetWithTemplate2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPushDescriptorSetWithTemplateInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdPushDescriptorSetWithTemplate2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkEvent, VkPipelineStageFlagBits2, void> _vkCmdResetEvent2KHR_fnptr = &vkCmdResetEvent2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdResetEvent2KHR_Lazy(VkCommandBuffer commandBuffer, VkEvent @event, VkPipelineStageFlagBits2 stageMask)
        {
            _vkCmdResetEvent2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkEvent, VkPipelineStageFlagBits2, void>)VKLoader.GetInstanceProcAddress("vkCmdResetEvent2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkResolveImageInfo2*, void> _vkCmdResolveImage2KHR_fnptr = &vkCmdResolveImage2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdResolveImage2KHR_Lazy(VkCommandBuffer commandBuffer, VkResolveImageInfo2* pResolveImageInfo)
        {
            _vkCmdResolveImage2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkResolveImageInfo2*, void>)VKLoader.GetInstanceProcAddress("vkCmdResolveImage2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCullModeFlagBits, void> _vkCmdSetCullModeEXT_fnptr = &vkCmdSetCullModeEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetCullModeEXT_Lazy(VkCommandBuffer commandBuffer, VkCullModeFlagBits cullMode)
        {
            _vkCmdSetCullModeEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCullModeFlagBits, void>)VKLoader.GetInstanceProcAddress("vkCmdSetCullModeEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetDepthBiasEnableEXT_fnptr = &vkCmdSetDepthBiasEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDepthBiasEnableEXT_Lazy(VkCommandBuffer commandBuffer, int depthBiasEnable)
        {
            _vkCmdSetDepthBiasEnableEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDepthBiasEnableEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetDepthBoundsTestEnableEXT_fnptr = &vkCmdSetDepthBoundsTestEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDepthBoundsTestEnableEXT_Lazy(VkCommandBuffer commandBuffer, int depthBoundsTestEnable)
        {
            _vkCmdSetDepthBoundsTestEnableEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDepthBoundsTestEnableEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkDepthClampModeEXT, VkDepthClampRangeEXT*, void> _vkCmdSetDepthClampRangeEXT_fnptr = &vkCmdSetDepthClampRangeEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDepthClampRangeEXT_Lazy(VkCommandBuffer commandBuffer, VkDepthClampModeEXT depthClampMode, VkDepthClampRangeEXT* pDepthClampRange)
        {
            _vkCmdSetDepthClampRangeEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkDepthClampModeEXT, VkDepthClampRangeEXT*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDepthClampRangeEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkCompareOp, void> _vkCmdSetDepthCompareOpEXT_fnptr = &vkCmdSetDepthCompareOpEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDepthCompareOpEXT_Lazy(VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp)
        {
            _vkCmdSetDepthCompareOpEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkCompareOp, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDepthCompareOpEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetDepthTestEnableEXT_fnptr = &vkCmdSetDepthTestEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDepthTestEnableEXT_Lazy(VkCommandBuffer commandBuffer, int depthTestEnable)
        {
            _vkCmdSetDepthTestEnableEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDepthTestEnableEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetDepthWriteEnableEXT_fnptr = &vkCmdSetDepthWriteEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDepthWriteEnableEXT_Lazy(VkCommandBuffer commandBuffer, int depthWriteEnable)
        {
            _vkCmdSetDepthWriteEnableEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDepthWriteEnableEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, void> _vkCmdSetDeviceMaskKHR_fnptr = &vkCmdSetDeviceMaskKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetDeviceMaskKHR_Lazy(VkCommandBuffer commandBuffer, uint deviceMask)
        {
            _vkCmdSetDeviceMaskKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdSetDeviceMaskKHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkEvent, VkDependencyInfo*, void> _vkCmdSetEvent2KHR_fnptr = &vkCmdSetEvent2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetEvent2KHR_Lazy(VkCommandBuffer commandBuffer, VkEvent @event, VkDependencyInfo* pDependencyInfo)
        {
            _vkCmdSetEvent2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkEvent, VkDependencyInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetEvent2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkFrontFace, void> _vkCmdSetFrontFaceEXT_fnptr = &vkCmdSetFrontFaceEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetFrontFaceEXT_Lazy(VkCommandBuffer commandBuffer, VkFrontFace frontFace)
        {
            _vkCmdSetFrontFaceEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkFrontFace, void>)VKLoader.GetInstanceProcAddress("vkCmdSetFrontFaceEXT");
            _vkCmdSetFrontFaceEXT_fnptr(commandBuffer, frontFace);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkLineRasterizationMode, void> _vkCmdSetLineRasterizationModeEXT_fnptr = &vkCmdSetLineRasterizationModeEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetLineRasterizationModeEXT_Lazy(VkCommandBuffer commandBuffer, VkLineRasterizationMode lineRasterizationMode)
        {
            _vkCmdSetLineRasterizationModeEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkLineRasterizationMode, void>)VKLoader.GetInstanceProcAddress("vkCmdSetLineRasterizationModeEXT");
            _vkCmdSetLineRasterizationModeEXT_fnptr(commandBuffer, lineRasterizationMode);
        }
        public static delegate* unmanaged<VkCommandBuffer, uint, ushort, void> _vkCmdSetLineStipple_fnptr = &vkCmdSetLineStipple_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetLineStipple_Lazy(VkCommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern)
        {
            _vkCmdSetLineStipple_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, ushort, void>)VKLoader.GetInstanceProcAddress("vkCmdSetLineStipple");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, ushort, void> _vkCmdSetLineStippleEXT_fnptr = &vkCmdSetLineStippleEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetLineStippleEXT_Lazy(VkCommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern)
        {
            _vkCmdSetLineStippleEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, ushort, void>)VKLoader.GetInstanceProcAddress("vkCmdSetLineStippleEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetPrimitiveRestartEnableEXT_fnptr = &vkCmdSetPrimitiveRestartEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetPrimitiveRestartEnableEXT_Lazy(VkCommandBuffer commandBuffer, int primitiveRestartEnable)
        {
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkPrimitiveTopology, void> _vkCmdSetPrimitiveTopologyEXT_fnptr = &vkCmdSetPrimitiveTopologyEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetPrimitiveTopologyEXT_Lazy(VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology)
        {
            _vkCmdSetPrimitiveTopologyEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPrimitiveTopology, void>)VKLoader.GetInstanceProcAddress("vkCmdSetPrimitiveTopologyEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetRasterizerDiscardEnableEXT_fnptr = &vkCmdSetRasterizerDiscardEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetRasterizerDiscardEnableEXT_Lazy(VkCommandBuffer commandBuffer, int rasterizerDiscardEnable)
        {
            _vkCmdSetRasterizerDiscardEnableEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, void>)VKLoader.GetInstanceProcAddress("vkCmdSetRasterizerDiscardEnableEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingAttachmentLocationInfo*, void> _vkCmdSetRenderingAttachmentLocations_fnptr = &vkCmdSetRenderingAttachmentLocations_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetRenderingAttachmentLocations_Lazy(VkCommandBuffer commandBuffer, VkRenderingAttachmentLocationInfo* pLocationInfo)
        {
            _vkCmdSetRenderingAttachmentLocations_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingAttachmentLocationInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetRenderingAttachmentLocations");
            _vkCmdSetRenderingAttachmentLocations_fnptr(commandBuffer, pLocationInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingAttachmentLocationInfo*, void> _vkCmdSetRenderingAttachmentLocationsKHR_fnptr = &vkCmdSetRenderingAttachmentLocationsKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetRenderingAttachmentLocationsKHR_Lazy(VkCommandBuffer commandBuffer, VkRenderingAttachmentLocationInfo* pLocationInfo)
        {
            _vkCmdSetRenderingAttachmentLocationsKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingAttachmentLocationInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetRenderingAttachmentLocationsKHR");
            _vkCmdSetRenderingAttachmentLocationsKHR_fnptr(commandBuffer, pLocationInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingInputAttachmentIndexInfo*, void> _vkCmdSetRenderingInputAttachmentIndices_fnptr = &vkCmdSetRenderingInputAttachmentIndices_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetRenderingInputAttachmentIndices_Lazy(VkCommandBuffer commandBuffer, VkRenderingInputAttachmentIndexInfo* pInputAttachmentIndexInfo)
        {
            _vkCmdSetRenderingInputAttachmentIndices_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingInputAttachmentIndexInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetRenderingInputAttachmentIndices");
            _vkCmdSetRenderingInputAttachmentIndices_fnptr(commandBuffer, pInputAttachmentIndexInfo);
        }
        public static delegate* unmanaged<VkCommandBuffer, VkRenderingInputAttachmentIndexInfo*, void> _vkCmdSetRenderingInputAttachmentIndicesKHR_fnptr = &vkCmdSetRenderingInputAttachmentIndicesKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetRenderingInputAttachmentIndicesKHR_Lazy(VkCommandBuffer commandBuffer, VkRenderingInputAttachmentIndexInfo* pInputAttachmentIndexInfo)
        {
            _vkCmdSetRenderingInputAttachmentIndicesKHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkRenderingInputAttachmentIndexInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetRenderingInputAttachmentIndicesKHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, VkRect2D*, void> _vkCmdSetScissorWithCountEXT_fnptr = &vkCmdSetScissorWithCountEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetScissorWithCountEXT_Lazy(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors)
        {
            _vkCmdSetScissorWithCountEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, VkRect2D*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetScissorWithCountEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkStencilFaceFlagBits, VkStencilOp, VkStencilOp, VkStencilOp, VkCompareOp, void> _vkCmdSetStencilOpEXT_fnptr = &vkCmdSetStencilOpEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetStencilOpEXT_Lazy(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp)
        {
            _vkCmdSetStencilOpEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, VkStencilFaceFlagBits, VkStencilOp, VkStencilOp, VkStencilOp, VkCompareOp, void>)VKLoader.GetInstanceProcAddress("vkCmdSetStencilOpEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, int, void> _vkCmdSetStencilTestEnableEXT_fnptr = &vkCmdSetStencilTestEnableEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetStencilTestEnableEXT_Lazy(VkCommandBuffer commandBuffer, int stencilTestEnable)
        {
            _vkCmdSetStencilTestEnableEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, int, void>)VKLoader.GetInstanceProcAddress("vkCmdSetStencilTestEnableEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, VkViewport*, void> _vkCmdSetViewportWithCountEXT_fnptr = &vkCmdSetViewportWithCountEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdSetViewportWithCountEXT_Lazy(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports)
        {
            _vkCmdSetViewportWithCountEXT_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, VkViewport*, void>)VKLoader.GetInstanceProcAddress("vkCmdSetViewportWithCountEXT");
        ...
        public static delegate* unmanaged<VkCommandBuffer, uint, VkEvent*, VkDependencyInfo*, void> _vkCmdWaitEvents2KHR_fnptr = &vkCmdWaitEvents2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdWaitEvents2KHR_Lazy(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, VkDependencyInfo* pDependencyInfos)
        {
            _vkCmdWaitEvents2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, uint, VkEvent*, VkDependencyInfo*, void>)VKLoader.GetInstanceProcAddress("vkCmdWaitEvents2KHR");
        ...
        public static delegate* unmanaged<VkCommandBuffer, VkPipelineStageFlagBits2, VkQueryPool, uint, void> _vkCmdWriteTimestamp2KHR_fnptr = &vkCmdWriteTimestamp2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkCmdWriteTimestamp2KHR_Lazy(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits2 stage, VkQueryPool queryPool, uint query)
        {
            _vkCmdWriteTimestamp2KHR_fnptr = (delegate* unmanaged<VkCommandBuffer, VkPipelineStageFlagBits2, VkQueryPool, uint, void>)VKLoader.GetInstanceProcAddress("vkCmdWriteTimestamp2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkConvertCooperativeVectorMatrixInfoNV*, VkResult> _vkConvertCooperativeVectorMatrixNV_fnptr = &vkConvertCooperativeVectorMatrixNV_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkConvertCooperativeVectorMatrixNV_Lazy(VkDevice device, VkConvertCooperativeVectorMatrixInfoNV* pInfo)
        {
            _vkConvertCooperativeVectorMatrixNV_fnptr = (delegate* unmanaged<VkDevice, VkConvertCooperativeVectorMatrixInfoNV*, VkResult>)VKLoader.GetInstanceProcAddress("vkConvertCooperativeVectorMatrixNV");
        ...
        public static delegate* unmanaged<VkDevice, VkCopyImageToImageInfo*, VkResult> _vkCopyImageToImage_fnptr = &vkCopyImageToImage_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCopyImageToImage_Lazy(VkDevice device, VkCopyImageToImageInfo* pCopyImageToImageInfo)
        {
            _vkCopyImageToImage_fnptr = (delegate* unmanaged<VkDevice, VkCopyImageToImageInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkCopyImageToImage");
            return _vkCopyImageToImage_fnptr(device, pCopyImageToImageInfo);
        }
        public static delegate* unmanaged<VkDevice, VkCopyImageToImageInfo*, VkResult> _vkCopyImageToImageEXT_fnptr = &vkCopyImageToImageEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCopyImageToImageEXT_Lazy(VkDevice device, VkCopyImageToImageInfo* pCopyImageToImageInfo)
        {
            _vkCopyImageToImageEXT_fnptr = (delegate* unmanaged<VkDevice, VkCopyImageToImageInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkCopyImageToImageEXT");
            return _vkCopyImageToImageEXT_fnptr(device, pCopyImageToImageInfo);
        }
        public static delegate* unmanaged<VkDevice, VkCopyImageToMemoryInfo*, VkResult> _vkCopyImageToMemory_fnptr = &vkCopyImageToMemory_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCopyImageToMemory_Lazy(VkDevice device, VkCopyImageToMemoryInfo* pCopyImageToMemoryInfo)
        {
            _vkCopyImageToMemory_fnptr = (delegate* unmanaged<VkDevice, VkCopyImageToMemoryInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkCopyImageToMemory");
            return _vkCopyImageToMemory_fnptr(device, pCopyImageToMemoryInfo);
        }
        public static delegate* unmanaged<VkDevice, VkCopyImageToMemoryInfo*, VkResult> _vkCopyImageToMemoryEXT_fnptr = &vkCopyImageToMemoryEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCopyImageToMemoryEXT_Lazy(VkDevice device, VkCopyImageToMemoryInfo* pCopyImageToMemoryInfo)
        {
            _vkCopyImageToMemoryEXT_fnptr = (delegate* unmanaged<VkDevice, VkCopyImageToMemoryInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkCopyImageToMemoryEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkCopyMemoryToImageInfo*, VkResult> _vkCopyMemoryToImage_fnptr = &vkCopyMemoryToImage_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCopyMemoryToImage_Lazy(VkDevice device, VkCopyMemoryToImageInfo* pCopyMemoryToImageInfo)
        {
            _vkCopyMemoryToImage_fnptr = (delegate* unmanaged<VkDevice, VkCopyMemoryToImageInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkCopyMemoryToImage");
            return _vkCopyMemoryToImage_fnptr(device, pCopyMemoryToImageInfo);
        }
        public static delegate* unmanaged<VkDevice, VkCopyMemoryToImageInfo*, VkResult> _vkCopyMemoryToImageEXT_fnptr = &vkCopyMemoryToImageEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCopyMemoryToImageEXT_Lazy(VkDevice device, VkCopyMemoryToImageInfo* pCopyMemoryToImageInfo)
        {
            _vkCopyMemoryToImageEXT_fnptr = (delegate* unmanaged<VkDevice, VkCopyMemoryToImageInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkCopyMemoryToImageEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkDeferredOperationKHR, VkPipelineCache, uint, VkDataGraphPipelineCreateInfoARM*, VkAllocationCallbacks*, VkPipeline*, VkResult> _vkCreateDataGraphPipelinesARM_fnptr = &vkCreateDataGraphPipelinesARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateDataGraphPipelinesARM_Lazy(VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache, uint createInfoCount, VkDataGraphPipelineCreateInfoARM* pCreateInfos, VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
        {
            _vkCreateDataGraphPipelinesARM_fnptr = (delegate* unmanaged<VkDevice, VkDeferredOperationKHR, VkPipelineCache, uint, VkDataGraphPipelineCreateInfoARM*, VkAllocationCallbacks*, VkPipeline*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateDataGraphPipelinesARM");
        ...
        public static delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionCreateInfoARM*, VkAllocationCallbacks*, VkDataGraphPipelineSessionARM*, VkResult> _vkCreateDataGraphPipelineSessionARM_fnptr = &vkCreateDataGraphPipelineSessionARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateDataGraphPipelineSessionARM_Lazy(VkDevice device, VkDataGraphPipelineSessionCreateInfoARM* pCreateInfo, VkAllocationCallbacks* pAllocator, VkDataGraphPipelineSessionARM* pSession)
        {
            _vkCreateDataGraphPipelineSessionARM_fnptr = (delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionCreateInfoARM*, VkAllocationCallbacks*, VkDataGraphPipelineSessionARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateDataGraphPipelineSessionARM");
        ...
        public static delegate* unmanaged<VkDevice, VkDescriptorUpdateTemplateCreateInfo*, VkAllocationCallbacks*, VkDescriptorUpdateTemplate*, VkResult> _vkCreateDescriptorUpdateTemplateKHR_fnptr = &vkCreateDescriptorUpdateTemplateKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateDescriptorUpdateTemplateKHR_Lazy(VkDevice device, VkDescriptorUpdateTemplateCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkDescriptorUpdateTemplate* pDescriptorUpdateTemplate)
        {
            _vkCreateDescriptorUpdateTemplateKHR_fnptr = (delegate* unmanaged<VkDevice, VkDescriptorUpdateTemplateCreateInfo*, VkAllocationCallbacks*, VkDescriptorUpdateTemplate*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateDescriptorUpdateTemplateKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkExternalComputeQueueCreateInfoNV*, VkAllocationCallbacks*, VkExternalComputeQueueNV*, VkResult> _vkCreateExternalComputeQueueNV_fnptr = &vkCreateExternalComputeQueueNV_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateExternalComputeQueueNV_Lazy(VkDevice device, VkExternalComputeQueueCreateInfoNV* pCreateInfo, VkAllocationCallbacks* pAllocator, VkExternalComputeQueueNV* pExternalQueue)
        {
            _vkCreateExternalComputeQueueNV_fnptr = (delegate* unmanaged<VkDevice, VkExternalComputeQueueCreateInfoNV*, VkAllocationCallbacks*, VkExternalComputeQueueNV*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateExternalComputeQueueNV");
        ...
        public static delegate* unmanaged<VkDevice, VkIndirectCommandsLayoutCreateInfoEXT*, VkAllocationCallbacks*, VkIndirectCommandsLayoutEXT*, VkResult> _vkCreateIndirectCommandsLayoutEXT_fnptr = &vkCreateIndirectCommandsLayoutEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateIndirectCommandsLayoutEXT_Lazy(VkDevice device, VkIndirectCommandsLayoutCreateInfoEXT* pCreateInfo, VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutEXT* pIndirectCommandsLayout)
        {
            _vkCreateIndirectCommandsLayoutEXT_fnptr = (delegate* unmanaged<VkDevice, VkIndirectCommandsLayoutCreateInfoEXT*, VkAllocationCallbacks*, VkIndirectCommandsLayoutEXT*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateIndirectCommandsLayoutEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkIndirectExecutionSetCreateInfoEXT*, VkAllocationCallbacks*, VkIndirectExecutionSetEXT*, VkResult> _vkCreateIndirectExecutionSetEXT_fnptr = &vkCreateIndirectExecutionSetEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateIndirectExecutionSetEXT_Lazy(VkDevice device, VkIndirectExecutionSetCreateInfoEXT* pCreateInfo, VkAllocationCallbacks* pAllocator, VkIndirectExecutionSetEXT* pIndirectExecutionSet)
        {
            _vkCreateIndirectExecutionSetEXT_fnptr = (delegate* unmanaged<VkDevice, VkIndirectExecutionSetCreateInfoEXT*, VkAllocationCallbacks*, VkIndirectExecutionSetEXT*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateIndirectExecutionSetEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkPrivateDataSlotCreateInfo*, VkAllocationCallbacks*, VkPrivateDataSlot*, VkResult> _vkCreatePrivateDataSlotEXT_fnptr = &vkCreatePrivateDataSlotEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreatePrivateDataSlotEXT_Lazy(VkDevice device, VkPrivateDataSlotCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot)
        {
            _vkCreatePrivateDataSlotEXT_fnptr = (delegate* unmanaged<VkDevice, VkPrivateDataSlotCreateInfo*, VkAllocationCallbacks*, VkPrivateDataSlot*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreatePrivateDataSlotEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkRenderPassCreateInfo2*, VkAllocationCallbacks*, VkRenderPass*, VkResult> _vkCreateRenderPass2KHR_fnptr = &vkCreateRenderPass2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateRenderPass2KHR_Lazy(VkDevice device, VkRenderPassCreateInfo2* pCreateInfo, VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass)
        {
            _vkCreateRenderPass2KHR_fnptr = (delegate* unmanaged<VkDevice, VkRenderPassCreateInfo2*, VkAllocationCallbacks*, VkRenderPass*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateRenderPass2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkSamplerYcbcrConversionCreateInfo*, VkAllocationCallbacks*, VkSamplerYcbcrConversion*, VkResult> _vkCreateSamplerYcbcrConversionKHR_fnptr = &vkCreateSamplerYcbcrConversionKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateSamplerYcbcrConversionKHR_Lazy(VkDevice device, VkSamplerYcbcrConversionCreateInfo* pCreateInfo, VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion)
        {
            _vkCreateSamplerYcbcrConversionKHR_fnptr = (delegate* unmanaged<VkDevice, VkSamplerYcbcrConversionCreateInfo*, VkAllocationCallbacks*, VkSamplerYcbcrConversion*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateSamplerYcbcrConversionKHR");
        ...
        public static delegate* unmanaged<VkInstance, VkSurfaceCreateInfoOHOS*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult> _vkCreateSurfaceOHOS_fnptr = &vkCreateSurfaceOHOS_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateSurfaceOHOS_Lazy(VkInstance instance, VkSurfaceCreateInfoOHOS* pCreateInfo, VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
        {
            _vkCreateSurfaceOHOS_fnptr = (delegate* unmanaged<VkInstance, VkSurfaceCreateInfoOHOS*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateSurfaceOHOS");
        ...
        public static delegate* unmanaged<VkDevice, VkTensorCreateInfoARM*, VkAllocationCallbacks*, VkTensorARM*, VkResult> _vkCreateTensorARM_fnptr = &vkCreateTensorARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateTensorARM_Lazy(VkDevice device, VkTensorCreateInfoARM* pCreateInfo, VkAllocationCallbacks* pAllocator, VkTensorARM* pTensor)
        {
            _vkCreateTensorARM_fnptr = (delegate* unmanaged<VkDevice, VkTensorCreateInfoARM*, VkAllocationCallbacks*, VkTensorARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkCreateTensorARM");
            return _vkCreateTensorARM_fnptr(device, pCreateInfo, pAllocator, pTensor);
        }
        public static delegate* unmanaged<VkDevice, VkTensorViewCreateInfoARM*, VkAllocationCallbacks*, VkTensorViewARM*, VkResult> _vkCreateTensorViewARM_fnptr = &vkCreateTensorViewARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkCreateTensorViewARM_Lazy(VkDevice device, VkTensorViewCreateInfoARM* pCreateInfo, VkAllocationCallbacks* pAllocator, VkTensorViewARM* pView)
        {
        ...
        public static delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionARM, VkAllocationCallbacks*, void> _vkDestroyDataGraphPipelineSessionARM_fnptr = &vkDestroyDataGraphPipelineSessionARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyDataGraphPipelineSessionARM_Lazy(VkDevice device, VkDataGraphPipelineSessionARM session, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyDataGraphPipelineSessionARM_fnptr = (delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionARM, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyDataGraphPipelineSessionARM");
        ...
        public static delegate* unmanaged<VkDevice, VkDescriptorUpdateTemplate, VkAllocationCallbacks*, void> _vkDestroyDescriptorUpdateTemplateKHR_fnptr = &vkDestroyDescriptorUpdateTemplateKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyDescriptorUpdateTemplateKHR_Lazy(VkDevice device, VkDescriptorUpdateTemplate descriptorUpdateTemplate, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyDescriptorUpdateTemplateKHR_fnptr = (delegate* unmanaged<VkDevice, VkDescriptorUpdateTemplate, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyDescriptorUpdateTemplateKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkExternalComputeQueueNV, VkAllocationCallbacks*, void> _vkDestroyExternalComputeQueueNV_fnptr = &vkDestroyExternalComputeQueueNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyExternalComputeQueueNV_Lazy(VkDevice device, VkExternalComputeQueueNV externalQueue, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyExternalComputeQueueNV_fnptr = (delegate* unmanaged<VkDevice, VkExternalComputeQueueNV, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyExternalComputeQueueNV");
        ...
        public static delegate* unmanaged<VkDevice, VkIndirectCommandsLayoutEXT, VkAllocationCallbacks*, void> _vkDestroyIndirectCommandsLayoutEXT_fnptr = &vkDestroyIndirectCommandsLayoutEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyIndirectCommandsLayoutEXT_Lazy(VkDevice device, VkIndirectCommandsLayoutEXT indirectCommandsLayout, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyIndirectCommandsLayoutEXT_fnptr = (delegate* unmanaged<VkDevice, VkIndirectCommandsLayoutEXT, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyIndirectCommandsLayoutEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkIndirectExecutionSetEXT, VkAllocationCallbacks*, void> _vkDestroyIndirectExecutionSetEXT_fnptr = &vkDestroyIndirectExecutionSetEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyIndirectExecutionSetEXT_Lazy(VkDevice device, VkIndirectExecutionSetEXT indirectExecutionSet, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyIndirectExecutionSetEXT_fnptr = (delegate* unmanaged<VkDevice, VkIndirectExecutionSetEXT, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyIndirectExecutionSetEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkPrivateDataSlot, VkAllocationCallbacks*, void> _vkDestroyPrivateDataSlotEXT_fnptr = &vkDestroyPrivateDataSlotEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyPrivateDataSlotEXT_Lazy(VkDevice device, VkPrivateDataSlot privateDataSlot, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyPrivateDataSlotEXT_fnptr = (delegate* unmanaged<VkDevice, VkPrivateDataSlot, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyPrivateDataSlotEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkSamplerYcbcrConversion, VkAllocationCallbacks*, void> _vkDestroySamplerYcbcrConversionKHR_fnptr = &vkDestroySamplerYcbcrConversionKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroySamplerYcbcrConversionKHR_Lazy(VkDevice device, VkSamplerYcbcrConversion ycbcrConversion, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroySamplerYcbcrConversionKHR_fnptr = (delegate* unmanaged<VkDevice, VkSamplerYcbcrConversion, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroySamplerYcbcrConversionKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkTensorARM, VkAllocationCallbacks*, void> _vkDestroyTensorARM_fnptr = &vkDestroyTensorARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyTensorARM_Lazy(VkDevice device, VkTensorARM tensor, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyTensorARM_fnptr = (delegate* unmanaged<VkDevice, VkTensorARM, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyTensorARM");
            _vkDestroyTensorARM_fnptr(device, tensor, pAllocator);
        }
        public static delegate* unmanaged<VkDevice, VkTensorViewARM, VkAllocationCallbacks*, void> _vkDestroyTensorViewARM_fnptr = &vkDestroyTensorViewARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkDestroyTensorViewARM_Lazy(VkDevice device, VkTensorViewARM tensorView, VkAllocationCallbacks* pAllocator)
        {
            _vkDestroyTensorViewARM_fnptr = (delegate* unmanaged<VkDevice, VkTensorViewARM, VkAllocationCallbacks*, void>)VKLoader.GetInstanceProcAddress("vkDestroyTensorViewARM");
        ...
        public static delegate* unmanaged<VkInstance, uint*, VkPhysicalDeviceGroupProperties*, VkResult> _vkEnumeratePhysicalDeviceGroupsKHR_fnptr = &vkEnumeratePhysicalDeviceGroupsKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkEnumeratePhysicalDeviceGroupsKHR_Lazy(VkInstance instance, uint* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties)
        {
            _vkEnumeratePhysicalDeviceGroupsKHR_fnptr = (delegate* unmanaged<VkInstance, uint*, VkPhysicalDeviceGroupProperties*, VkResult>)VKLoader.GetInstanceProcAddress("vkEnumeratePhysicalDeviceGroupsKHR");
            return _vkEnumeratePhysicalDeviceGroupsKHR_fnptr(instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
        }
        public static delegate* unmanaged<VkPhysicalDevice, uint, uint*, VkPerformanceCounterARM*, VkPerformanceCounterDescriptionARM*, VkResult> _vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM_fnptr = &vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM_Lazy(VkPhysicalDevice physicalDevice, uint queueFamilyIndex, uint* pCounterCount, VkPerformanceCounterARM* pCounters, VkPerformanceCounterDescriptionARM* pCounterDescriptions)
        {
            _vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM_fnptr = (delegate* unmanaged<VkPhysicalDevice, uint, uint*, VkPerformanceCounterARM*, VkPerformanceCounterDescriptionARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM");
        ...
        public static delegate* unmanaged<VkDevice, VkAccelerationStructureMemoryRequirementsInfoNV*, VkMemoryRequirements2*, void> _vkGetAccelerationStructureMemoryRequirementsNV_fnptr = &vkGetAccelerationStructureMemoryRequirementsNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetAccelerationStructureMemoryRequirementsNV_Lazy(VkDevice device, VkAccelerationStructureMemoryRequirementsInfoNV* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
            _vkGetAccelerationStructureMemoryRequirementsNV_fnptr = (delegate* unmanaged<VkDevice, VkAccelerationStructureMemoryRequirementsInfoNV*, VkMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetAccelerationStructureMemoryRequirementsNV");
        ...
        public static delegate* unmanaged<VkDevice, VkBufferDeviceAddressInfo*, ulong> _vkGetBufferDeviceAddressEXT_fnptr = &vkGetBufferDeviceAddressEXT_Lazy;
        [UnmanagedCallersOnly]
        private static ulong vkGetBufferDeviceAddressEXT_Lazy(VkDevice device, VkBufferDeviceAddressInfo* pInfo)
        {
            _vkGetBufferDeviceAddressEXT_fnptr = (delegate* unmanaged<VkDevice, VkBufferDeviceAddressInfo*, ulong>)VKLoader.GetInstanceProcAddress("vkGetBufferDeviceAddressEXT");
            return _vkGetBufferDeviceAddressEXT_fnptr(device, pInfo);
        }
        public static delegate* unmanaged<VkDevice, VkBufferDeviceAddressInfo*, ulong> _vkGetBufferDeviceAddressKHR_fnptr = &vkGetBufferDeviceAddressKHR_Lazy;
        [UnmanagedCallersOnly]
        private static ulong vkGetBufferDeviceAddressKHR_Lazy(VkDevice device, VkBufferDeviceAddressInfo* pInfo)
        {
            _vkGetBufferDeviceAddressKHR_fnptr = (delegate* unmanaged<VkDevice, VkBufferDeviceAddressInfo*, ulong>)VKLoader.GetInstanceProcAddress("vkGetBufferDeviceAddressKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkBufferMemoryRequirementsInfo2*, VkMemoryRequirements2*, void> _vkGetBufferMemoryRequirements2KHR_fnptr = &vkGetBufferMemoryRequirements2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetBufferMemoryRequirements2KHR_Lazy(VkDevice device, VkBufferMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
            _vkGetBufferMemoryRequirements2KHR_fnptr = (delegate* unmanaged<VkDevice, VkBufferMemoryRequirementsInfo2*, VkMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetBufferMemoryRequirements2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkBufferDeviceAddressInfo*, ulong> _vkGetBufferOpaqueCaptureAddressKHR_fnptr = &vkGetBufferOpaqueCaptureAddressKHR_Lazy;
        [UnmanagedCallersOnly]
        private static ulong vkGetBufferOpaqueCaptureAddressKHR_Lazy(VkDevice device, VkBufferDeviceAddressInfo* pInfo)
        {
            _vkGetBufferOpaqueCaptureAddressKHR_fnptr = (delegate* unmanaged<VkDevice, VkBufferDeviceAddressInfo*, ulong>)VKLoader.GetInstanceProcAddress("vkGetBufferOpaqueCaptureAddressKHR");
        ...
        public static delegate* unmanaged<VkDevice, uint, VkCalibratedTimestampInfoKHR*, ulong*, ulong*, VkResult> _vkGetCalibratedTimestampsEXT_fnptr = &vkGetCalibratedTimestampsEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetCalibratedTimestampsEXT_Lazy(VkDevice device, uint timestampCount, VkCalibratedTimestampInfoKHR* pTimestampInfos, ulong* pTimestamps, ulong* pMaxDeviation)
        {
            _vkGetCalibratedTimestampsEXT_fnptr = (delegate* unmanaged<VkDevice, uint, VkCalibratedTimestampInfoKHR*, ulong*, ulong*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetCalibratedTimestampsEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkClusterAccelerationStructureInputInfoNV*, VkAccelerationStructureBuildSizesInfoKHR*, void> _vkGetClusterAccelerationStructureBuildSizesNV_fnptr = &vkGetClusterAccelerationStructureBuildSizesNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetClusterAccelerationStructureBuildSizesNV_Lazy(VkDevice device, VkClusterAccelerationStructureInputInfoNV* pInfo, VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo)
        {
            _vkGetClusterAccelerationStructureBuildSizesNV_fnptr = (delegate* unmanaged<VkDevice, VkClusterAccelerationStructureInputInfoNV*, VkAccelerationStructureBuildSizesInfoKHR*, void>)VKLoader.GetInstanceProcAddress("vkGetClusterAccelerationStructureBuildSizesNV");
        ...
        public static delegate* unmanaged<VkDevice, VkDataGraphPipelineInfoARM*, uint*, VkDataGraphPipelinePropertyARM*, VkResult> _vkGetDataGraphPipelineAvailablePropertiesARM_fnptr = &vkGetDataGraphPipelineAvailablePropertiesARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetDataGraphPipelineAvailablePropertiesARM_Lazy(VkDevice device, VkDataGraphPipelineInfoARM* pPipelineInfo, uint* pPropertiesCount, VkDataGraphPipelinePropertyARM* pProperties)
        {
            _vkGetDataGraphPipelineAvailablePropertiesARM_fnptr = (delegate* unmanaged<VkDevice, VkDataGraphPipelineInfoARM*, uint*, VkDataGraphPipelinePropertyARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetDataGraphPipelineAvailablePropertiesARM");
            return _vkGetDataGraphPipelineAvailablePropertiesARM_fnptr(device, pPipelineInfo, pPropertiesCount, pProperties);
        }
        public static delegate* unmanaged<VkDevice, VkDataGraphPipelineInfoARM*, uint, VkDataGraphPipelinePropertyQueryResultARM*, VkResult> _vkGetDataGraphPipelinePropertiesARM_fnptr = &vkGetDataGraphPipelinePropertiesARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetDataGraphPipelinePropertiesARM_Lazy(VkDevice device, VkDataGraphPipelineInfoARM* pPipelineInfo, uint propertiesCount, VkDataGraphPipelinePropertyQueryResultARM* pProperties)
        {
            _vkGetDataGraphPipelinePropertiesARM_fnptr = (delegate* unmanaged<VkDevice, VkDataGraphPipelineInfoARM*, uint, VkDataGraphPipelinePropertyQueryResultARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetDataGraphPipelinePropertiesARM");
            return _vkGetDataGraphPipelinePropertiesARM_fnptr(device, pPipelineInfo, propertiesCount, pProperties);
        }
        public static delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionBindPointRequirementsInfoARM*, uint*, VkDataGraphPipelineSessionBindPointRequirementARM*, VkResult> _vkGetDataGraphPipelineSessionBindPointRequirementsARM_fnptr = &vkGetDataGraphPipelineSessionBindPointRequirementsARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetDataGraphPipelineSessionBindPointRequirementsARM_Lazy(VkDevice device, VkDataGraphPipelineSessionBindPointRequirementsInfoARM* pInfo, uint* pBindPointRequirementCount, VkDataGraphPipelineSessionBindPointRequirementARM* pBindPointRequirements)
        {
            _vkGetDataGraphPipelineSessionBindPointRequirementsARM_fnptr = (delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionBindPointRequirementsInfoARM*, uint*, VkDataGraphPipelineSessionBindPointRequirementARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetDataGraphPipelineSessionBindPointRequirementsARM");
        ...
        public static delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionMemoryRequirementsInfoARM*, VkMemoryRequirements2*, void> _vkGetDataGraphPipelineSessionMemoryRequirementsARM_fnptr = &vkGetDataGraphPipelineSessionMemoryRequirementsARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDataGraphPipelineSessionMemoryRequirementsARM_Lazy(VkDevice device, VkDataGraphPipelineSessionMemoryRequirementsInfoARM* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
            _vkGetDataGraphPipelineSessionMemoryRequirementsARM_fnptr = (delegate* unmanaged<VkDevice, VkDataGraphPipelineSessionMemoryRequirementsInfoARM*, VkMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetDataGraphPipelineSessionMemoryRequirementsARM");
        ...
        public static delegate* unmanaged<VkDevice, VkDescriptorSetLayoutCreateInfo*, VkDescriptorSetLayoutSupport*, void> _vkGetDescriptorSetLayoutSupportKHR_fnptr = &vkGetDescriptorSetLayoutSupportKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDescriptorSetLayoutSupportKHR_Lazy(VkDevice device, VkDescriptorSetLayoutCreateInfo* pCreateInfo, VkDescriptorSetLayoutSupport* pSupport)
        {
            _vkGetDescriptorSetLayoutSupportKHR_fnptr = (delegate* unmanaged<VkDevice, VkDescriptorSetLayoutCreateInfo*, VkDescriptorSetLayoutSupport*, void>)VKLoader.GetInstanceProcAddress("vkGetDescriptorSetLayoutSupportKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkDeviceBufferMemoryRequirements*, VkMemoryRequirements2*, void> _vkGetDeviceBufferMemoryRequirementsKHR_fnptr = &vkGetDeviceBufferMemoryRequirementsKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceBufferMemoryRequirementsKHR_Lazy(VkDevice device, VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
        ...
        public static delegate* unmanaged<VkDevice, uint, uint, uint, VkPeerMemoryFeatureFlagBits*, void> _vkGetDeviceGroupPeerMemoryFeaturesKHR_fnptr = &vkGetDeviceGroupPeerMemoryFeaturesKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceGroupPeerMemoryFeaturesKHR_Lazy(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlagBits* pPeerMemoryFeatures)
        {
            _vkGetDeviceGroupPeerMemoryFeaturesKHR_fnptr = (delegate* unmanaged<VkDevice, uint, uint, uint, VkPeerMemoryFeatureFlagBits*, void>)VKLoader.GetInstanceProcAddress("vkGetDeviceGroupPeerMemoryFeaturesKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, VkMemoryRequirements2*, void> _vkGetDeviceImageMemoryRequirementsKHR_fnptr = &vkGetDeviceImageMemoryRequirementsKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceImageMemoryRequirementsKHR_Lazy(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
            _vkGetDeviceImageMemoryRequirementsKHR_fnptr = (delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, VkMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetDeviceImageMemoryRequirementsKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, uint*, VkSparseImageMemoryRequirements2*, void> _vkGetDeviceImageSparseMemoryRequirementsKHR_fnptr = &vkGetDeviceImageSparseMemoryRequirementsKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceImageSparseMemoryRequirementsKHR_Lazy(VkDevice device, VkDeviceImageMemoryRequirements* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements)
        {
            _vkGetDeviceImageSparseMemoryRequirementsKHR_fnptr = (delegate* unmanaged<VkDevice, VkDeviceImageMemoryRequirements*, uint*, VkSparseImageMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetDeviceImageSparseMemoryRequirementsKHR");
            _vkGetDeviceImageSparseMemoryRequirementsKHR_fnptr(device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
        }
        public static delegate* unmanaged<VkDevice, VkDeviceImageSubresourceInfo*, VkSubresourceLayout2*, void> _vkGetDeviceImageSubresourceLayout_fnptr = &vkGetDeviceImageSubresourceLayout_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceImageSubresourceLayout_Lazy(VkDevice device, VkDeviceImageSubresourceInfo* pInfo, VkSubresourceLayout2* pLayout)
        {
            _vkGetDeviceImageSubresourceLayout_fnptr = (delegate* unmanaged<VkDevice, VkDeviceImageSubresourceInfo*, VkSubresourceLayout2*, void>)VKLoader.GetInstanceProcAddress("vkGetDeviceImageSubresourceLayout");
            _vkGetDeviceImageSubresourceLayout_fnptr(device, pInfo, pLayout);
        }
        public static delegate* unmanaged<VkDevice, VkDeviceImageSubresourceInfo*, VkSubresourceLayout2*, void> _vkGetDeviceImageSubresourceLayoutKHR_fnptr = &vkGetDeviceImageSubresourceLayoutKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceImageSubresourceLayoutKHR_Lazy(VkDevice device, VkDeviceImageSubresourceInfo* pInfo, VkSubresourceLayout2* pLayout)
        {
            _vkGetDeviceImageSubresourceLayoutKHR_fnptr = (delegate* unmanaged<VkDevice, VkDeviceImageSubresourceInfo*, VkSubresourceLayout2*, void>)VKLoader.GetInstanceProcAddress("vkGetDeviceImageSubresourceLayoutKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkDeviceMemoryOpaqueCaptureAddressInfo*, ulong> _vkGetDeviceMemoryOpaqueCaptureAddressKHR_fnptr = &vkGetDeviceMemoryOpaqueCaptureAddressKHR_Lazy;
        [UnmanagedCallersOnly]
        private static ulong vkGetDeviceMemoryOpaqueCaptureAddressKHR_Lazy(VkDevice device, VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo)
        {
            _vkGetDeviceMemoryOpaqueCaptureAddressKHR_fnptr = (delegate* unmanaged<VkDevice, VkDeviceMemoryOpaqueCaptureAddressInfo*, ulong>)VKLoader.GetInstanceProcAddress("vkGetDeviceMemoryOpaqueCaptureAddressKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkDeviceTensorMemoryRequirementsARM*, VkMemoryRequirements2*, void> _vkGetDeviceTensorMemoryRequirementsARM_fnptr = &vkGetDeviceTensorMemoryRequirementsARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetDeviceTensorMemoryRequirementsARM_Lazy(VkDevice device, VkDeviceTensorMemoryRequirementsARM* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
            _vkGetDeviceTensorMemoryRequirementsARM_fnptr = (delegate* unmanaged<VkDevice, VkDeviceTensorMemoryRequirementsARM*, VkMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetDeviceTensorMemoryRequirementsARM");
        ...
        public static delegate* unmanaged<VkDevice, VkGeneratedCommandsMemoryRequirementsInfoEXT*, VkMemoryRequirements2*, void> _vkGetGeneratedCommandsMemoryRequirementsEXT_fnptr = &vkGetGeneratedCommandsMemoryRequirementsEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetGeneratedCommandsMemoryRequirementsEXT_Lazy(VkDevice device, VkGeneratedCommandsMemoryRequirementsInfoEXT* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
            _vkGetGeneratedCommandsMemoryRequirementsEXT_fnptr = (delegate* unmanaged<VkDevice, VkGeneratedCommandsMemoryRequirementsInfoEXT*, VkMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetGeneratedCommandsMemoryRequirementsEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkImageMemoryRequirementsInfo2*, VkMemoryRequirements2*, void> _vkGetImageMemoryRequirements2KHR_fnptr = &vkGetImageMemoryRequirements2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetImageMemoryRequirements2KHR_Lazy(VkDevice device, VkImageMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
        ...
        public static delegate* unmanaged<VkDevice, VkImageSparseMemoryRequirementsInfo2*, uint*, VkSparseImageMemoryRequirements2*, void> _vkGetImageSparseMemoryRequirements2KHR_fnptr = &vkGetImageSparseMemoryRequirements2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetImageSparseMemoryRequirements2KHR_Lazy(VkDevice device, VkImageSparseMemoryRequirementsInfo2* pInfo, uint* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements)
        {
            _vkGetImageSparseMemoryRequirements2KHR_fnptr = (delegate* unmanaged<VkDevice, VkImageSparseMemoryRequirementsInfo2*, uint*, VkSparseImageMemoryRequirements2*, void>)VKLoader.GetInstanceProcAddress("vkGetImageSparseMemoryRequirements2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkImage, VkImageSubresource2*, VkSubresourceLayout2*, void> _vkGetImageSubresourceLayout2_fnptr = &vkGetImageSubresourceLayout2_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetImageSubresourceLayout2_Lazy(VkDevice device, VkImage image, VkImageSubresource2* pSubresource, VkSubresourceLayout2* pLayout)
        {
            _vkGetImageSubresourceLayout2_fnptr = (delegate* unmanaged<VkDevice, VkImage, VkImageSubresource2*, VkSubresourceLayout2*, void>)VKLoader.GetInstanceProcAddress("vkGetImageSubresourceLayout2");
            _vkGetImageSubresourceLayout2_fnptr(device, image, pSubresource, pLayout);
        }
        public static delegate* unmanaged<VkDevice, VkImage, VkImageSubresource2*, VkSubresourceLayout2*, void> _vkGetImageSubresourceLayout2EXT_fnptr = &vkGetImageSubresourceLayout2EXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetImageSubresourceLayout2EXT_Lazy(VkDevice device, VkImage image, VkImageSubresource2* pSubresource, VkSubresourceLayout2* pLayout)
        {
            _vkGetImageSubresourceLayout2EXT_fnptr = (delegate* unmanaged<VkDevice, VkImage, VkImageSubresource2*, VkSubresourceLayout2*, void>)VKLoader.GetInstanceProcAddress("vkGetImageSubresourceLayout2EXT");
            _vkGetImageSubresourceLayout2EXT_fnptr(device, image, pSubresource, pLayout);
        }
        public static delegate* unmanaged<VkDevice, VkImage, VkImageSubresource2*, VkSubresourceLayout2*, void> _vkGetImageSubresourceLayout2KHR_fnptr = &vkGetImageSubresourceLayout2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetImageSubresourceLayout2KHR_Lazy(VkDevice device, VkImage image, VkImageSubresource2* pSubresource, VkSubresourceLayout2* pLayout)
        {
            _vkGetImageSubresourceLayout2KHR_fnptr = (delegate* unmanaged<VkDevice, VkImage, VkImageSubresource2*, VkSubresourceLayout2*, void>)VKLoader.GetInstanceProcAddress("vkGetImageSubresourceLayout2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkImageViewHandleInfoNVX*, ulong> _vkGetImageViewHandle64NVX_fnptr = &vkGetImageViewHandle64NVX_Lazy;
        [UnmanagedCallersOnly]
        private static ulong vkGetImageViewHandle64NVX_Lazy(VkDevice device, VkImageViewHandleInfoNVX* pInfo)
        {
            _vkGetImageViewHandle64NVX_fnptr = (delegate* unmanaged<VkDevice, VkImageViewHandleInfoNVX*, ulong>)VKLoader.GetInstanceProcAddress("vkGetImageViewHandle64NVX");
        ...
        public static delegate* unmanaged<VkDevice, VkMemoryGetMetalHandleInfoEXT*, void**, VkResult> _vkGetMemoryMetalHandleEXT_fnptr = &vkGetMemoryMetalHandleEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetMemoryMetalHandleEXT_Lazy(VkDevice device, VkMemoryGetMetalHandleInfoEXT* pGetMetalHandleInfo, void** pHandle)
        {
            _vkGetMemoryMetalHandleEXT_fnptr = (delegate* unmanaged<VkDevice, VkMemoryGetMetalHandleInfoEXT*, void**, VkResult>)VKLoader.GetInstanceProcAddress("vkGetMemoryMetalHandleEXT");
            return _vkGetMemoryMetalHandleEXT_fnptr(device, pGetMetalHandleInfo, pHandle);
        }
        public static delegate* unmanaged<VkDevice, VkExternalMemoryHandleTypeFlagBits, void*, VkMemoryMetalHandlePropertiesEXT*, VkResult> _vkGetMemoryMetalHandlePropertiesEXT_fnptr = &vkGetMemoryMetalHandlePropertiesEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetMemoryMetalHandlePropertiesEXT_Lazy(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, void* pHandle, VkMemoryMetalHandlePropertiesEXT* pMemoryMetalHandleProperties)
        {
            _vkGetMemoryMetalHandlePropertiesEXT_fnptr = (delegate* unmanaged<VkDevice, VkExternalMemoryHandleTypeFlagBits, void*, VkMemoryMetalHandlePropertiesEXT*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetMemoryMetalHandlePropertiesEXT");
            return _vkGetMemoryMetalHandlePropertiesEXT_fnptr(device, handleType, pHandle, pMemoryMetalHandleProperties);
        }
        public static delegate* unmanaged<VkDevice, VkMemoryGetNativeBufferInfoOHOS*, IntPtr*, VkResult> _vkGetMemoryNativeBufferOHOS_fnptr = &vkGetMemoryNativeBufferOHOS_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetMemoryNativeBufferOHOS_Lazy(VkDevice device, VkMemoryGetNativeBufferInfoOHOS* pInfo, IntPtr* pBuffer)
        {
            _vkGetMemoryNativeBufferOHOS_fnptr = (delegate* unmanaged<VkDevice, VkMemoryGetNativeBufferInfoOHOS*, IntPtr*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetMemoryNativeBufferOHOS");
        ...
        public static delegate* unmanaged<VkDevice, IntPtr, VkNativeBufferPropertiesOHOS*, VkResult> _vkGetNativeBufferPropertiesOHOS_fnptr = &vkGetNativeBufferPropertiesOHOS_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetNativeBufferPropertiesOHOS_Lazy(VkDevice device, IntPtr buffer, VkNativeBufferPropertiesOHOS* pProperties)
        {
            _vkGetNativeBufferPropertiesOHOS_fnptr = (delegate* unmanaged<VkDevice, IntPtr, VkNativeBufferPropertiesOHOS*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetNativeBufferPropertiesOHOS");
            return _vkGetNativeBufferPropertiesOHOS_fnptr(device, buffer, pProperties);
        }
        public static delegate* unmanaged<VkDevice, VkPartitionedAccelerationStructureInstancesInputNV*, VkAccelerationStructureBuildSizesInfoKHR*, void> _vkGetPartitionedAccelerationStructuresBuildSizesNV_fnptr = &vkGetPartitionedAccelerationStructuresBuildSizesNV_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPartitionedAccelerationStructuresBuildSizesNV_Lazy(VkDevice device, VkPartitionedAccelerationStructureInstancesInputNV* pInfo, VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo)
        {
            _vkGetPartitionedAccelerationStructuresBuildSizesNV_fnptr = (delegate* unmanaged<VkDevice, VkPartitionedAccelerationStructureInstancesInputNV*, VkAccelerationStructureBuildSizesInfoKHR*, void>)VKLoader.GetInstanceProcAddress("vkGetPartitionedAccelerationStructuresBuildSizesNV");
            _vkGetPartitionedAccelerationStructuresBuildSizesNV_fnptr(device, pInfo, pSizeInfo);
        }
        public static delegate* unmanaged<VkDevice, VkPastPresentationTimingInfoEXT*, VkPastPresentationTimingPropertiesEXT*, VkResult> _vkGetPastPresentationTimingEXT_fnptr = &vkGetPastPresentationTimingEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPastPresentationTimingEXT_Lazy(VkDevice device, VkPastPresentationTimingInfoEXT* pPastPresentationTimingInfo, VkPastPresentationTimingPropertiesEXT* pPastPresentationTimingProperties)
        {
            _vkGetPastPresentationTimingEXT_fnptr = (delegate* unmanaged<VkDevice, VkPastPresentationTimingInfoEXT*, VkPastPresentationTimingPropertiesEXT*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetPastPresentationTimingEXT");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, uint*, VkTimeDomainKHR*, VkResult> _vkGetPhysicalDeviceCalibrateableTimeDomainsEXT_fnptr = &vkGetPhysicalDeviceCalibrateableTimeDomainsEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPhysicalDeviceCalibrateableTimeDomainsEXT_Lazy(VkPhysicalDevice physicalDevice, uint* pTimeDomainCount, VkTimeDomainKHR* pTimeDomains)
        {
            _vkGetPhysicalDeviceCalibrateableTimeDomainsEXT_fnptr = (delegate* unmanaged<VkPhysicalDevice, uint*, VkTimeDomainKHR*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceCalibrateableTimeDomainsEXT");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, uint*, VkCooperativeMatrixFlexibleDimensionsPropertiesNV*, VkResult> _vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV_fnptr = &vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV_Lazy(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkCooperativeMatrixFlexibleDimensionsPropertiesNV* pProperties)
        {
            _vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV_fnptr = (delegate* unmanaged<VkPhysicalDevice, uint*, VkCooperativeMatrixFlexibleDimensionsPropertiesNV*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, uint*, VkCooperativeVectorPropertiesNV*, VkResult> _vkGetPhysicalDeviceCooperativeVectorPropertiesNV_fnptr = &vkGetPhysicalDeviceCooperativeVectorPropertiesNV_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPhysicalDeviceCooperativeVectorPropertiesNV_Lazy(VkPhysicalDevice physicalDevice, uint* pPropertyCount, VkCooperativeVectorPropertiesNV* pProperties)
        {
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalBufferInfo*, VkExternalBufferProperties*, void> _vkGetPhysicalDeviceExternalBufferPropertiesKHR_fnptr = &vkGetPhysicalDeviceExternalBufferPropertiesKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceExternalBufferPropertiesKHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceExternalBufferInfo* pExternalBufferInfo, VkExternalBufferProperties* pExternalBufferProperties)
        {
            _vkGetPhysicalDeviceExternalBufferPropertiesKHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalBufferInfo*, VkExternalBufferProperties*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceExternalBufferPropertiesKHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalFenceInfo*, VkExternalFenceProperties*, void> _vkGetPhysicalDeviceExternalFencePropertiesKHR_fnptr = &vkGetPhysicalDeviceExternalFencePropertiesKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceExternalFencePropertiesKHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceExternalFenceInfo* pExternalFenceInfo, VkExternalFenceProperties* pExternalFenceProperties)
        {
            _vkGetPhysicalDeviceExternalFencePropertiesKHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalFenceInfo*, VkExternalFenceProperties*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceExternalFencePropertiesKHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalSemaphoreInfo*, VkExternalSemaphoreProperties*, void> _vkGetPhysicalDeviceExternalSemaphorePropertiesKHR_fnptr = &vkGetPhysicalDeviceExternalSemaphorePropertiesKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceExternalSemaphorePropertiesKHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceExternalSemaphoreInfo* pExternalSemaphoreInfo, VkExternalSemaphoreProperties* pExternalSemaphoreProperties)
        {
            _vkGetPhysicalDeviceExternalSemaphorePropertiesKHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalSemaphoreInfo*, VkExternalSemaphoreProperties*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceExternalSemaphorePropertiesKHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalTensorInfoARM*, VkExternalTensorPropertiesARM*, void> _vkGetPhysicalDeviceExternalTensorPropertiesARM_fnptr = &vkGetPhysicalDeviceExternalTensorPropertiesARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceExternalTensorPropertiesARM_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceExternalTensorInfoARM* pExternalTensorInfo, VkExternalTensorPropertiesARM* pExternalTensorProperties)
        {
            _vkGetPhysicalDeviceExternalTensorPropertiesARM_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceExternalTensorInfoARM*, VkExternalTensorPropertiesARM*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceExternalTensorPropertiesARM");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceFeatures2*, void> _vkGetPhysicalDeviceFeatures2KHR_fnptr = &vkGetPhysicalDeviceFeatures2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceFeatures2KHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceFeatures2* pFeatures)
        {
            _vkGetPhysicalDeviceFeatures2KHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceFeatures2*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceFeatures2KHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkFormat, VkFormatProperties2*, void> _vkGetPhysicalDeviceFormatProperties2KHR_fnptr = &vkGetPhysicalDeviceFormatProperties2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceFormatProperties2KHR_Lazy(VkPhysicalDevice physicalDevice, VkFormat format, VkFormatProperties2* pFormatProperties)
        {
            _vkGetPhysicalDeviceFormatProperties2KHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkFormat, VkFormatProperties2*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceFormatProperties2KHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceImageFormatInfo2*, VkImageFormatProperties2*, VkResult> _vkGetPhysicalDeviceImageFormatProperties2KHR_fnptr = &vkGetPhysicalDeviceImageFormatProperties2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPhysicalDeviceImageFormatProperties2KHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceImageFormatInfo2* pImageFormatInfo, VkImageFormatProperties2* pImageFormatProperties)
        {
            _vkGetPhysicalDeviceImageFormatProperties2KHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceImageFormatInfo2*, VkImageFormatProperties2*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceImageFormatProperties2KHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceMemoryProperties2*, void> _vkGetPhysicalDeviceMemoryProperties2KHR_fnptr = &vkGetPhysicalDeviceMemoryProperties2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceMemoryProperties2KHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceMemoryProperties2* pMemoryProperties)
        {
            _vkGetPhysicalDeviceMemoryProperties2KHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceMemoryProperties2*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceMemoryProperties2KHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceProperties2*, void> _vkGetPhysicalDeviceProperties2KHR_fnptr = &vkGetPhysicalDeviceProperties2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceProperties2KHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties2* pProperties)
        {
        ...
        {
            _vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM*, VkQueueFamilyDataGraphProcessingEnginePropertiesARM*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, uint, uint*, VkQueueFamilyDataGraphPropertiesARM*, VkResult> _vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM_fnptr = &vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM_Lazy(VkPhysicalDevice physicalDevice, uint queueFamilyIndex, uint* pQueueFamilyDataGraphPropertyCount, VkQueueFamilyDataGraphPropertiesARM* pQueueFamilyDataGraphProperties)
        {
            _vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM_fnptr = (delegate* unmanaged<VkPhysicalDevice, uint, uint*, VkQueueFamilyDataGraphPropertiesARM*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, uint*, VkQueueFamilyProperties2*, void> _vkGetPhysicalDeviceQueueFamilyProperties2KHR_fnptr = &vkGetPhysicalDeviceQueueFamilyProperties2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceQueueFamilyProperties2KHR_Lazy(VkPhysicalDevice physicalDevice, uint* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties)
        {
            _vkGetPhysicalDeviceQueueFamilyProperties2KHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, uint*, VkQueueFamilyProperties2*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceQueueFamilyProperties2KHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceSparseImageFormatInfo2*, uint*, VkSparseImageFormatProperties2*, void> _vkGetPhysicalDeviceSparseImageFormatProperties2KHR_fnptr = &vkGetPhysicalDeviceSparseImageFormatProperties2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPhysicalDeviceSparseImageFormatProperties2KHR_Lazy(VkPhysicalDevice physicalDevice, VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint* pPropertyCount, VkSparseImageFormatProperties2* pProperties)
        {
            _vkGetPhysicalDeviceSparseImageFormatProperties2KHR_fnptr = (delegate* unmanaged<VkPhysicalDevice, VkPhysicalDeviceSparseImageFormatInfo2*, uint*, VkSparseImageFormatProperties2*, void>)VKLoader.GetInstanceProcAddress("vkGetPhysicalDeviceSparseImageFormatProperties2KHR");
        ...
        public static delegate* unmanaged<VkPhysicalDevice, uint*, VkPhysicalDeviceToolProperties*, VkResult> _vkGetPhysicalDeviceToolPropertiesEXT_fnptr = &vkGetPhysicalDeviceToolPropertiesEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPhysicalDeviceToolPropertiesEXT_Lazy(VkPhysicalDevice physicalDevice, uint* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties)
        {
        ...
        [UnmanagedCallersOnly]
        private static int vkGetPhysicalDeviceUbmPresentationSupportSEC_Lazy(VkPhysicalDevice physicalDevice, uint queueFamilyIndex, IntPtr ubm_device)
        {
        ...
        public static delegate* unmanaged<VkDevice, VkPipelineInfoKHR*, VkBaseOutStructure*, VkResult> _vkGetPipelinePropertiesEXT_fnptr = &vkGetPipelinePropertiesEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetPipelinePropertiesEXT_Lazy(VkDevice device, VkPipelineInfoKHR* pPipelineInfo, VkBaseOutStructure* pPipelineProperties)
        {
            _vkGetPipelinePropertiesEXT_fnptr = (delegate* unmanaged<VkDevice, VkPipelineInfoKHR*, VkBaseOutStructure*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetPipelinePropertiesEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong*, void> _vkGetPrivateDataEXT_fnptr = &vkGetPrivateDataEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetPrivateDataEXT_Lazy(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong* pData)
        {
            _vkGetPrivateDataEXT_fnptr = (delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong*, void>)VKLoader.GetInstanceProcAddress("vkGetPrivateDataEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkPipeline, uint, uint, nuint, void*, VkResult> _vkGetRayTracingShaderGroupHandlesNV_fnptr = &vkGetRayTracingShaderGroupHandlesNV_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetRayTracingShaderGroupHandlesNV_Lazy(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData)
        {
            _vkGetRayTracingShaderGroupHandlesNV_fnptr = (delegate* unmanaged<VkDevice, VkPipeline, uint, uint, nuint, void*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetRayTracingShaderGroupHandlesNV");
        ...
        public static delegate* unmanaged<VkDevice, VkRenderingAreaInfo*, VkExtent2D*, void> _vkGetRenderingAreaGranularity_fnptr = &vkGetRenderingAreaGranularity_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetRenderingAreaGranularity_Lazy(VkDevice device, VkRenderingAreaInfo* pRenderingAreaInfo, VkExtent2D* pGranularity)
        {
            _vkGetRenderingAreaGranularity_fnptr = (delegate* unmanaged<VkDevice, VkRenderingAreaInfo*, VkExtent2D*, void>)VKLoader.GetInstanceProcAddress("vkGetRenderingAreaGranularity");
            _vkGetRenderingAreaGranularity_fnptr(device, pRenderingAreaInfo, pGranularity);
        }
        public static delegate* unmanaged<VkDevice, VkRenderingAreaInfo*, VkExtent2D*, void> _vkGetRenderingAreaGranularityKHR_fnptr = &vkGetRenderingAreaGranularityKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetRenderingAreaGranularityKHR_Lazy(VkDevice device, VkRenderingAreaInfo* pRenderingAreaInfo, VkExtent2D* pGranularity)
        {
            _vkGetRenderingAreaGranularityKHR_fnptr = (delegate* unmanaged<VkDevice, VkRenderingAreaInfo*, VkExtent2D*, void>)VKLoader.GetInstanceProcAddress("vkGetRenderingAreaGranularityKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkSemaphore, ulong*, VkResult> _vkGetSemaphoreCounterValueKHR_fnptr = &vkGetSemaphoreCounterValueKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetSemaphoreCounterValueKHR_Lazy(VkDevice device, VkSemaphore semaphore, ulong* pValue)
        {
            _vkGetSemaphoreCounterValueKHR_fnptr = (delegate* unmanaged<VkDevice, VkSemaphore, ulong*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetSemaphoreCounterValueKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkFormat, VkImageUsageFlagBits, ulong*, VkResult> _vkGetSwapchainGrallocUsageOHOS_fnptr = &vkGetSwapchainGrallocUsageOHOS_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetSwapchainGrallocUsageOHOS_Lazy(VkDevice device, VkFormat format, VkImageUsageFlagBits imageUsage, ulong* grallocUsage)
        {
            _vkGetSwapchainGrallocUsageOHOS_fnptr = (delegate* unmanaged<VkDevice, VkFormat, VkImageUsageFlagBits, ulong*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetSwapchainGrallocUsageOHOS");
        ...
        public static delegate* unmanaged<VkDevice, VkSwapchainKHR, VkSwapchainTimeDomainPropertiesEXT*, ulong*, VkResult> _vkGetSwapchainTimeDomainPropertiesEXT_fnptr = &vkGetSwapchainTimeDomainPropertiesEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetSwapchainTimeDomainPropertiesEXT_Lazy(VkDevice device, VkSwapchainKHR swapchain, VkSwapchainTimeDomainPropertiesEXT* pSwapchainTimeDomainProperties, ulong* pTimeDomainsCounter)
        {
            _vkGetSwapchainTimeDomainPropertiesEXT_fnptr = (delegate* unmanaged<VkDevice, VkSwapchainKHR, VkSwapchainTimeDomainPropertiesEXT*, ulong*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetSwapchainTimeDomainPropertiesEXT");
            return _vkGetSwapchainTimeDomainPropertiesEXT_fnptr(device, swapchain, pSwapchainTimeDomainProperties, pTimeDomainsCounter);
        }
        public static delegate* unmanaged<VkDevice, VkSwapchainKHR, VkSwapchainTimingPropertiesEXT*, ulong*, VkResult> _vkGetSwapchainTimingPropertiesEXT_fnptr = &vkGetSwapchainTimingPropertiesEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetSwapchainTimingPropertiesEXT_Lazy(VkDevice device, VkSwapchainKHR swapchain, VkSwapchainTimingPropertiesEXT* pSwapchainTimingProperties, ulong* pSwapchainTimingPropertiesCounter)
        {
            _vkGetSwapchainTimingPropertiesEXT_fnptr = (delegate* unmanaged<VkDevice, VkSwapchainKHR, VkSwapchainTimingPropertiesEXT*, ulong*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetSwapchainTimingPropertiesEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkTensorMemoryRequirementsInfoARM*, VkMemoryRequirements2*, void> _vkGetTensorMemoryRequirementsARM_fnptr = &vkGetTensorMemoryRequirementsARM_Lazy;
        [UnmanagedCallersOnly]
        private static void vkGetTensorMemoryRequirementsARM_Lazy(VkDevice device, VkTensorMemoryRequirementsInfoARM* pInfo, VkMemoryRequirements2* pMemoryRequirements)
        {
        ...
        [UnmanagedCallersOnly]
        private static VkResult vkGetTensorOpaqueCaptureDescriptorDataARM_Lazy(VkDevice device, VkTensorCaptureDescriptorDataInfoARM* pInfo, void* pData)
        {
            _vkGetTensorOpaqueCaptureDescriptorDataARM_fnptr = (delegate* unmanaged<VkDevice, VkTensorCaptureDescriptorDataInfoARM*, void*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetTensorOpaqueCaptureDescriptorDataARM");
            return _vkGetTensorOpaqueCaptureDescriptorDataARM_fnptr(device, pInfo, pData);
        }
        public static delegate* unmanaged<VkDevice, VkTensorViewCaptureDescriptorDataInfoARM*, void*, VkResult> _vkGetTensorViewOpaqueCaptureDescriptorDataARM_fnptr = &vkGetTensorViewOpaqueCaptureDescriptorDataARM_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkGetTensorViewOpaqueCaptureDescriptorDataARM_Lazy(VkDevice device, VkTensorViewCaptureDescriptorDataInfoARM* pInfo, void* pData)
        {
            _vkGetTensorViewOpaqueCaptureDescriptorDataARM_fnptr = (delegate* unmanaged<VkDevice, VkTensorViewCaptureDescriptorDataInfoARM*, void*, VkResult>)VKLoader.GetInstanceProcAddress("vkGetTensorViewOpaqueCaptureDescriptorDataARM");
        ...
        public static delegate* unmanaged<VkDevice, VkMemoryMapInfo*, void**, VkResult> _vkMapMemory2_fnptr = &vkMapMemory2_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkMapMemory2_Lazy(VkDevice device, VkMemoryMapInfo* pMemoryMapInfo, void** ppData)
        {
            _vkMapMemory2_fnptr = (delegate* unmanaged<VkDevice, VkMemoryMapInfo*, void**, VkResult>)VKLoader.GetInstanceProcAddress("vkMapMemory2");
            return _vkMapMemory2_fnptr(device, pMemoryMapInfo, ppData);
        }
        public static delegate* unmanaged<VkDevice, VkMemoryMapInfo*, void**, VkResult> _vkMapMemory2KHR_fnptr = &vkMapMemory2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkMapMemory2KHR_Lazy(VkDevice device, VkMemoryMapInfo* pMemoryMapInfo, void** ppData)
        {
            _vkMapMemory2KHR_fnptr = (delegate* unmanaged<VkDevice, VkMemoryMapInfo*, void**, VkResult>)VKLoader.GetInstanceProcAddress("vkMapMemory2KHR");
        ...
        public static delegate* unmanaged<VkQueue, uint, VkSemaphore*, VkImage, int*, VkResult> _vkQueueSignalReleaseImageOHOS_fnptr = &vkQueueSignalReleaseImageOHOS_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkQueueSignalReleaseImageOHOS_Lazy(VkQueue queue, uint waitSemaphoreCount, VkSemaphore* pWaitSemaphores, VkImage image, int* pNativeFenceFd)
        {
            _vkQueueSignalReleaseImageOHOS_fnptr = (delegate* unmanaged<VkQueue, uint, VkSemaphore*, VkImage, int*, VkResult>)VKLoader.GetInstanceProcAddress("vkQueueSignalReleaseImageOHOS");
        ...
        public static delegate* unmanaged<VkQueue, uint, VkSubmitInfo2*, VkFence, VkResult> _vkQueueSubmit2KHR_fnptr = &vkQueueSubmit2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkQueueSubmit2KHR_Lazy(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence)
        {
            _vkQueueSubmit2KHR_fnptr = (delegate* unmanaged<VkQueue, uint, VkSubmitInfo2*, VkFence, VkResult>)VKLoader.GetInstanceProcAddress("vkQueueSubmit2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkReleaseSwapchainImagesInfoKHR*, VkResult> _vkReleaseSwapchainImagesEXT_fnptr = &vkReleaseSwapchainImagesEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkReleaseSwapchainImagesEXT_Lazy(VkDevice device, VkReleaseSwapchainImagesInfoKHR* pReleaseInfo)
        {
            _vkReleaseSwapchainImagesEXT_fnptr = (delegate* unmanaged<VkDevice, VkReleaseSwapchainImagesInfoKHR*, VkResult>)VKLoader.GetInstanceProcAddress("vkReleaseSwapchainImagesEXT");
            return _vkReleaseSwapchainImagesEXT_fnptr(device, pReleaseInfo);
        }
        public static delegate* unmanaged<VkDevice, VkReleaseSwapchainImagesInfoKHR*, VkResult> _vkReleaseSwapchainImagesKHR_fnptr = &vkReleaseSwapchainImagesKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkReleaseSwapchainImagesKHR_Lazy(VkDevice device, VkReleaseSwapchainImagesInfoKHR* pReleaseInfo)
        {
            _vkReleaseSwapchainImagesKHR_fnptr = (delegate* unmanaged<VkDevice, VkReleaseSwapchainImagesInfoKHR*, VkResult>)VKLoader.GetInstanceProcAddress("vkReleaseSwapchainImagesKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkQueryPool, uint, uint, void> _vkResetQueryPoolEXT_fnptr = &vkResetQueryPoolEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkResetQueryPoolEXT_Lazy(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount)
        {
            _vkResetQueryPoolEXT_fnptr = (delegate* unmanaged<VkDevice, VkQueryPool, uint, uint, void>)VKLoader.GetInstanceProcAddress("vkResetQueryPoolEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong, VkResult> _vkSetPrivateDataEXT_fnptr = &vkSetPrivateDataEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkSetPrivateDataEXT_Lazy(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data)
        {
            _vkSetPrivateDataEXT_fnptr = (delegate* unmanaged<VkDevice, VkObjectType, ulong, VkPrivateDataSlot, ulong, VkResult>)VKLoader.GetInstanceProcAddress("vkSetPrivateDataEXT");
            return _vkSetPrivateDataEXT_fnptr(device, objectType, objectHandle, privateDataSlot, data);
        }
        public static delegate* unmanaged<VkDevice, VkSwapchainKHR, uint, VkResult> _vkSetSwapchainPresentTimingQueueSizeEXT_fnptr = &vkSetSwapchainPresentTimingQueueSizeEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkSetSwapchainPresentTimingQueueSizeEXT_Lazy(VkDevice device, VkSwapchainKHR swapchain, uint size)
        {
            _vkSetSwapchainPresentTimingQueueSizeEXT_fnptr = (delegate* unmanaged<VkDevice, VkSwapchainKHR, uint, VkResult>)VKLoader.GetInstanceProcAddress("vkSetSwapchainPresentTimingQueueSizeEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkSemaphoreSignalInfo*, VkResult> _vkSignalSemaphoreKHR_fnptr = &vkSignalSemaphoreKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkSignalSemaphoreKHR_Lazy(VkDevice device, VkSemaphoreSignalInfo* pSignalInfo)
        {
            _vkSignalSemaphoreKHR_fnptr = (delegate* unmanaged<VkDevice, VkSemaphoreSignalInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkSignalSemaphoreKHR");
        ...
        public static delegate* unmanaged<VkDevice, uint, VkHostImageLayoutTransitionInfo*, VkResult> _vkTransitionImageLayout_fnptr = &vkTransitionImageLayout_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkTransitionImageLayout_Lazy(VkDevice device, uint transitionCount, VkHostImageLayoutTransitionInfo* pTransitions)
        {
            _vkTransitionImageLayout_fnptr = (delegate* unmanaged<VkDevice, uint, VkHostImageLayoutTransitionInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkTransitionImageLayout");
            return _vkTransitionImageLayout_fnptr(device, transitionCount, pTransitions);
        }
        public static delegate* unmanaged<VkDevice, uint, VkHostImageLayoutTransitionInfo*, VkResult> _vkTransitionImageLayoutEXT_fnptr = &vkTransitionImageLayoutEXT_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkTransitionImageLayoutEXT_Lazy(VkDevice device, uint transitionCount, VkHostImageLayoutTransitionInfo* pTransitions)
        {
            _vkTransitionImageLayoutEXT_fnptr = (delegate* unmanaged<VkDevice, uint, VkHostImageLayoutTransitionInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkTransitionImageLayoutEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkCommandPool, VkCommandPoolTrimFlags, void> _vkTrimCommandPoolKHR_fnptr = &vkTrimCommandPoolKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkTrimCommandPoolKHR_Lazy(VkDevice device, VkCommandPool commandPool, VkCommandPoolTrimFlags flags)
        {
            _vkTrimCommandPoolKHR_fnptr = (delegate* unmanaged<VkDevice, VkCommandPool, VkCommandPoolTrimFlags, void>)VKLoader.GetInstanceProcAddress("vkTrimCommandPoolKHR");
        ...
        public static delegate* unmanaged<VkDevice, VkMemoryUnmapInfo*, VkResult> _vkUnmapMemory2_fnptr = &vkUnmapMemory2_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkUnmapMemory2_Lazy(VkDevice device, VkMemoryUnmapInfo* pMemoryUnmapInfo)
        {
            _vkUnmapMemory2_fnptr = (delegate* unmanaged<VkDevice, VkMemoryUnmapInfo*, VkResult>)VKLoader.GetInstanceProcAddress("vkUnmapMemory2");
            return _vkUnmapMemory2_fnptr(device, pMemoryUnmapInfo);
        }
        public static delegate* unmanaged<VkDevice, VkMemoryUnmapInfo*, VkResult> _vkUnmapMemory2KHR_fnptr = &vkUnmapMemory2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkUnmapMemory2KHR_Lazy(VkDevice device, VkMemoryUnmapInfo* pMemoryUnmapInfo)
        {
        ...
        public static delegate* unmanaged<VkDevice, VkDescriptorSet, VkDescriptorUpdateTemplate, void*, void> _vkUpdateDescriptorSetWithTemplateKHR_fnptr = &vkUpdateDescriptorSetWithTemplateKHR_Lazy;
        [UnmanagedCallersOnly]
        private static void vkUpdateDescriptorSetWithTemplateKHR_Lazy(VkDevice device, VkDescriptorSet descriptorSet, VkDescriptorUpdateTemplate descriptorUpdateTemplate, void* pData)
        {
            _vkUpdateDescriptorSetWithTemplateKHR_fnptr = (delegate* unmanaged<VkDevice, VkDescriptorSet, VkDescriptorUpdateTemplate, void*, void>)VKLoader.GetInstanceProcAddress("vkUpdateDescriptorSetWithTemplateKHR");
            _vkUpdateDescriptorSetWithTemplateKHR_fnptr(device, descriptorSet, descriptorUpdateTemplate, pData);
        }
        public static delegate* unmanaged<VkDevice, VkIndirectExecutionSetEXT, uint, VkWriteIndirectExecutionSetPipelineEXT*, void> _vkUpdateIndirectExecutionSetPipelineEXT_fnptr = &vkUpdateIndirectExecutionSetPipelineEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkUpdateIndirectExecutionSetPipelineEXT_Lazy(VkDevice device, VkIndirectExecutionSetEXT indirectExecutionSet, uint executionSetWriteCount, VkWriteIndirectExecutionSetPipelineEXT* pExecutionSetWrites)
        {
            _vkUpdateIndirectExecutionSetPipelineEXT_fnptr = (delegate* unmanaged<VkDevice, VkIndirectExecutionSetEXT, uint, VkWriteIndirectExecutionSetPipelineEXT*, void>)VKLoader.GetInstanceProcAddress("vkUpdateIndirectExecutionSetPipelineEXT");
            _vkUpdateIndirectExecutionSetPipelineEXT_fnptr(device, indirectExecutionSet, executionSetWriteCount, pExecutionSetWrites);
        }
        public static delegate* unmanaged<VkDevice, VkIndirectExecutionSetEXT, uint, VkWriteIndirectExecutionSetShaderEXT*, void> _vkUpdateIndirectExecutionSetShaderEXT_fnptr = &vkUpdateIndirectExecutionSetShaderEXT_Lazy;
        [UnmanagedCallersOnly]
        private static void vkUpdateIndirectExecutionSetShaderEXT_Lazy(VkDevice device, VkIndirectExecutionSetEXT indirectExecutionSet, uint executionSetWriteCount, VkWriteIndirectExecutionSetShaderEXT* pExecutionSetWrites)
        {
            _vkUpdateIndirectExecutionSetShaderEXT_fnptr = (delegate* unmanaged<VkDevice, VkIndirectExecutionSetEXT, uint, VkWriteIndirectExecutionSetShaderEXT*, void>)VKLoader.GetInstanceProcAddress("vkUpdateIndirectExecutionSetShaderEXT");
        ...
        public static delegate* unmanaged<VkDevice, VkSwapchainKHR, VkPresentWait2InfoKHR*, VkResult> _vkWaitForPresent2KHR_fnptr = &vkWaitForPresent2KHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkWaitForPresent2KHR_Lazy(VkDevice device, VkSwapchainKHR swapchain, VkPresentWait2InfoKHR* pPresentWait2Info)
        {
            _vkWaitForPresent2KHR_fnptr = (delegate* unmanaged<VkDevice, VkSwapchainKHR, VkPresentWait2InfoKHR*, VkResult>)VKLoader.GetInstanceProcAddress("vkWaitForPresent2KHR");
        ...
        public static delegate* unmanaged<VkDevice, VkSemaphoreWaitInfo*, ulong, VkResult> _vkWaitSemaphoresKHR_fnptr = &vkWaitSemaphoresKHR_Lazy;
        [UnmanagedCallersOnly]
        private static VkResult vkWaitSemaphoresKHR_Lazy(VkDevice device, VkSemaphoreWaitInfo* pWaitInfo, ulong timeout)
        {
            _vkWaitSemaphoresKHR_fnptr = (delegate* unmanaged<VkDevice, VkSemaphoreWaitInfo*, ulong, VkResult>)VKLoader.GetInstanceProcAddress("vkWaitSemaphoresKHR");
