...
namespace OpenTK.OpenAL.Native
{
    ...
    public static class Alc
    {
        ...
        private static extern unsafe IntPtr SysCreateContext([In] IntPtr device, [In] int* attrlist);
        ...
        {
            return new ContextHandle(SysCreateContext(device, attrlist));
        }
        ...
        [SuppressUnmanagedCodeSecurity]
        private static extern IntPtr SysGetCurrentContext();
        ...
        {
            return new ContextHandle(SysGetCurrentContext());
        }
        ...
        /// This function completes a capture operation, and does not block.
        /// </summary>
        /// <typeparam name="T">The sample type to capture the buffer in.</typeparam>
        /// <param name="device">a pointer to a capture device.</param>
