...
namespace OpenTK.OpenGL.Wgl
{
    public static unsafe partial class Wgl
    {
        ...
        public static int CopyContext_(IntPtr hglrcSrc, IntPtr hglrcDst, uint mask) => WglPointers._wglCopyContext_fnptr(hglrcSrc, hglrcDst, mask);
        ...
        public static int SwapLayerBuffers_(IntPtr hdc, uint fuFlags) => WglPointers._wglSwapLayerBuffers_fnptr(hdc, fuFlags);
        ...
        public static int UseFontOutlines_(IntPtr hDC, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr lpgmf) => WglPointers._wglUseFontOutlines_fnptr(hDC, first, count, listBase, deviation, extrusion, format, lpgmf);
        
        /// <summary> <b>[requires: v1.0]</b> <b>[entry point: <c>wglUseFontOutlinesA</c>]</b><br/>  </summary>
        public static int UseFontOutlinesA_(IntPtr hDC, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr lpgmf) => WglPointers._wglUseFontOutlinesA_fnptr(hDC, first, count, listBase, deviation, extrusion, format, lpgmf);
        
        /// <summary> <b>[requires: v1.0]</b> <b>[entry point: <c>wglUseFontOutlinesW</c>]</b><br/>  </summary>
        public static int UseFontOutlinesW_(IntPtr hDC, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr lpgmf) => WglPointers._wglUseFontOutlinesW_fnptr(hDC, first, count, listBase, deviation, extrusion, format, lpgmf);
        ...
        public static unsafe partial class _3DL
        {
            ...
            public static int SetStereoEmitterState3DL_(IntPtr hDC, uint uState) => WglPointers._wglSetStereoEmitterState3DL_fnptr(hDC, uState);
        ...
        public static unsafe partial class ARB
        {
            ...
            public static int BindTexImageARB_(IntPtr hPbuffer, int iBuffer) => WglPointers._wglBindTexImageARB_fnptr(hPbuffer, iBuffer);
            ...
            public static int ReleaseTexImageARB_(IntPtr hPbuffer, int iBuffer) => WglPointers._wglReleaseTexImageARB_fnptr(hPbuffer, iBuffer);
        ...
        public static unsafe partial class NV
        {
            ...
            public static int BindVideoImageNV_(IntPtr hVideoDevice, IntPtr hPbuffer, int iVideoBuffer) => WglPointers._wglBindVideoImageNV_fnptr(hVideoDevice, hPbuffer, iVideoBuffer);
            
            /// <summary> <b>[requires: WGL_NV_copy_image]</b> <b>[entry point: <c>wglCopyImageSubDataNV</c>]</b><br/>  </summary>
            public static int CopyImageSubDataNV_(IntPtr hSrcRC, uint srcName, All srcTarget, int srcLevel, int srcX, int srcY, int srcZ, IntPtr hDstRC, uint dstName, All dstTarget, int dstLevel, int dstX, int dstY, int dstZ, int width, int height, int depth) => WglPointers._wglCopyImageSubDataNV_fnptr(hSrcRC, srcName, (uint)srcTarget, srcLevel, srcX, srcY, srcZ, hDstRC, dstName, (uint)dstTarget, dstLevel, dstX, dstY, dstZ, width, height, depth);
            ...
            public static int DXObjectAccessNV_(IntPtr hObject, All access) => WglPointers._wglDXObjectAccessNV_fnptr(hObject, (uint)access);
            ...
            public static int ReleaseVideoImageNV_(IntPtr hPbuffer, int iVideoBuffer) => WglPointers._wglReleaseVideoImageNV_fnptr(hPbuffer, iVideoBuffer);
