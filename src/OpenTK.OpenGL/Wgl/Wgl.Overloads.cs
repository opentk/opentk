...
namespace OpenTK.OpenGL.Wgl
{
    public static unsafe partial class Wgl
    {
        ...
        /// <inheritdoc cref="CopyContext(IntPtr, IntPtr, uint)"/>
        public static unsafe bool CopyContext(IntPtr hglrcSrc, IntPtr hglrcDst, uint mask)
        {
        ...
        /// <inheritdoc cref="SwapLayerBuffers(IntPtr, uint)"/>
        public static unsafe bool SwapLayerBuffers(IntPtr hdc, uint fuFlags)
        {
            bool returnValue_bool;
            int returnValue;
        ...
        /// <inheritdoc cref="UseFontOutlines(IntPtr, uint, uint, uint, float, float, int, IntPtr)"/>
        public static unsafe bool UseFontOutlines(IntPtr hDC, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr lpgmf)
        {
            bool returnValue_bool;
            int returnValue;
        ...
        /// <inheritdoc cref="UseFontOutlinesA(IntPtr, uint, uint, uint, float, float, int, IntPtr)"/>
        public static unsafe bool UseFontOutlinesA(IntPtr hDC, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr lpgmf)
        {
            bool returnValue_bool;
            int returnValue;
        ...
        /// <inheritdoc cref="UseFontOutlinesW(IntPtr, uint, uint, uint, float, float, int, IntPtr)"/>
        public static unsafe bool UseFontOutlinesW(IntPtr hDC, uint first, uint count, uint listBase, float deviation, float extrusion, int format, IntPtr lpgmf)
        {
            bool returnValue_bool;
            int returnValue;
        ...
        {
            /// <inheritdoc cref="SetStereoEmitterState3DL(IntPtr, uint)"/>
            public static unsafe bool SetStereoEmitterState3DL(IntPtr hDC, uint uState)
            {
                bool returnValue_bool;
                int returnValue;
        ...
        {
            /// <inheritdoc cref="BindTexImageARB(IntPtr, int)"/>
            public static unsafe bool BindTexImageARB(IntPtr hPbuffer, int iBuffer)
            {
                bool returnValue_bool;
                int returnValue;
            ...
            public static unsafe bool ChoosePixelFormatARB(IntPtr hdc, in int piAttribIList, in float pfAttribFList, uint nMaxFormats, ref int piFormats, ref uint nNumFormats)
            {
                bool returnValue_bool;
            ...
            public static unsafe bool GetPixelFormatAttribfvARB(IntPtr hdc, int iPixelFormat, int iLayerPlane, uint nAttributes, in int piAttributes, ref float pfValues)
            {
                bool returnValue_bool;
            ...
            public static unsafe bool GetPixelFormatAttribivARB(IntPtr hdc, int iPixelFormat, int iLayerPlane, uint nAttributes, in int piAttributes, ref int piValues)
            {
                bool returnValue_bool;
                fixed (int* piAttributes_ptr = &piAttributes)
            ...
            public static unsafe bool QueryPbufferARB(IntPtr hPbuffer, int iAttribute, ref int piValue)
            {
                bool returnValue_bool;
            ...
            /// <inheritdoc cref="ReleaseTexImageARB(IntPtr, int)"/>
            public static unsafe bool ReleaseTexImageARB(IntPtr hPbuffer, int iBuffer)
            {
                bool returnValue_bool;
                int returnValue;
        ...
        public static unsafe partial class EXT
        {
            ...
            public static unsafe bool GetPixelFormatAttribfvEXT(IntPtr hdc, int iPixelFormat, int iLayerPlane, uint nAttributes, ref int piAttributes, ref float pfValues)
            {
                bool returnValue_bool;
                fixed (int* piAttributes_ptr = &piAttributes)
                fixed (float* pfValues_ptr = &pfValues)
            ...
            public static unsafe bool GetPixelFormatAttribivEXT(IntPtr hdc, int iPixelFormat, int iLayerPlane, uint nAttributes, ref int piAttributes, ref int piValues)
            {
                bool returnValue_bool;
                fixed (int* piAttributes_ptr = &piAttributes)
                fixed (int* piValues_ptr = &piValues)
            ...
            public static unsafe bool QueryPbufferEXT(IntPtr hPbuffer, int iAttribute, ref int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
        ...
        public static unsafe partial class I3D
        {
            ...
            public static unsafe bool GetDigitalVideoParametersI3D(IntPtr hDC, int iAttribute, ref int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
            ...
            public static unsafe bool GetGammaTableParametersI3D(IntPtr hDC, int iAttribute, ref int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
            ...
            public static unsafe bool SetDigitalVideoParametersI3D(IntPtr hDC, int iAttribute, in int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
            ...
            public static unsafe bool SetGammaTableParametersI3D(IntPtr hDC, int iAttribute, in int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
        ...
        public static unsafe partial class NV
        {
            ...
            /// <inheritdoc cref="BindVideoImageNV(IntPtr, IntPtr, int)"/>
            public static unsafe bool BindVideoImageNV(IntPtr hVideoDevice, IntPtr hPbuffer, int iVideoBuffer)
            {
                bool returnValue_bool;
                int returnValue;
            ...
            /// <inheritdoc cref="CopyImageSubDataNV(IntPtr, uint, All, int, int, int, int, IntPtr, uint, All, int, int, int, int, int, int, int)"/>
            public static unsafe bool CopyImageSubDataNV(IntPtr hSrcRC, uint srcName, All srcTarget, int srcLevel, int srcX, int srcY, int srcZ, IntPtr hDstRC, uint dstName, All dstTarget, int dstLevel, int dstX, int dstY, int dstZ, int width, int height, int depth)
            {
                bool returnValue_bool;
                int returnValue;
            ...
            /// <inheritdoc cref="DXObjectAccessNV(IntPtr, All)"/>
            public static unsafe bool DXObjectAccessNV(IntPtr hObject, All access)
            {
                bool returnValue_bool;
                int returnValue;
            ...
            /// <inheritdoc cref="DXRegisterObjectNV(IntPtr, void*, uint, All, All)"/>
            public static unsafe IntPtr DXRegisterObjectNV(IntPtr hDevice, IntPtr dxObject, uint name, All type, All access)
            {
                IntPtr returnValue;
            ...
            /// <inheritdoc cref="DXRegisterObjectNV(IntPtr, void*, uint, All, All)"/>
            public static unsafe IntPtr DXRegisterObjectNV<T1>(IntPtr hDevice, ref T1 dxObject, uint name, All type, All access)
                where T1 : unmanaged
            {
                IntPtr returnValue;
            ...
            public static unsafe bool QueryCurrentContextNV(int iAttribute, ref int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
            ...
            public static unsafe bool QueryVideoCaptureDeviceNV(IntPtr hDc, IntPtr hDevice, int iAttribute, ref int piValue)
            {
                bool returnValue_bool;
                fixed (int* piValue_ptr = &piValue)
                {
            ...
            /// <inheritdoc cref="ReleaseVideoImageNV(IntPtr, int)"/>
            public static unsafe bool ReleaseVideoImageNV(IntPtr hPbuffer, int iVideoBuffer)
            {
                bool returnValue_bool;
                int returnValue;
            ...
            public static unsafe bool SendPbufferToVideoNV(IntPtr hPbuffer, int iBufferType, ref ulong pulCounterPbuffer, int bBlock)
            {
                bool returnValue_bool;
