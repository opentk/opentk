...
namespace OpenToolkit.Graphics.OpenGLES2.Extensions
{
    ...
    {
        public unsafe static partial class AlphaTest
        {
            [DllImport("opengl32.dll", EntryPoint = "glAlphaFuncQCOM")]
            public static extern void GlAlphaFunc(uint func, float reference);
            
        }
        public unsafe static partial class BinningControl
        {
        }
        ...
        public unsafe static partial class FramebufferFoveated
        {
            [DllImport("opengl32.dll", EntryPoint = "glFramebufferFoveationConfigQCOM")]
            public static extern void GlFramebufferFoveationConfig(uint framebuffer, uint numLayers, uint focalPointsPerLayer, uint requestedFeatures, uint* providedFeatures);
            
            [DllImport("opengl32.dll", EntryPoint = "glFramebufferFoveationParametersQCOM")]
            public static extern void GlFramebufferFoveationParameters(uint framebuffer, uint layer, uint focalPoint, float focalX, float focalY, float gainX, float gainY, float foveaArea);
            
        }
        public unsafe static partial class MotionEstimation
        {
            [DllImport("opengl32.dll", EntryPoint = "glTexEstimateMotionQCOM")]
            public static extern void GlTexEstimateMotion(uint reference, uint target, uint output);
            
            [DllImport("opengl32.dll", EntryPoint = "glTexEstimateMotionRegionsQCOM")]
            public static extern void GlTexEstimateMotionRegions(uint reference, uint target, uint output, uint mask);
            
        }
        public unsafe static partial class TextureFoveated
        {
            [DllImport("opengl32.dll", EntryPoint = "glTextureFoveationParametersQCOM")]
            public static extern void GlTextureFoveationParameters(uint texture, uint layer, uint focalPoint, float focalX, float focalY, float gainX, float gainY, float foveaArea);
            
        }
        public unsafe static partial class TextureFoveatedSubsampledLayout
        {
        }
        ...
        {
            [DllImport("opengl32.dll", EntryPoint = "glFramebufferFetchBarrierQCOM")]
            public static extern void GlFramebufferFetchBarrier();
            
        }
        public unsafe static partial class ShaderFramebufferFetchRate
        {
        }
        public unsafe static partial class ShadingRate
        {
            [DllImport("opengl32.dll", EntryPoint = "glShadingRateQCOM")]
            public static extern void GlShadingRate(uint rate);
        ...
        public unsafe static partial class YuvTextureGather
        {
        }
    }
}
