...
namespace OpenToolkit.Graphics.GL46
{
    public unsafe static partial class GL
    {
        ...
        public static extern void ClearBufferData(uint target, uint internalformat, uint format, uint type, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearBufferSubData")]
        public static extern void ClearBufferSubData(uint target, uint internalformat, IntPtr offset, IntPtr size, uint format, uint type, void* data);
        ...
        public static extern void GetInternalformati64v(uint target, uint internalformat, uint pname, int count, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glInvalidateTexSubImage")]
        public static extern void InvalidateTexSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth);
        
        [DllImport("opengl32.dll", EntryPoint = "glInvalidateTexImage")]
        public static extern void InvalidateTexImage(uint texture, int level);
        
        [DllImport("opengl32.dll", EntryPoint = "glInvalidateBufferSubData")]
        public static extern void InvalidateBufferSubData(uint buffer, IntPtr offset, IntPtr length);
        
        [DllImport("opengl32.dll", EntryPoint = "glInvalidateBufferData")]
        public static extern void InvalidateBufferData(uint buffer);
        ...
        public static extern void MultiDrawArraysIndirect(uint mode, void* indirect, int drawcount, int stride);
        
        [DllImport("opengl32.dll", EntryPoint = "glMultiDrawElementsIndirect")]
        public static extern void MultiDrawElementsIndirect(uint mode, uint type, void* indirect, int drawcount, int stride);
        ...
        public static extern int GetProgramResourceLocationIndex(uint program, uint programInterface, char* name);
        
        [DllImport("opengl32.dll", EntryPoint = "glShaderStorageBlockBinding")]
        public static extern void ShaderStorageBlockBinding(uint program, uint storageBlockIndex, uint storageBlockBinding);
        ...
        public static extern void TextureView(uint texture, uint target, uint origtexture, uint internalformat, uint minlevel, uint numlevels, uint minlayer, uint numlayers);
        ...
        public static extern void VertexAttribLFormat(uint attribindex, int size, uint type, uint relativeoffset);
        ...
        public static extern void BufferStorage(uint target, IntPtr size, void* data, uint flags);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearTexImage")]
        public static extern void ClearTexImage(uint texture, int level, uint format, uint type, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearTexSubImage")]
        public static extern void ClearTexSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, uint format, uint type, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindBuffersBase")]
        public static extern void BindBuffersBase(uint target, uint first, int count, uint* buffers);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindBuffersRange")]
        public static extern void BindBuffersRange(uint target, uint first, int count, uint* buffers, IntPtr* offsets, IntPtr* sizes);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindTextures")]
        public static extern void BindTextures(uint first, int count, uint* textures);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindSamplers")]
        public static extern void BindSamplers(uint first, int count, uint* samplers);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindImageTextures")]
        public static extern void BindImageTextures(uint first, int count, uint* textures);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindVertexBuffers")]
        public static extern void BindVertexBuffers(uint first, int count, uint* buffers, IntPtr* offsets, int* strides);
        
        [DllImport("opengl32.dll", EntryPoint = "glClipControl")]
        public static extern void ClipControl(uint origin, uint depth);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateTransformFeedbacks")]
        public static extern void CreateTransformFeedbacks(int n, uint* ids);
        
        [DllImport("opengl32.dll", EntryPoint = "glTransformFeedbackBufferBase")]
        public static extern void TransformFeedbackBufferBase(uint xfb, uint index, uint buffer);
        
        [DllImport("opengl32.dll", EntryPoint = "glTransformFeedbackBufferRange")]
        public static extern void TransformFeedbackBufferRange(uint xfb, uint index, uint buffer, IntPtr offset, IntPtr size);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTransformFeedbackiv")]
        public static extern void GetTransformFeedbackiv(uint xfb, uint pname, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTransformFeedbacki_v")]
        public static extern void GetTransformFeedbacki_v(uint xfb, uint pname, uint index, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTransformFeedbacki64_v")]
        public static extern void GetTransformFeedbacki64_v(uint xfb, uint pname, uint index, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateBuffers")]
        public static extern void CreateBuffers(int n, uint* buffers);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedBufferStorage")]
        public static extern void NamedBufferStorage(uint buffer, IntPtr size, void* data, uint flags);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedBufferData")]
        public static extern void NamedBufferData(uint buffer, IntPtr size, void* data, uint usage);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedBufferSubData")]
        public static extern void NamedBufferSubData(uint buffer, IntPtr offset, IntPtr size, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glCopyNamedBufferSubData")]
        public static extern void CopyNamedBufferSubData(uint readBuffer, uint writeBuffer, IntPtr readOffset, IntPtr writeOffset, IntPtr size);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearNamedBufferData")]
        public static extern void ClearNamedBufferData(uint buffer, uint internalformat, uint format, uint type, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearNamedBufferSubData")]
        public static extern void ClearNamedBufferSubData(uint buffer, uint internalformat, IntPtr offset, IntPtr size, uint format, uint type, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glMapNamedBuffer")]
        public static extern void* MapNamedBuffer(uint buffer, uint access);
        
        [DllImport("opengl32.dll", EntryPoint = "glMapNamedBufferRange")]
        public static extern void* MapNamedBufferRange(uint buffer, IntPtr offset, IntPtr length, uint access);
        
        [DllImport("opengl32.dll", EntryPoint = "glUnmapNamedBuffer")]
        public static extern byte UnmapNamedBuffer(uint buffer);
        
        [DllImport("opengl32.dll", EntryPoint = "glFlushMappedNamedBufferRange")]
        public static extern void FlushMappedNamedBufferRange(uint buffer, IntPtr offset, IntPtr length);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedBufferParameteriv")]
        public static extern void GetNamedBufferParameteriv(uint buffer, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedBufferParameteri64v")]
        public static extern void GetNamedBufferParameteri64v(uint buffer, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedBufferPointerv")]
        public static extern void GetNamedBufferPointerv(uint buffer, uint pname, void** parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedBufferSubData")]
        public static extern void GetNamedBufferSubData(uint buffer, IntPtr offset, IntPtr size, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateFramebuffers")]
        public static extern void CreateFramebuffers(int n, uint* framebuffers);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferRenderbuffer")]
        public static extern void NamedFramebufferRenderbuffer(uint framebuffer, uint attachment, uint renderbuffertarget, uint renderbuffer);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferParameteri")]
        public static extern void NamedFramebufferParameteri(uint framebuffer, uint pname, int param);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferTexture")]
        public static extern void NamedFramebufferTexture(uint framebuffer, uint attachment, uint texture, int level);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferTextureLayer")]
        public static extern void NamedFramebufferTextureLayer(uint framebuffer, uint attachment, uint texture, int level, int layer);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferDrawBuffer")]
        public static extern void NamedFramebufferDrawBuffer(uint framebuffer, uint buf);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferDrawBuffers")]
        public static extern void NamedFramebufferDrawBuffers(uint framebuffer, int n, uint* bufs);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedFramebufferReadBuffer")]
        public static extern void NamedFramebufferReadBuffer(uint framebuffer, uint src);
        
        [DllImport("opengl32.dll", EntryPoint = "glInvalidateNamedFramebufferData")]
        public static extern void InvalidateNamedFramebufferData(uint framebuffer, int numAttachments, uint* attachments);
        
        [DllImport("opengl32.dll", EntryPoint = "glInvalidateNamedFramebufferSubData")]
        public static extern void InvalidateNamedFramebufferSubData(uint framebuffer, int numAttachments, uint* attachments, int x, int y, int width, int height);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearNamedFramebufferiv")]
        public static extern void ClearNamedFramebufferiv(uint framebuffer, uint buffer, int drawbuffer, int* value);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearNamedFramebufferuiv")]
        public static extern void ClearNamedFramebufferuiv(uint framebuffer, uint buffer, int drawbuffer, uint* value);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearNamedFramebufferfv")]
        public static extern void ClearNamedFramebufferfv(uint framebuffer, uint buffer, int drawbuffer, float* value);
        
        [DllImport("opengl32.dll", EntryPoint = "glClearNamedFramebufferfi")]
        public static extern void ClearNamedFramebufferfi(uint framebuffer, uint buffer, int drawbuffer, float depth, int stencil);
        
        [DllImport("opengl32.dll", EntryPoint = "glBlitNamedFramebuffer")]
        public static extern void BlitNamedFramebuffer(uint readFramebuffer, uint drawFramebuffer, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, uint mask, uint filter);
        
        [DllImport("opengl32.dll", EntryPoint = "glCheckNamedFramebufferStatus")]
        public static extern uint CheckNamedFramebufferStatus(uint framebuffer, uint target);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedFramebufferParameteriv")]
        public static extern void GetNamedFramebufferParameteriv(uint framebuffer, uint pname, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedFramebufferAttachmentParameteriv")]
        public static extern void GetNamedFramebufferAttachmentParameteriv(uint framebuffer, uint attachment, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateRenderbuffers")]
        public static extern void CreateRenderbuffers(int n, uint* renderbuffers);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedRenderbufferStorage")]
        public static extern void NamedRenderbufferStorage(uint renderbuffer, uint internalformat, int width, int height);
        
        [DllImport("opengl32.dll", EntryPoint = "glNamedRenderbufferStorageMultisample")]
        public static extern void NamedRenderbufferStorageMultisample(uint renderbuffer, int samples, uint internalformat, int width, int height);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetNamedRenderbufferParameteriv")]
        public static extern void GetNamedRenderbufferParameteriv(uint renderbuffer, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateTextures")]
        public static extern void CreateTextures(uint target, int n, uint* textures);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureBuffer")]
        public static extern void TextureBuffer(uint texture, uint internalformat, uint buffer);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureBufferRange")]
        public static extern void TextureBufferRange(uint texture, uint internalformat, uint buffer, IntPtr offset, IntPtr size);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureStorage1D")]
        public static extern void TextureStorage1D(uint texture, int levels, uint internalformat, int width);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureStorage2D")]
        public static extern void TextureStorage2D(uint texture, int levels, uint internalformat, int width, int height);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureStorage3D")]
        public static extern void TextureStorage3D(uint texture, int levels, uint internalformat, int width, int height, int depth);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureStorage2DMultisample")]
        public static extern void TextureStorage2DMultisample(uint texture, int samples, uint internalformat, int width, int height, byte fixedsamplelocations);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureStorage3DMultisample")]
        public static extern void TextureStorage3DMultisample(uint texture, int samples, uint internalformat, int width, int height, int depth, byte fixedsamplelocations);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureSubImage1D")]
        public static extern void TextureSubImage1D(uint texture, int level, int xoffset, int width, uint format, uint type, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureSubImage2D")]
        public static extern void TextureSubImage2D(uint texture, int level, int xoffset, int yoffset, int width, int height, uint format, uint type, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureSubImage3D")]
        public static extern void TextureSubImage3D(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, uint format, uint type, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glCompressedTextureSubImage1D")]
        public static extern void CompressedTextureSubImage1D(uint texture, int level, int xoffset, int width, uint format, int imageSize, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glCompressedTextureSubImage2D")]
        public static extern void CompressedTextureSubImage2D(uint texture, int level, int xoffset, int yoffset, int width, int height, uint format, int imageSize, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glCompressedTextureSubImage3D")]
        public static extern void CompressedTextureSubImage3D(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, uint format, int imageSize, void* data);
        
        [DllImport("opengl32.dll", EntryPoint = "glCopyTextureSubImage1D")]
        public static extern void CopyTextureSubImage1D(uint texture, int level, int xoffset, int x, int y, int width);
        
        [DllImport("opengl32.dll", EntryPoint = "glCopyTextureSubImage2D")]
        public static extern void CopyTextureSubImage2D(uint texture, int level, int xoffset, int yoffset, int x, int y, int width, int height);
        
        [DllImport("opengl32.dll", EntryPoint = "glCopyTextureSubImage3D")]
        public static extern void CopyTextureSubImage3D(uint texture, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width, int height);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureParameterf")]
        public static extern void TextureParameterf(uint texture, uint pname, float param);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureParameterfv")]
        public static extern void TextureParameterfv(uint texture, uint pname, float* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureParameteri")]
        public static extern void TextureParameteri(uint texture, uint pname, int param);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureParameterIiv")]
        public static extern void TextureParameterIiv(uint texture, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureParameterIuiv")]
        public static extern void TextureParameterIuiv(uint texture, uint pname, uint* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureParameteriv")]
        public static extern void TextureParameteriv(uint texture, uint pname, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glGenerateTextureMipmap")]
        public static extern void GenerateTextureMipmap(uint texture);
        
        [DllImport("opengl32.dll", EntryPoint = "glBindTextureUnit")]
        public static extern void BindTextureUnit(uint unit, uint texture);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureImage")]
        public static extern void GetTextureImage(uint texture, int level, uint format, uint type, int bufSize, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetCompressedTextureImage")]
        public static extern void GetCompressedTextureImage(uint texture, int level, int bufSize, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureLevelParameterfv")]
        public static extern void GetTextureLevelParameterfv(uint texture, int level, uint pname, float* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureLevelParameteriv")]
        public static extern void GetTextureLevelParameteriv(uint texture, int level, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureParameterfv")]
        public static extern void GetTextureParameterfv(uint texture, uint pname, float* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureParameterIiv")]
        public static extern void GetTextureParameterIiv(uint texture, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureParameterIuiv")]
        public static extern void GetTextureParameterIuiv(uint texture, uint pname, uint* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetTextureParameteriv")]
        public static extern void GetTextureParameteriv(uint texture, uint pname, int* parameters);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateVertexArrays")]
        public static extern void CreateVertexArrays(int n, uint* arrays);
        ...
        public static extern void VertexArrayVertexBuffers(uint vaobj, uint first, int count, uint* buffers, IntPtr* offsets, int* strides);
        ...
        public static extern void VertexArrayAttribFormat(uint vaobj, uint attribindex, int size, uint type, byte normalized, uint relativeoffset);
        
        [DllImport("opengl32.dll", EntryPoint = "glVertexArrayAttribIFormat")]
        public static extern void VertexArrayAttribIFormat(uint vaobj, uint attribindex, int size, uint type, uint relativeoffset);
        
        [DllImport("opengl32.dll", EntryPoint = "glVertexArrayAttribLFormat")]
        public static extern void VertexArrayAttribLFormat(uint vaobj, uint attribindex, int size, uint type, uint relativeoffset);
        
        [DllImport("opengl32.dll", EntryPoint = "glVertexArrayBindingDivisor")]
        public static extern void VertexArrayBindingDivisor(uint vaobj, uint bindingindex, uint divisor);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetVertexArrayiv")]
        public static extern void GetVertexArrayiv(uint vaobj, uint pname, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetVertexArrayIndexediv")]
        public static extern void GetVertexArrayIndexediv(uint vaobj, uint index, uint pname, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetVertexArrayIndexed64iv")]
        public static extern void GetVertexArrayIndexed64iv(uint vaobj, uint index, uint pname, int* param);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateSamplers")]
        public static extern void CreateSamplers(int n, uint* samplers);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateProgramPipelines")]
        public static extern void CreateProgramPipelines(int n, uint* pipelines);
        
        [DllImport("opengl32.dll", EntryPoint = "glCreateQueries")]
        public static extern void CreateQueries(uint target, int n, uint* ids);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetQueryBufferObjecti64v")]
        public static extern void GetQueryBufferObjecti64v(uint id, uint buffer, uint pname, IntPtr offset);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetQueryBufferObjectiv")]
        public static extern void GetQueryBufferObjectiv(uint id, uint buffer, uint pname, IntPtr offset);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetQueryBufferObjectui64v")]
        public static extern void GetQueryBufferObjectui64v(uint id, uint buffer, uint pname, IntPtr offset);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetQueryBufferObjectuiv")]
        public static extern void GetQueryBufferObjectuiv(uint id, uint buffer, uint pname, IntPtr offset);
        ...
        public static extern void GetTextureSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, uint format, uint type, int bufSize, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetCompressedTextureSubImage")]
        public static extern void GetCompressedTextureSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int bufSize, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetGraphicsResetStatus")]
        public static extern uint GetGraphicsResetStatus();
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnCompressedTexImage")]
        public static extern void GetnCompressedTexImage(uint target, int lod, int bufSize, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnTexImage")]
        public static extern void GetnTexImage(uint target, int level, uint format, uint type, int bufSize, void* pixels);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnUniformdv")]
        public static extern void GetnUniformdv(uint program, int location, int bufSize, double* parameters);
        ...
        [DllImport("opengl32.dll", EntryPoint = "glGetnMapdv")]
        public static extern void GetnMapdv(uint target, uint query, int bufSize, double* v);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnMapfv")]
        public static extern void GetnMapfv(uint target, uint query, int bufSize, float* v);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnMapiv")]
        public static extern void GetnMapiv(uint target, uint query, int bufSize, int* v);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnPixelMapfv")]
        public static extern void GetnPixelMapfv(uint map, int bufSize, float* values);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnPixelMapuiv")]
        public static extern void GetnPixelMapuiv(uint map, int bufSize, uint* values);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnPixelMapusv")]
        public static extern void GetnPixelMapusv(uint map, int bufSize, ushort* values);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnPolygonStipple")]
        public static extern void GetnPolygonStipple(int bufSize, byte* pattern);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnColorTable")]
        public static extern void GetnColorTable(uint target, uint format, uint type, int bufSize, void* table);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnConvolutionFilter")]
        public static extern void GetnConvolutionFilter(uint target, uint format, uint type, int bufSize, void* image);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnSeparableFilter")]
        public static extern void GetnSeparableFilter(uint target, uint format, uint type, int rowBufSize, void* row, int columnBufSize, void* column, void* span);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnHistogram")]
        public static extern void GetnHistogram(uint target, byte reset, uint format, uint type, int bufSize, void* values);
        
        [DllImport("opengl32.dll", EntryPoint = "glGetnMinmax")]
        public static extern void GetnMinmax(uint target, byte reset, uint format, uint type, int bufSize, void* values);
        
        [DllImport("opengl32.dll", EntryPoint = "glTextureBarrier")]
        public static extern void TextureBarrier();
        
        [DllImport("opengl32.dll", EntryPoint = "glSpecializeShader")]
        public static extern void SpecializeShader(uint shader, char* pEntryPoint, uint numSpecializationConstants, uint* pConstantIndex, uint* pConstantValue);
        
        [DllImport("opengl32.dll", EntryPoint = "glMultiDrawArraysIndirectCount")]
        public static extern void MultiDrawArraysIndirectCount(uint mode, void* indirect, IntPtr drawcount, int maxdrawcount, int stride);
        
        [DllImport("opengl32.dll", EntryPoint = "glMultiDrawElementsIndirectCount")]
        public static extern void MultiDrawElementsIndirectCount(uint mode, uint type, void* indirect, IntPtr drawcount, int maxdrawcount, int stride);
        
        [DllImport("opengl32.dll", EntryPoint = "glPolygonOffsetClamp")]
        public static extern void PolygonOffsetClamp(float factor, float units, float clamp);
