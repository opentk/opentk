...
namespace OpenTK.Core.Platform
{
    ...
    /// </summary>
    public class GamepadBatteryInfo
    {
        /// <summary>
        /// The type of battery contained in the gamepad.
        /// </summary>
        public GamepadBatteryType BatteryType { get; internal set; }
        ...
        /// </remarks>
        public float ChargeLevel { get; internal set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="GamepadBatteryInfo"/> class.
        /// </summary>
