...
namespace Bind.Generators
{
    ...
    internal interface IGeneratorSettings
    {
        ...
        /// <summary>
        /// Gets the name container for this generator.
        /// </summary>
        NameContainer NameContainer { get; }

        /// <summary>
        /// Gets the extensions namespace.
        /// </summary>
        string ExtensionNamespace { get; }
    }
}
