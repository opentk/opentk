...
namespace Generator.Convert.Construction
{
    ...
    {
        /// <summary>
        /// Gets the overrides read from the override files specified in <see cref="Program.CliOptions"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the overrides for this profile using the <see cref="Program.CliOptions"/>, and then applies them to the
        /// profile.
        /// </summary>
