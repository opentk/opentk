...
using OpenToolkit.Platform.Dummy;
using OpenToolkit.Platform.Egl;
using OpenToolkit.Platform.SDL2;
using OpenToolkit.Platform.X11;
...
namespace OpenToolkit.Platform
{
    ...
    public static class Utilities
    {
        ...
        {
#if WIN32
            return new OpenToolkit.Platform.Windows.WinWindowInfo(windowHandle, null);
            #else
...
/// <returns>A new IWindowInfo instance.</returns>
        public static IWindowInfo CreateMacOSCarbonWindowInfo(IntPtr windowHandle, bool ownHandle, bool isControl,
            OpenToolkit.Platform.MacOS.GetInt xOffset, OpenToolkit.Platform.MacOS.GetInt yOffset)
        {
            return new OpenToolkit.Platform.MacOS.CarbonWindowInfo(windowHandle, false, isControl, xOffset, yOffset);
        }
        #endif
        ...
        {
#if CARBON
            return new OpenToolkit.Platform.MacOS.CocoaWindowInfo(windowHandle);
            #else
            return new DummyWindowInfo();
#endif
        }
        ...
        {
#if CARBON
            return new OpenToolkit.Platform.MacOS.CocoaWindowInfo(windowHandle, viewHandle);
            #else
            return new DummyWindowInfo();
#endif
        }
