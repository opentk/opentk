...
namespace OpenTK.NT.Native
{
    public static class Gdi32
    {
        ...
        /// <returns>If the function succeeds, the return value is a pixel format index (one-based) that is the closest match to the given pixel format descriptor.<br/>
        ...
        /// <returns>If the function succeeds, the return value is the maximum pixel format index of the device context. In addition, the function sets the members of the <see cref="PixelFormatDescriptor"/> structure pointed to by <paramref name="ppfd"/> according to the specified pixel format.<br/>
        /// If the function fails, the return value is zero. To get extended error information, call <see cref="Marshal.GetLastWin32Error"/>.</returns>
        [DllImport(Library, SetLastError = true)]
        ...
        /// <returns>If the function succeeds, the return value is true.<br/>
        ...
        /// <returns>The return value specifies the value of the desired item.<br/>
        ...
        /// <returns>If the function succeeds, the return value is a handle to the requested logical object.<br/>
        ...
        /// <remarks>Do not delete a drawing object (pen or brush) while it is still selected into a DC.<br/>
