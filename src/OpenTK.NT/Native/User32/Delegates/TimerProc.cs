...
{
    /// <summary>
    /// An application-defined callback function that processes <see cref="WindowMessage.Timer"/> messages. TimerProc is a placeholder for the application-defined function name. 
    /// </summary>
