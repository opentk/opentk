...
namespace OpenToolkit.Audio.OpenAL
{
    ...
    public partial class AL : ApiContainer<AL>
    {
        ...
        */
        ...
        private static unsafe extern void ListenerPrivate(ALListenerfv param, float* values);
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alGetListenerfv", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        private static unsafe extern void GenSourcesPrivate(int n, [Out] uint* sources);
        ...
        public static unsafe extern void DeleteSources(int n, [In] uint* sources); // Delete Source objects
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alIsSource", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourcef", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
...
#pragma warning disable SA1625 // Element documentation should not be copied and pasted
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSource3f", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
...
#pragma warning restore SA1625 // Element documentation should not be copied and pasted
        ...
        /// <param name="value">The value to set the attribute to.</param>
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourcei", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSource3i", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        /// <param name="param">The name of the attribute to set: ALSourcef.Pitch, Gain, MinGain, MaxGain, MaxDistance, RolloffFactor, ConeOuterGain, ConeInnerAngle, ConeOuterAngle, ReferenceDistance, EfxAirAbsorptionFactor, EfxRoomRolloffFactor, EfxConeOuterGainHighFrequency.</param>
        /// <param name="value">A pointer to the floating-point value being retrieved.</param>
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alGetSourcef", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
...
#pragma warning disable SA1625 // Element documentation should not be copied and pasted
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alGetSource3f", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
#pragma warning restore SA1625 // Element documentation should not be copied and pasted
...
#pragma warning restore SA1625 // Element documentation should not be copied and pasted
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alGetSourcei", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourcePlayv"), SuppressUnmanagedCodeSecurity]
        public static unsafe extern void SourcePlay(int ns, [In] uint* sids);
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourceStopv"), SuppressUnmanagedCodeSecurity]
        public static unsafe extern void SourceStop(int ns, [In] uint* sids);
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourceRewindv"), SuppressUnmanagedCodeSecurity]
        public static unsafe extern void SourceRewind(int ns, [In] uint* sids);
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourcePausev"), SuppressUnmanagedCodeSecurity]
        public static unsafe extern void SourcePause(int ns, [In] uint* sids);
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourcePlay", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourceStop", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourceRewind", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourcePause", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourceQueueBuffers"), SuppressUnmanagedCodeSecurity]
        public static unsafe extern void SourceQueueBuffers(uint sid, int numEntries, [In] uint* bids);
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alSourceUnqueueBuffers"), SuppressUnmanagedCodeSecurity]
        public static unsafe extern void SourceUnqueueBuffers(uint sid, int numEntries, [In] uint* bids);
        ...
        public static unsafe extern void GenBuffers(int n, [Out] uint* buffers);
        ...
        public static unsafe extern void DeleteBuffers(int n, [In] uint* buffers);
        ...
        /// <returns>Success.</returns>
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alIsBuffer", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alBufferData", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
        ...
        */
        ...
        [CLSCompliant(false), DllImport(Lib, EntryPoint = "alGetBufferi", ExactSpelling = true, CallingConvention = Style), SuppressUnmanagedCodeSecurity]
