...
namespace XrGenerator
{
    ...
    public static class Reader
    {
        ...
        public static FileStream ReadXRSpecFromGithub()
        {
            string url = "https://raw.githubusercontent.com/KhronosGroup/OpenXR-Docs/refs/heads/main/specification/registry/xr.xml";
            string filePath = Path.Combine(TempDirectory, "xr.xml");
