...
namespace OpenToolkit
{
    ...
    public static class Color4
    {
        ...
        public static Color4<Rgba> Add(in Color4<Rgba> left, in Color4<Rgba> right) =>
        ...
        public static Color4<Rgba> Subtract(in Color4<Rgba> left, in Color4<Rgba> right) =>
            new Color4<Rgba>(left.X - right.X, left.Y - right.Y, left.Z - right.Z, left.W - right.W);
        ...
        public static Color4<Rgba> Multiply(in Color4<Rgba> left, in Color4<Rgba> right) =>
            new Color4<Rgba>(left.X * right.X, left.Y * right.Y, left.Z * right.Z, left.W * right.W);
        ...
        public static Color4<Rgba> Multiply(in Color4<Rgba> left, in float right) =>
        ...
        /// <summary>
        /// Converts a <see cref="Color4{Rgba}"/> to a <see cref="Color"/>.
        /// </summary>
        /// <param name="col">The color to convert.</param>
        /// <returns>The converted color.</returns>
        public static Color ToSystemColor(this in Color4<Rgba> col) =>
            Color.FromArgb((int)col.W * 255, (int)col.X * 255, (int)col.Y * 255, (int)col.Z * 255);

        /// <summary>
        /// Converts a <see cref="Color"/> to a <see cref="Color4{Rgba}"/>.
        /// </summary>
        /// <param name="col">The color to convert.</param>
        /// <returns>The converted color.</returns>
        public static Color4<Rgba> ToOpenTkColor(this in Color col) =>
            new Color4<Rgba>(col.R / 255f, col.G / 255f, col.B / 255f, col.B / 255f);
