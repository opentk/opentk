...
namespace Generator.Convert.Documentation
{
    ...
    public class ProfileDocumentation
    {
        ...
        {
            return _documentedFunctions.TryGetValue(function.NativeName, out documentation);
        }
        ...
        [NotNull]
        public FunctionDocumentation GetDocumentation([NotNull] Function function)
        {
            return _documentedFunctions[function.NativeName];
        }
        ...
        /// <param name="function">The function.</param>
        /// <returns>true if the function has documentation; otherwise, false.</returns>
        public bool HasDocumentation([NotNull] Function function)
        {
            return _documentedFunctions.ContainsKey(function.NativeName);
        }
    }
}
