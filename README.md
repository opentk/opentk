...
OpenTK is available for Windows, Linux, Mac OS X, *BSD and SteamOS, and to a limited extent Android and iOS via Xamarin. It can be used standalone or integrated into a GUI (Windows.Forms, WPF, GTK+, Qt, VTK, ...)
