...
namespace OpenTK.OpenAL
{
    public partial class Efx
    {
        ...
        public enum a : int
        {
            ...
            ///<summary>Range [float.MinValue .. float.MaxValue] Default: 1.0f</summary>
             ...
             * al source values.
             */
            ///<summary>Range [  ..  ] Default: </summary>
            AL_DIRECT_FILTER = 0x20005,
            ///<summary>Range [  ..  ] Default: </summary>
            AL_AUXILIARY_SEND_FILTER = 0x20006,

            ///<summary>Range [0.0f .. 10.0f] Default: 0.0f</summary>
            ...
            ///<summary>Range [AL_FALSE .. AL_TRUE] Default: AL_TRUE</summary>
        ...
        {
            ///<summary>Range [0.0f .. 1.0f] Default: 0.1f</summary>
            AL_REVERB_DENSITY = 0x0001,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.1f</summary>
            AL_REVERB_DIFFUSION = 0x0002,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.32f</summary>
            AL_REVERB_GAIN = 0x0003,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.89f</summary>
            AL_REVERB_GAINHF = 0x0004,
            ///<summary>Range [0.1f .. 20.0f] Default: 1.49f</summary>
            AL_REVERB_DECAY_TIME = 0x0005,
            ///<summary>Range [0.1f .. 2.0f] Default: 0.83f</summary>
            AL_REVERB_DECAY_HFRATIO = 0x0006,
            ///<summary>Range [0.0f .. 3.16f] Default: 0.05f</summary>
            AL_REVERB_REFLECTIONS_GAIN = 0x0007,
            ///<summary>Range [0.0f .. 0.3f] Default: 0.007f</summary>
            AL_REVERB_REFLECTIONS_DELAY = 0x0008,
            ///<summary>Range [0.0f .. 10.0f] Default: 1.26f</summary>
            AL_REVERB_LATE_REVERB_GAIN = 0x0009,
            ///<summary>Range [0.0f .. 0.1f] Default: 0.011f</summary>
            AL_REVERB_LATE_REVERB_DELAY = 0x000A,
            ///<summary>Range [0.892f .. 1.0f] Default: 0.994f</summary>
        ...
        {
            ///<summary>Range [0 .. 1] Default: 1</summary>
            AL_CHORUS_WAVEFORM = 0x0001,
            ///<summary>Range [-180 .. 180] Default: 90</summary>
            AL_CHORUS_PHASE = 0x0002,
            ///<summary>Range [0.0f .. 10.0f] Default: 1.1f</summary>
            AL_CHORUS_RATE = 0x0003,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.1f</summary>
            AL_CHORUS_DEPTH = 0x0004,
            ///<summary>Range [-1.0f .. +1.0f] Default: +0.25f</summary>
            AL_CHORUS_FEEDBACK = 0x0005,
            ///<summary>Range [0.0f .. 0.016f] Default:  0.016f</summary>
        ...
        {
            ///<summary>Range [0.0f .. 1.0f] Default: 0.2f</summary>
            AL_DISTORTION_EDGE = 0x0001,
            ///<summary>Range [0.01f .. 1.0f] Default: 0.05f</summary>
            AL_DISTORTION_GAIN = 0x0002,
            ///<summary>Range [80.0f .. 24000.0f] Default: 8000.0f</summary>
            AL_DISTORTION_LOWPASS_CUTOFF = 0x0003,
            ///<summary>Range [80.0f .. 24000.0f] Default: 3600.0f</summary>
        ...
        {
            ///<summary>Range [0.0f .. 0.207f] Default: 0.1f</summary>
            AL_ECHO_DELAY = 0x0001,
            ///<summary>Range [0.0f .. 0.404f] Default: 0.1f</summary>
            AL_ECHO_LRDELAY = 0x0002,
            ///<summary>Range [0.0f .. 0.99f] Default: 0.5f</summary>
            AL_ECHO_DAMPING = 0x0003,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.5f</summary>
            AL_ECHO_FEEDBACK = 0x0004,
            ///<summary>Range [-1.0f .. +1.0f] Default: -1.0f</summary>
        ...
        public enum AL_EFFECT_FLANGER : int
        {
            ...
            ///<summary>Range [-180 .. +180] Default: 0</summary>
            AL_FLANGER_PHASE = 0x0002,
            ///<summary>Range [0.0f .. 10.0f] Default: 0.27f</summary>
            AL_FLANGER_RATE = 0x0003,
            ///<summary>Range [0.0f .. 1.0f] Default: 1.0f</summary>
            AL_FLANGER_DEPTH = 0x0004,
            ///<summary>Range [-1.0f .. +1.0f] Default: -0.5f</summary>
            AL_FLANGER_FEEDBACK = 0x0005,
            ///<summary>Range [0.0f .. 0.004f] Default: 0.002f</summary>
        ...
        {
            ///<summary>Range [0.0f .. 24000.0f] Default: 0.0f</summary>
            AL_FREQUENCY_SHIFTER_FREQUENCY = 0x0001,
            ///<summary>Range [0 .. 2] Default: 0</summary>
        ...
        {
            ///<summary>Range [0 .. 92] Default: 0, AL_VOCAL_MORPHER_PHONEME_A</summary>
            AL_VOCAL_MORPHER_PHONEMEA = 0x0001,
            ///<summary>Range [-24 .. +24] Default: 0</summary>
            AL_VOCAL_MORPHER_PHONEMEA_COARSE_TUNING = 0x0002,
            ///<summary>Range [0 .. 29] Default: 10, AL_VOCAL_MORPHER_PHONEME_ER</summary>
            AL_VOCAL_MORPHER_PHONEMEB = 0x0003,
            ///<summary>Range [-24 .. +24] Default: 0</summary>
            AL_VOCAL_MORPHER_PHONEMEB_COARSE_TUNING = 0x0004,
            ///<summary>Range [0 .. 2] Default: 0</summary>
            AL_VOCAL_MORPHER_WAVEFORM = 0x0005,
            ///<summary>Range [0.0f .. 10.0f] Default: 1.41f</summary>
        ...
        {
            ///<summary>Range [-12 .. +12] Default: +12</summary>
            AL_PITCH_SHIFTER_COARSE_TUNE = 0x0001,
            ///<summary>Range [-50 .. +50] Default: 0</summary>
        ...
        {
            ///<summary>Range [0.0f .. 8000.0f] Default: 440.0f</summary>
            AL_RING_MODULATOR_FREQUENCY = 0x0001,
            ///<summary>Range [0.0f .. 24000.0f] Default: 800.0f</summary>
        ...
        {
            ///<summary>Range [0.0001f .. 1.0f] Default: 0.06f</summary>
            AL_AUTOWAH_ATTACK_TIME = 0x0001,
            ///<summary>Range [0.0001f .. 1.0f] Default: 0.06f</summary>
            AL_AUTOWAH_RELEASE_TIME = 0x0002,
            ///<summary>Range [2.0f .. 1000.0f] Default: 1000.0f</summary>
            AL_AUTOWAH_RESONANCE = 0x0003,
            ///<summary>Range [0.00003f .. 31621.0f] Default: 11.22f</summary>
        ...
        {
            ///<summary>Range [0.126f .. 7.943f] Default: 1.0f</summary>
            AL_EQUALIZER_LOW_GAIN = 0x0001,
            ///<summary>Range [50.0f .. 800.0f] Default: 200.0f</summary>
            AL_EQUALIZER_LOW_CUTOFF = 0x0002,
            ///<summary>Range [0.126f .. 7.943f] Default: 1.0f</summary>
            AL_EQUALIZER_MID1_GAIN = 0x0003,
            ///<summary>Range [200.0f .. 3000.0f] Default: 500.0f</summary>
            AL_EQUALIZER_MID1_CENTER = 0x0004,
            ///<summary>Range [0.01f .. 1.0f] Default: 1.0f</summary>
            AL_EQUALIZER_MID1_WIDTH = 0x0005,
            ///<summary>Range [0.126f .. 7.943f] Default: 1.0f</summary>
            AL_EQUALIZER_MID2_GAIN = 0x0006,
            ///<summary>Range [1000.0f .. 8000.0f] Default: 3000.0f</summary>
            AL_EQUALIZER_MID2_CENTER = 0x0007,
            ///<summary>Range [0.01f .. 1.0f] Default: 1.0f</summary>
            AL_EQUALIZER_MID2_WIDTH = 0x0008,
            ///<summary>Range [0.126f .. 7.943f] Default: 1.0f</summary>
            AL_EQUALIZER_HIGH_GAIN = 0x0009,
            ///<summary>Range [4000.0f .. 16000.0f] Default: 6000.0f</summary>
        ...
        public enum EaxReverb : int
        {
            ...
            ///<summary>Range [0.075f .. 0.25f] Default: 0.25f</summary>
            AL_EAXREVERB_ECHO_TIME = 0x000F,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.0f</summary>
            AL_EAXREVERB_ECHO_DEPTH = 0x0010,
            ///<summary>Range [0.04f .. 4.0f] Default: 0.25f</summary>
            AL_EAXREVERB_MODULATION_TIME = 0x0011,
            ///<summary>Range [0.0f .. 1.0f] Default: 0.0f</summary>
            AL_EAXREVERB_MODULATION_DEPTH = 0x0012,
            ///<summary>Range [0.892f .. 1.0f] Default: 0.994f</summary>
            AL_EAXREVERB_AIR_ABSORPTION_GAINHF = 0x0013,
            ///<summary>Range [1000.0f .. 20000.0f] Default: 5000.0f</summary>
            AL_EAXREVERB_HFREFERENCE = 0x0014,
            ///<summary>Range [20.0f .. 1000.0f] Default: 250.0f</summary>
