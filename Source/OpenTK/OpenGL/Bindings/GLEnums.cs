namespace OpenTK.OpenGL
{
    namespace Enums
    {
        ...
        {
            StencilBufferBit = ((int)AttribMask.StencilBufferBit),
            AccumBufferBit = ((int)AttribMask.AccumBufferBit),
            ColorBufferBit = ((int)AttribMask.ColorBufferBit),
            DepthBufferBit = ((int)AttribMask.DepthBufferBit),
        }
        ...
        {
            ConstantColorExt = ((int)ExtBlendColor.ConstantColorExt),
            OneMinusSrcAlpha = ((int)0x0303),
            One = ((int)1),
            OneMinusDstAlpha = ((int)0x0305),
            OneMinusConstantColorExt = ((int)ExtBlendColor.OneMinusConstantColorExt),
            SrcColor = ((int)0x0300),
            OneMinusSrcColor = ((int)0x0301),
            ConstantAlphaExt = ((int)ExtBlendColor.ConstantAlphaExt),
            SrcAlpha = ((int)0x0302),
            DstAlpha = ((int)0x0304),
            Zero = ((int)0),
            OneMinusConstantAlphaExt = ((int)ExtBlendColor.OneMinusConstantAlphaExt),
        }

        public enum BlendingFactorSrc
        {
            ConstantColorExt = ((int)ExtBlendColor.ConstantColorExt),
            OneMinusSrcAlpha = ((int)BlendingFactorDest.OneMinusSrcAlpha),
            One = ((int)BlendingFactorDest.One),
            SrcAlphaSaturate = ((int)0x0308),
            OneMinusConstantColorExt = ((int)ExtBlendColor.OneMinusConstantColorExt),
            OneMinusDstAlpha = ((int)BlendingFactorDest.OneMinusDstAlpha),
            OneMinusDstColor = ((int)0x0307),
            ConstantAlphaExt = ((int)ExtBlendColor.ConstantAlphaExt),
            SrcAlpha = ((int)BlendingFactorDest.SrcAlpha),
            DstColor = ((int)0x0306),
            Zero = ((int)BlendingFactorDest.Zero),
            DstAlpha = ((int)BlendingFactorDest.DstAlpha),
            OneMinusConstantAlphaExt = ((int)ExtBlendColor.OneMinusConstantAlphaExt),
        }

        public enum BlendEquationModeExt
        {
            FuncSubtractExt = ((int)ExtBlendSubtract.FuncSubtractExt),
            FuncAddExt = ((int)ExtBlendMinmax.FuncAddExt),
            MaxExt = ((int)ExtBlendMinmax.MaxExt),
            AlphaMinSgix = ((int)SgixBlendAlphaMinmax.AlphaMinSgix),
            FuncReverseSubtractExt = ((int)ExtBlendSubtract.FuncReverseSubtractExt),
            AlphaMaxSgix = ((int)SgixBlendAlphaMinmax.AlphaMaxSgix),
            MinExt = ((int)ExtBlendMinmax.MinExt),
            LogicOp = ((int)GetPName.LogicOp),
        }

        public enum ColorMaterialFace
        {
            Front = ((int)DrawBufferMode.Front),
            FrontAndBack = ((int)DrawBufferMode.FrontAndBack),
        ...
        public enum ColorMaterialParameter
        {
            ...
            AmbientAndDiffuse = ((int)MaterialParameter.AmbientAndDiffuse),
        ...
        {
            UnsignedByte = ((int)DataType.UnsignedByte),
            Byte = ((int)DataType.Byte),
            UnsignedInt = ((int)DataType.UnsignedInt),
            Short = ((int)DataType.Short),
            Int = ((int)DataType.Int),
            Float = ((int)DataType.Float),
            Double = ((int)DataType.Double),
            UnsignedShort = ((int)DataType.UnsignedShort),
        }

        public enum ColorTableParameterPNameSgi
        {
            ColorTableScaleSgi = ((int)SgiColorTable.ColorTableScaleSgi),
            ColorTableBiasSgi = ((int)SgiColorTable.ColorTableBiasSgi),
        }

        public enum ColorTableTargetSgi
        {
            ProxyTextureColorTableSgi = ((int)SgiTextureColorTable.ProxyTextureColorTableSgi),
            PostColorMatrixColorTableSgi = ((int)SgiColorTable.PostColorMatrixColorTableSgi),
            ProxyPostConvolutionColorTableSgi = ((int)SgiColorTable.ProxyPostConvolutionColorTableSgi),
            TextureColorTableSgi = ((int)SgiTextureColorTable.TextureColorTableSgi),
            PostConvolutionColorTableSgi = ((int)SgiColorTable.PostConvolutionColorTableSgi),
            ProxyPostColorMatrixColorTableSgi = ((int)SgiColorTable.ProxyPostColorMatrixColorTableSgi),
            ProxyColorTableSgi = ((int)SgiColorTable.ProxyColorTableSgi),
            ColorTableSgi = ((int)SgiColorTable.ColorTableSgi),
        }

        public enum ConvolutionBorderModeExt
        {
            ReduceExt = ((int)ExtConvolution.ReduceExt),
        }

        public enum ConvolutionParameterExt
        {
            ConvolutionFilterBiasExt = ((int)ExtConvolution.ConvolutionFilterBiasExt),
            ConvolutionFilterScaleExt = ((int)ExtConvolution.ConvolutionFilterScaleExt),
            ConvolutionBorderModeExt = ((int)ExtConvolution.ConvolutionBorderModeExt),
        }

        public enum ConvolutionTargetExt
        {
            Convolution2dExt = ((int)ExtConvolution.Convolution2dExt),
            Convolution1dExt = ((int)ExtConvolution.Convolution1dExt),
        }
        ...
        public enum EnableCap
        {
            ...
            SampleAlphaToOneSgis = ((int)SgisMultisample.SampleAlphaToOneSgis),
            FragmentLight5Sgix = ((int)SgixFragmentLighting.FragmentLight5Sgix),
            FragmentLight6Sgix = ((int)SgixFragmentLighting.FragmentLight6Sgix),
            ColorMaterial = ((int)GetPName.ColorMaterial),
            PolygonOffsetFill = ((int)GetPName.PolygonOffsetFill),
            FragmentLight7Sgix = ((int)SgixFragmentLighting.FragmentLight7Sgix),
            Lighting = ((int)GetPName.Lighting),
            FragmentLight3Sgix = ((int)SgixFragmentLighting.FragmentLight3Sgix),
            FragmentLightingSgix = ((int)SgixFragmentLighting.FragmentLightingSgix),
            PolygonStipple = ((int)GetPName.PolygonStipple),
            CullFace = ((int)GetPName.CullFace),
            PostConvolutionColorTableSgi = ((int)SgiColorTable.PostConvolutionColorTableSgi),
            Map1Normal = ((int)GetPName.Map1Normal),
            Multisample = ((int)Version13.Multisample),
            SampleMaskSgis = ((int)SgisMultisample.SampleMaskSgis),
            FragmentLight0Sgix = ((int)SgixFragmentLighting.FragmentLight0Sgix),
            FogOffsetSgix = ((int)SgixFogOffset.FogOffsetSgix),
            Map2Normal = ((int)GetPName.Map2Normal),
            Fog = ((int)GetPName.Fog),
            PolygonOffsetPoint = ((int)GetPName.PolygonOffsetPoint),
            IndexLogicOp = ((int)GetPName.IndexLogicOp),
            NormalArray = ((int)GetPName.NormalArray),
            ClipPlane3 = ((int)GetPName.ClipPlane3),
            AsyncHistogramSgix = ((int)SgixAsyncHistogram.AsyncHistogramSgix),
            Light5 = ((int)GetPName.Light5),
            Light0 = ((int)GetPName.Light0),
            StencilTest = ((int)GetPName.StencilTest),
            Texture3dExt = ((int)ExtTexture3D.Texture3dExt),
            ClipPlane0 = ((int)GetPName.ClipPlane0),
            SampleAlphaToMaskSgis = ((int)SgisMultisample.SampleAlphaToMaskSgis),
            Map1TextureCoord4 = ((int)GetPName.Map1TextureCoord4),
            TextureGenR = ((int)GetPName.TextureGenR),
            Map1TextureCoord2 = ((int)GetPName.Map1TextureCoord2),
            Map1TextureCoord3 = ((int)GetPName.Map1TextureCoord3),
            Map1TextureCoord1 = ((int)GetPName.Map1TextureCoord1),
            Map2TextureCoord4 = ((int)GetPName.Map2TextureCoord4),
            Map2TextureCoord2 = ((int)GetPName.Map2TextureCoord2),
            Map2TextureCoord3 = ((int)GetPName.Map2TextureCoord3),
            ScissorTest = ((int)GetPName.ScissorTest),
            Map2TextureCoord1 = ((int)GetPName.Map2TextureCoord1),
            RescaleNormalExt = ((int)ExtRescaleNormal.RescaleNormalExt),
            ColorTableSgi = ((int)SgiColorTable.ColorTableSgi),
            FragmentColorMaterialSgix = ((int)SgixFragmentLighting.FragmentColorMaterialSgix),
            Convolution2dExt = ((int)ExtConvolution.Convolution2dExt),
            Map2Vertex4 = ((int)GetPName.Map2Vertex4),
            HistogramExt = ((int)ExtHistogram.HistogramExt),
            Map2Vertex3 = ((int)GetPName.Map2Vertex3),
            TextureCoordArray = ((int)GetPName.TextureCoordArray),
            DepthTest = ((int)GetPName.DepthTest),
            IndexArray = ((int)GetPName.IndexArray),
            ReferencePlaneSgix = ((int)SgixReferencePlane.ReferencePlaneSgix),
            PixelTexGenSgix = ((int)SgixPixelTexture.PixelTexGenSgix),
            PixelTextureSgis = ((int)SgisPixelTexture.PixelTextureSgis),
            IrInstrument1Sgix = ((int)SgixIrInstrument1.IrInstrument1Sgix),
            Map1Vertex4 = ((int)GetPName.Map1Vertex4),
            Map1Vertex3 = ((int)GetPName.Map1Vertex3),
            AutoNormal = ((int)GetPName.AutoNormal),
            Dither = ((int)GetPName.Dither),
            SpriteSgix = ((int)SgixSprite.SpriteSgix),
            Light3 = ((int)GetPName.Light3),
            AsyncReadPixelsSgix = ((int)SgixAsyncPixel.AsyncReadPixelsSgix),
            ClipPlane1 = ((int)GetPName.ClipPlane1),
            EdgeFlagArray = ((int)GetPName.EdgeFlagArray),
            SharedTexturePaletteExt = ((int)ExtSharedTexturePalette.SharedTexturePaletteExt),
            LineStipple = ((int)GetPName.LineStipple),
            PolygonSmooth = ((int)GetPName.PolygonSmooth),
            Map2Color4 = ((int)GetPName.Map2Color4),
            ColorLogicOp = ((int)GetPName.ColorLogicOp),
            Map2Index = ((int)GetPName.Map2Index),
            TextureGenT = ((int)GetPName.TextureGenT),
            LineSmooth = ((int)GetPName.LineSmooth),
            FragmentLight4Sgix = ((int)SgixFragmentLighting.FragmentLight4Sgix),
            AsyncDrawPixelsSgix = ((int)SgixAsyncPixel.AsyncDrawPixelsSgix),
            Texture4dSgis = ((int)SgisTexture4D.Texture4dSgis),
            PointSmooth = ((int)GetPName.PointSmooth),
            VertexArray = ((int)GetPName.VertexArray),
            Light4 = ((int)GetPName.Light4),
            Separable2dExt = ((int)ExtConvolution.Separable2dExt),
            TextureGenQ = ((int)GetPName.TextureGenQ),
            Texture2d = ((int)GetPName.Texture2d),
            Map1Index = ((int)GetPName.Map1Index),
            Light7 = ((int)GetPName.Light7),
            Convolution1dExt = ((int)ExtConvolution.Convolution1dExt),
            Texture1d = ((int)GetPName.Texture1d),
            Light2 = ((int)GetPName.Light2),
            ClipPlane2 = ((int)GetPName.ClipPlane2),
            TextureColorTableSgi = ((int)SgiTextureColorTable.TextureColorTableSgi),
            ClipPlane5 = ((int)GetPName.ClipPlane5),
            ClipPlane4 = ((int)GetPName.ClipPlane4),
            FragmentLight2Sgix = ((int)SgixFragmentLighting.FragmentLight2Sgix),
            Map1Color4 = ((int)GetPName.Map1Color4),
            InterlaceSgix = ((int)SgixInterlace.InterlaceSgix),
            Normalize = ((int)GetPName.Normalize),
            AlphaTest = ((int)GetPName.AlphaTest),
            MinmaxExt = ((int)ExtHistogram.MinmaxExt),
            Blend = ((int)GetPName.Blend),
            ColorArray = ((int)GetPName.ColorArray),
            TextureGenS = ((int)GetPName.TextureGenS),
            FragmentLight1Sgix = ((int)SgixFragmentLighting.FragmentLight1Sgix),
            PostColorMatrixColorTableSgi = ((int)SgiColorTable.PostColorMatrixColorTableSgi),
            CalligraphicFragmentSgix = ((int)SgixCalligraphicFragment.CalligraphicFragmentSgix),
            Light6 = ((int)GetPName.Light6),
            PolygonOffsetLine = ((int)GetPName.PolygonOffsetLine),
            AsyncTexImageSgix = ((int)SgixAsyncPixel.AsyncTexImageSgix),
            FramezoomSgix = ((int)SgixFramezoom.FramezoomSgix),
        }
        ...
        public enum ErrorCode
        {
            ...
            TableTooLargeExt = ((int)ExtHistogram.TableTooLargeExt),
            StackOverflow = ((int)0x0503),
            OutOfMemory = ((int)0x0505),
            StackUnderflow = ((int)0x0504),
            TextureTooLargeExt = ((int)ExtTexture.TextureTooLargeExt),
        ...
        {
            TextureDeformationSgix = ((int)SgixPolynomialFfd.TextureDeformationSgix),
            GeometryDeformationSgix = ((int)SgixPolynomialFfd.GeometryDeformationSgix),
        }

        public enum FogMode
        {
            Exp2 = ((int)0x0801),
            FogFuncSgis = ((int)SgisFogFunction.FogFuncSgis),
            Exp = ((int)0x0800),
        ...
        {
            FogOffsetValueSgix = ((int)SgixFogOffset.FogOffsetValueSgix),
            FogStart = ((int)GetPName.FogStart),
            FogIndex = ((int)GetPName.FogIndex),
            FogEnd = ((int)GetPName.FogEnd),
            FogMode = ((int)GetPName.FogMode),
            FogColor = ((int)GetPName.FogColor),
            FogDensity = ((int)GetPName.FogDensity),
        }

        public enum FragmentLightModelParameterSgix
        {
            FragmentLightModelAmbientSgix = ((int)SgixFragmentLighting.FragmentLightModelAmbientSgix),
            FragmentLightModelLocalViewerSgix = ((int)SgixFragmentLighting.FragmentLightModelLocalViewerSgix),
            FragmentLightModelTwoSideSgix = ((int)SgixFragmentLighting.FragmentLightModelTwoSideSgix),
        ...
        {
            ColorTableBiasSgi = ((int)SgiColorTable.ColorTableBiasSgi),
            ColorTableIntensitySizeSgi = ((int)SgiColorTable.ColorTableIntensitySizeSgi),
            ColorTableLuminanceSizeSgi = ((int)SgiColorTable.ColorTableLuminanceSizeSgi),
            ColorTableAlphaSizeSgi = ((int)SgiColorTable.ColorTableAlphaSizeSgi),
            ColorTableBlueSizeSgi = ((int)SgiColorTable.ColorTableBlueSizeSgi),
            ColorTableScaleSgi = ((int)SgiColorTable.ColorTableScaleSgi),
            ColorTableWidthSgi = ((int)SgiColorTable.ColorTableWidthSgi),
            ColorTableFormatSgi = ((int)SgiColorTable.ColorTableFormatSgi),
            ColorTableRedSizeSgi = ((int)SgiColorTable.ColorTableRedSizeSgi),
            ColorTableGreenSizeSgi = ((int)SgiColorTable.ColorTableGreenSizeSgi),
        }

        public enum GetConvolutionParameter
        {
            MaxConvolutionWidthExt = ((int)ExtConvolution.MaxConvolutionWidthExt),
            ConvolutionHeightExt = ((int)ExtConvolution.ConvolutionHeightExt),
            ConvolutionFormatExt = ((int)ExtConvolution.ConvolutionFormatExt),
            MaxConvolutionHeightExt = ((int)ExtConvolution.MaxConvolutionHeightExt),
            ConvolutionBorderModeExt = ((int)ExtConvolution.ConvolutionBorderModeExt),
            ConvolutionWidthExt = ((int)ExtConvolution.ConvolutionWidthExt),
            ConvolutionFilterScaleExt = ((int)ExtConvolution.ConvolutionFilterScaleExt),
            ConvolutionFilterBiasExt = ((int)ExtConvolution.ConvolutionFilterBiasExt),
        }
        ...
        {
            HistogramAlphaSizeExt = ((int)ExtHistogram.HistogramAlphaSizeExt),
            HistogramLuminanceSizeExt = ((int)ExtHistogram.HistogramLuminanceSizeExt),
            HistogramFormatExt = ((int)ExtHistogram.HistogramFormatExt),
            HistogramGreenSizeExt = ((int)ExtHistogram.HistogramGreenSizeExt),
            HistogramSinkExt = ((int)ExtHistogram.HistogramSinkExt),
            HistogramWidthExt = ((int)ExtHistogram.HistogramWidthExt),
            HistogramBlueSizeExt = ((int)ExtHistogram.HistogramBlueSizeExt),
            HistogramRedSizeExt = ((int)ExtHistogram.HistogramRedSizeExt),
        }
        ...
        {
            MinmaxSinkExt = ((int)ExtHistogram.MinmaxSinkExt),
            MinmaxFormatExt = ((int)ExtHistogram.MinmaxFormatExt),
        }
        ...
        public enum GetPointervPName
        {
            ...
            InstrumentBufferPointerSgix = ((int)SgixInstruments.InstrumentBufferPointerSgix),
        ...
        {
            AliasedLineWidthRange = ((int)Version12.AliasedLineWidthRange),
            Map1TextureCoord4 = ((int)0x0d96),
            PolygonSmoothHint = ((int)0x0c53),
            DepthWritemask = ((int)0x0b72),
            PostConvolutionBlueScaleExt = ((int)ExtConvolution.PostConvolutionBlueScaleExt),
            ...
            ClipPlane3 = ((int)ClipPlaneName.ClipPlane3),
            PixelTileGridHeightSgix = ((int)SgixPixelTiles.PixelTileGridHeightSgix),
            ...
            UnpackImageDepthSgis = ((int)SgisTexture4D.UnpackImageDepthSgis),
            AsyncReadPixelsSgix = ((int)SgixAsyncPixel.AsyncReadPixelsSgix),
            PackResampleSgix = ((int)SgixResample.PackResampleSgix),
            MaxTextureStackDepth = ((int)0x0d39),
            SampleMaskValueSgis = ((int)SgisMultisample.SampleMaskValueSgis),
            InstrumentMeasurementsSgix = ((int)SgixInstruments.InstrumentMeasurementsSgix),
            PixelTextureSgis = ((int)SgisPixelTexture.PixelTextureSgis),
            ...
            PostConvolutionColorTableSgi = ((int)SgiColorTable.PostConvolutionColorTableSgi),
            PostConvolutionGreenScaleExt = ((int)ExtConvolution.PostConvolutionGreenScaleExt),
            Texture3dBindingExt = ((int)ExtTextureObject.Texture3dBindingExt),
            MaxAsyncTexImageSgix = ((int)SgixAsyncPixel.MaxAsyncTexImageSgix),
            UnpackSwapBytes = ((int)0x0cf0),
            Texture4dSgis = ((int)SgisTexture4D.Texture4dSgis),
            PixelMapAToASize = ((int)0x0cb9),
            PostColorMatrixRedBiasSgi = ((int)SgiColorMatrix.PostColorMatrixRedBiasSgi),
            PackSkipVolumesSgis = ((int)SgisTexture4D.PackSkipVolumesSgis),
            ...
            PixelTileBestAlignmentSgix = ((int)SgixPixelTiles.PixelTileBestAlignmentSgix),
            MaxClipmapVirtualDepthSgix = ((int)SgixClipmap.MaxClipmapVirtualDepthSgix),
            PixelTileHeightSgix = ((int)SgixPixelTiles.PixelTileHeightSgix),
            ...
            PackSkipImagesExt = ((int)ExtTexture3D.PackSkipImagesExt),
            MapStencil = ((int)0x0d11),
            DepthBias = ((int)0x0d1f),
            PackSkipPixels = ((int)0x0d04),
            MaxModelviewStackDepth = ((int)0x0d36),
            PostColorMatrixBlueScaleSgi = ((int)SgiColorMatrix.PostColorMatrixBlueScaleSgi),
            PixelMapIToISize = ((int)0x0cb0),
            NormalArrayStride = ((int)0x807f),
            FragmentLightModelTwoSideSgix = ((int)SgixFragmentLighting.FragmentLightModelTwoSideSgix),
            EdgeFlagArrayCountExt = ((int)ExtVertexArray.EdgeFlagArrayCountExt),
            CullFace = ((int)0x0b44),
            Texture1d = ((int)0x0de0),
            LightModelTwoSide = ((int)0x0b52),
            UnpackImageHeightExt = ((int)ExtTexture3D.UnpackImageHeightExt),
            SampleBuffers = ((int)Version13.SampleBuffers),
            FogIndex = ((int)0x0b61),
            FragmentColorMaterialParameterSgix = ((int)SgixFragmentLighting.FragmentColorMaterialParameterSgix),
            ZoomY = ((int)0x0d17),
            Samples = ((int)Version13.Samples),
            DepthTest = ((int)0x0b71),
            LogicOpMode = ((int)0x0bf0),
            AsyncTexImageSgix = ((int)SgixAsyncPixel.AsyncTexImageSgix),
            SmoothPointSizeRange = ((int)Version12.SmoothPointSizeRange),
            Lighting = ((int)0x0b50),
            RedScale = ((int)0x0d14),
            StencilBits = ((int)0x0d57),
            UnpackCmykHintExt = ((int)ExtCmyka.UnpackCmykHintExt),
            PostConvolutionRedBiasExt = ((int)ExtConvolution.PostConvolutionRedBiasExt),
            ...
            SpriteSgix = ((int)SgixSprite.SpriteSgix),
            SmoothLineWidthGranularity = ((int)Version12.SmoothLineWidthGranularity),
            UnpackSkipVolumesSgis = ((int)SgisTexture4D.UnpackSkipVolumesSgis),
            AccumAlphaBits = ((int)0x0d5b),
            ClientAttribStackDepth = ((int)0x0bb1),
            PixelMapIToASize = ((int)0x0cb5),
            UnpackResampleSgix = ((int)SgixResample.UnpackResampleSgix),
            ...
            PixelTileCacheIncrementSgix = ((int)SgixPixelTiles.PixelTileCacheIncrementSgix),
            ConvolutionHintSgix = ((int)SgixConvolutionAccuracy.ConvolutionHintSgix),
            DepthClearValue = ((int)0x0b73),
            AccumRedBits = ((int)0x0d58),
            PostColorMatrixRedScaleSgi = ((int)SgiColorMatrix.PostColorMatrixRedScaleSgi),
            ClipPlane1 = ((int)ClipPlaneName.ClipPlane1),
            PolygonOffsetBiasExt = ((int)ExtPolygonOffset.PolygonOffsetBiasExt),
            DetailTexture2dBindingSgis = ((int)SgisDetailTexture.DetailTexture2dBindingSgis),
            PackCmykHintExt = ((int)ExtCmyka.PackCmykHintExt),
            ...
            GenerateMipmapHintSgis = ((int)SgisGenerateMipmap.GenerateMipmapHintSgis),
            ...
            Convolution1dExt = ((int)ExtConvolution.Convolution1dExt),
            BlendColorExt = ((int)ExtBlendColor.BlendColorExt),
            SpriteAxisSgix = ((int)SgixSprite.SpriteAxisSgix),
            RgbaMode = ((int)0x0c31),
            FogDensity = ((int)0x0b62),
            Separable2dExt = ((int)ExtConvolution.Separable2dExt),
            PostConvolutionRedScaleExt = ((int)ExtConvolution.PostConvolutionRedScaleExt),
            Map2Vertex4 = ((int)0x0db8),
            ColorWritemask = ((int)0x0c23),
            Map2Vertex3 = ((int)0x0db7),
            MultisampleSgis = ((int)SgisMultisample.MultisampleSgis),
            PostConvolutionAlphaScaleExt = ((int)ExtConvolution.PostConvolutionAlphaScaleExt),
            ...
            ClipPlane4 = ((int)ClipPlaneName.ClipPlane4),
            PolygonSmooth = ((int)0x0b41),
            IndexShift = ((int)0x0d12),
            FogColor = ((int)0x0b66),
            FragmentLight0Sgix = ((int)SgixFragmentLighting.FragmentLight0Sgix),
            PostConvolutionAlphaBiasExt = ((int)ExtConvolution.PostConvolutionAlphaBiasExt),
            LineWidth = ((int)0x0b21),
            ReferencePlaneSgix = ((int)SgixReferencePlane.ReferencePlaneSgix),
            SpriteTranslationSgix = ((int)SgixSprite.SpriteTranslationSgix),
            SampleAlphaToOneSgis = ((int)SgisMultisample.SampleAlphaToOneSgis),
            ...
            SpriteModeSgix = ((int)SgixSprite.SpriteModeSgix),
            PixelTileGridWidthSgix = ((int)SgixPixelTiles.PixelTileGridWidthSgix),
            PolygonOffsetFactor = ((int)0x8038),
            PixelTileGridDepthSgix = ((int)SgixPixelTiles.PixelTileGridDepthSgix),
            PixelTexGenModeSgix = ((int)SgixPixelTexture.PixelTexGenModeSgix),
            BlueBits = ((int)0x0d54),
            SelectionBufferSize = ((int)0x0df4),
            Map2GridDomain = ((int)0x0dd2),
            BlendEquationExt = ((int)ExtBlendMinmax.BlendEquationExt),
            PostColorMatrixBlueBiasSgi = ((int)SgiColorMatrix.PostColorMatrixBlueBiasSgi),
            LightEnvModeSgix = ((int)SgixFragmentLighting.LightEnvModeSgix),
            PixelMapIToBSize = ((int)0x0cb4),
            Map1Color4 = ((int)0x0d90),
            DistanceAttenuationSgis = ((int)SgisPointParameters.DistanceAttenuationSgis),
            ProjectionMatrix = ((int)0x0ba7),
            IrInstrument1Sgix = ((int)SgixIrInstrument1.IrInstrument1Sgix),
            VertexArray = ((int)0x8074),
            StencilClearValue = ((int)0x0b91),
            MaxAsyncDrawPixelsSgix = ((int)SgixAsyncPixel.MaxAsyncDrawPixelsSgix),
            CurrentIndex = ((int)0x0b01),
            SampleBuffersSgis = ((int)SgisMultisample.SampleBuffersSgis),
            RedBits = ((int)0x0d52),
            SamplePatternSgis = ((int)SgisMultisample.SamplePatternSgis),
            StencilTest = ((int)0x0b90),
            PointSizeRange = ((int)0x0b12),
            AccumBlueBits = ((int)0x0d5a),
            Stereo = ((int)0x0c33),
            UnpackSubsampleRateSgix = ((int)SgixSubsample.UnpackSubsampleRateSgix),
            PointSize = ((int)0x0b11),
            ColorArrayType = ((int)0x8082),
            MapColor = ((int)0x0d10),
            Map1Index = ((int)0x0d91),
            UnpackSkipImagesExt = ((int)ExtTexture3D.UnpackSkipImagesExt),
            AlphaTest = ((int)0x0bc0),
            AlphaBias = ((int)0x0d1d),
            CurrentRasterPosition = ((int)0x0b07),
            SampleMaskInvertSgis = ((int)SgisMultisample.SampleMaskInvertSgis),
            VertexPreclipHintSgix = ((int)SgixVertexPreclip.VertexPreclipHintSgix),
            AlphaScale = ((int)0x0d1c),
            VertexArrayStride = ((int)0x807c),
            Max3dTextureSizeExt = ((int)ExtTexture3D.Max3dTextureSizeExt),
            PackLsbFirst = ((int)0x0d01),
            FragmentColorMaterialFaceSgix = ((int)SgixFragmentLighting.FragmentColorMaterialFaceSgix),
            Map1GridSegments = ((int)0x0dd1),
            MaxFragmentLightsSgix = ((int)SgixFragmentLighting.MaxFragmentLightsSgix),
            FogOffsetSgix = ((int)SgixFogOffset.FogOffsetSgix),
            Map2Index = ((int)0x0db1),
            MaxAsyncHistogramSgix = ((int)SgixAsyncHistogram.MaxAsyncHistogramSgix),
            ...
            FramezoomSgix = ((int)SgixFramezoom.FramezoomSgix),
            MaxFogFuncPointsSgis = ((int)SgisFogFunction.MaxFogFuncPointsSgis),
            MaxColorMatrixStackDepthSgi = ((int)SgiColorMatrix.MaxColorMatrixStackDepthSgi),
            PointSizeGranularity = ((int)0x0b13),
            PostConvolutionGreenBiasExt = ((int)ExtConvolution.PostConvolutionGreenBiasExt),
            FogFuncPointsSgis = ((int)SgisFogFunction.FogFuncPointsSgis),
            MaxViewportDims = ((int)0x0d3a),
            PointSizeMaxSgis = ((int)SgisPointParameters.PointSizeMaxSgis),
            BlendDst = ((int)0x0be0),
            FragmentLightModelLocalViewerSgix = ((int)SgixFragmentLighting.FragmentLightModelLocalViewerSgix),
            PackSubsampleRateSgix = ((int)SgixSubsample.PackSubsampleRateSgix),
            ModelviewMatrix = ((int)0x0ba6),
            PackImageDepthSgis = ((int)SgisTexture4D.PackImageDepthSgis),
            FogMode = ((int)0x0b65),
            IndexMode = ((int)0x0c30),
            AccumClearValue = ((int)0x0b80),
            TextureBinding3d = ((int)0x806a),
            TextureBinding2d = ((int)0x8069),
            PixelTileCacheSizeSgix = ((int)SgixPixelTiles.PixelTileCacheSizeSgix),
            DrawBuffer = ((int)0x0c01),
            Map1Normal = ((int)0x0d92),
            FogHint = ((int)0x0c54),
            RescaleNormalExt = ((int)ExtRescaleNormal.RescaleNormalExt),
            LightModelColorControl = ((int)Version12.LightModelColorControl),
            SubpixelBits = ((int)0x0d50),
            NormalArray = ((int)0x8075),
            PostTextureFilterBiasRangeSgix = ((int)SgixTextureScaleBias.PostTextureFilterBiasRangeSgix),
            ...
            ClipPlane2 = ((int)ClipPlaneName.ClipPlane2),
            LogicOp = ((int)0x0bf1),
            RedBias = ((int)0x0d15),
            SamplesSgis = ((int)SgisMultisample.SamplesSgis),
            FeedbackBufferType = ((int)0x0df2),
            ColorArrayCountExt = ((int)ExtVertexArray.ColorArrayCountExt),
            ScissorTest = ((int)0x0c11),
            PointFadeThresholdSizeSgis = ((int)SgisPointParameters.PointFadeThresholdSizeSgis),
            StencilPassDepthPass = ((int)0x0b96),
            Viewport = ((int)0x0ba2),
            AsyncMarkerSgix = ((int)SgixAsync.AsyncMarkerSgix),
            ...
            ColorMatrixStackDepthSgi = ((int)SgiColorMatrix.ColorMatrixStackDepthSgi),
            NormalArrayType = ((int)0x807e),
            AlphaTestFunc = ((int)0x0bc1),
            UnpackRowLength = ((int)0x0cf2),
            MaxClipmapDepthSgix = ((int)SgixClipmap.MaxClipmapDepthSgix),
            ...
            SmoothLineWidthRange = ((int)Version12.SmoothLineWidthRange),
            EdgeFlagArrayStride = ((int)0x808c),
            ZoomX = ((int)0x0d16),
            VertexPreclipSgix = ((int)SgixVertexPreclip.VertexPreclipSgix),
            PolygonOffsetFill = ((int)0x8037),
            PixelMapBToBSize = ((int)0x0cb8),
            StencilWritemask = ((int)0x0b98),
            PostColorMatrixAlphaBiasSgi = ((int)SgiColorMatrix.PostColorMatrixAlphaBiasSgi),
            CurrentNormal = ((int)0x0b02),
            LightModelAmbient = ((int)0x0b53),
            MaxNameStackDepth = ((int)0x0d37),
            SmoothPointSizeGranularity = ((int)Version12.SmoothPointSizeGranularity),
            SampleAlphaToMaskSgis = ((int)SgisMultisample.SampleAlphaToMaskSgis),
            AliasedPointSizeRange = ((int)Version12.AliasedPointSizeRange),
            ListMode = ((int)0x0b30),
            ColorTableSgi = ((int)SgiColorTable.ColorTableSgi),
            ClipPlane5 = ((int)ClipPlaneName.ClipPlane5),
            IndexArrayCountExt = ((int)ExtVertexArray.IndexArrayCountExt),
            FrontFace = ((int)0x0b46),
            PackImageHeightExt = ((int)ExtTexture3D.PackImageHeightExt),
            TextureCoordArraySize = ((int)0x8088),
            FogStart = ((int)0x0b63),
            FragmentLightingSgix = ((int)SgixFragmentLighting.FragmentLightingSgix),
            NameStackDepth = ((int)0x0d70),
            Light2 = ((int)LightName.Light2),
            ColorMatrixSgi = ((int)SgiColorMatrix.ColorMatrixSgi),
            PixelTileWidthSgix = ((int)SgixPixelTiles.PixelTileWidthSgix),
            FogOffsetValueSgix = ((int)SgixFogOffset.FogOffsetValueSgix),
            InterlaceSgix = ((int)SgixInterlace.InterlaceSgix),
            ...
            FramezoomFactorSgix = ((int)SgixFramezoom.FramezoomFactorSgix),
            DepthRange = ((int)0x0b70),
            DeformationsMaskSgix = ((int)SgixPolynomialFfd.DeformationsMaskSgix),
            PostConvolutionBlueBiasExt = ((int)ExtConvolution.PostConvolutionBlueBiasExt),
            MaxFramezoomFactorSgix = ((int)SgixFramezoom.MaxFramezoomFactorSgix),
            Map2Color4 = ((int)0x0db0),
            MinmaxExt = ((int)ExtHistogram.MinmaxExt),
            Texture4dBindingSgis = ((int)SgisTexture4D.Texture4dBindingSgis),
            ...
            NormalArrayCountExt = ((int)ExtVertexArray.NormalArrayCountExt),
            ...
            VertexArrayCountExt = ((int)ExtVertexArray.VertexArrayCountExt),
            Map2TextureCoord1 = ((int)0x0db3),
            MaxActiveLightsSgix = ((int)SgixFragmentLighting.MaxActiveLightsSgix),
            ...
            PostColorMatrixAlphaScaleSgi = ((int)SgiColorMatrix.PostColorMatrixAlphaScaleSgi),
            IndexArray = ((int)0x8077),
            PostColorMatrixGreenScaleSgi = ((int)SgiColorMatrix.PostColorMatrixGreenScaleSgi),
            ClipPlane0 = ((int)ClipPlaneName.ClipPlane0),
            ...
            PostTextureFilterScaleRangeSgix = ((int)SgixTextureScaleBias.PostTextureFilterScaleRangeSgix),
            ScissorBox = ((int)0x0c10),
            Max4dTextureSizeSgis = ((int)SgisTexture4D.Max4dTextureSizeSgis),
            RenderMode = ((int)0x0c40),
            PolygonStipple = ((int)0x0b42),
            PostColorMatrixGreenBiasSgi = ((int)SgiColorMatrix.PostColorMatrixGreenBiasSgi),
            GreenBias = ((int)0x0d19),
            TextureCoordArrayCountExt = ((int)ExtVertexArray.TextureCoordArrayCountExt),
            PointSizeMinSgis = ((int)SgisPointParameters.PointSizeMinSgis),
            Map2TextureCoord2 = ((int)0x0db4),
            Map2TextureCoord3 = ((int)0x0db5),
            PolygonMode = ((int)0x0b40),
            PolygonOffsetUnits = ((int)0x2a00),
            StencilFail = ((int)0x0b94),
            ReferencePlaneEquationSgix = ((int)SgixReferencePlane.ReferencePlaneEquationSgix),
        ...
        public enum GetTextureParameter
        {
            ...
            QuadTextureSelectSgis = ((int)SgisTextureSelect.QuadTextureSelectSgis),
            DetailTextureLevelSgis = ((int)SgisDetailTexture.DetailTextureLevelSgis),
            TextureGreenSize = ((int)0x805d),
            TextureMaxClampRSgix = ((int)SgixTextureCoordinateClamp.TextureMaxClampRSgix),
            TexturePriority = ((int)0x8066),
            TextureLequalRSgix = ((int)SgixShadow.TextureLequalRSgix),
            TextureLodBiasTSgix = ((int)SgixTextureLodBias.TextureLodBiasTSgix),
            Texture4dsizeSgis = ((int)SgisTexture4D.Texture4dsizeSgis),
            TextureBaseLevelSgis = ((int)SgisTextureLod.TextureBaseLevelSgis),
            TextureClipmapCenterSgix = ((int)SgixClipmap.TextureClipmapCenterSgix),
            TextureComponents = ((int)0x1003),
            TextureMaxClampTSgix = ((int)SgixTextureCoordinateClamp.TextureMaxClampTSgix),
            TextureMaxLevelSgis = ((int)SgisTextureLod.TextureMaxLevelSgis),
            TextureLodBiasRSgix = ((int)SgixTextureLodBias.TextureLodBiasRSgix),
            TextureLodBiasSSgix = ((int)SgixTextureLodBias.TextureLodBiasSSgix),
            TextureLuminanceSize = ((int)0x8060),
            TextureClipmapOffsetSgix = ((int)SgixClipmap.TextureClipmapOffsetSgix),
            TextureWrapQSgis = ((int)SgisTexture4D.TextureWrapQSgis),
            TextureMinLodSgis = ((int)SgisTextureLod.TextureMinLodSgis),
            TextureClipmapFrameSgix = ((int)SgixClipmap.TextureClipmapFrameSgix),
            TextureGequalRSgix = ((int)SgixShadow.TextureGequalRSgix),
            SharpenTextureFuncPointsSgis = ((int)SgisSharpenTexture.SharpenTextureFuncPointsSgis),
            TextureWrapS = ((int)TextureParameterName.TextureWrapS),
            TextureMinFilter = ((int)TextureParameterName.TextureMinFilter),
            TextureClipmapDepthSgix = ((int)SgixClipmap.TextureClipmapDepthSgix),
            TextureFilter4SizeSgis = ((int)SgisTextureFilter4.TextureFilter4SizeSgis),
            TextureWrapRExt = ((int)ExtTexture3D.TextureWrapRExt),
            TextureCompareSgix = ((int)SgixShadow.TextureCompareSgix),
            TextureMaxClampSSgix = ((int)SgixTextureCoordinateClamp.TextureMaxClampSSgix),
            DetailTextureModeSgis = ((int)SgisDetailTexture.DetailTextureModeSgis),
            DetailTextureFuncPointsSgis = ((int)SgisDetailTexture.DetailTextureFuncPointsSgis),
            DualTextureSelectSgis = ((int)SgisTextureSelect.DualTextureSelectSgis),
            TextureClipmapLodOffsetSgix = ((int)SgixClipmap.TextureClipmapLodOffsetSgix),
            TextureDepthExt = ((int)ExtTexture3D.TextureDepthExt),
            TextureRedSize = ((int)0x805c),
            TextureInternalFormat = ((int)0x1003),
            PostTextureFilterBiasSgix = ((int)SgixTextureScaleBias.PostTextureFilterBiasSgix),
            TextureIntensitySize = ((int)0x8061),
            TextureCompareOperatorSgix = ((int)SgixShadow.TextureCompareOperatorSgix),
            TextureMaxLodSgis = ((int)SgisTextureLod.TextureMaxLodSgis),
            TextureBlueSize = ((int)0x805e),
            GenerateMipmapSgis = ((int)SgisGenerateMipmap.GenerateMipmapSgis),
            TextureWidth = ((int)0x1000),
            TextureAlphaSize = ((int)0x805f),
            ShadowAmbientSgix = ((int)SgixShadowAmbient.ShadowAmbientSgix),
            PostTextureFilterScaleSgix = ((int)SgixTextureScaleBias.PostTextureFilterScaleSgix),
            TextureBorderColor = ((int)0x1004),
            TextureResident = ((int)0x8067),
            TextureBorder = ((int)0x1005),
            TextureClipmapVirtualDepthSgix = ((int)SgixClipmap.TextureClipmapVirtualDepthSgix),
            TextureMagFilter = ((int)TextureParameterName.TextureMagFilter),
            TextureWrapT = ((int)TextureParameterName.TextureWrapT),
        }
        ...
        {
            PerspectiveCorrectionHint = ((int)GetPName.PerspectiveCorrectionHint),
            VertexPreclipHintSgix = ((int)SgixVertexPreclip.VertexPreclipHintSgix),
            LineSmoothHint = ((int)GetPName.LineSmoothHint),
            UnpackCmykHintExt = ((int)ExtCmyka.UnpackCmykHintExt),
            PolygonSmoothHint = ((int)GetPName.PolygonSmoothHint),
            ConvolutionHintSgix = ((int)SgixConvolutionAccuracy.ConvolutionHintSgix),
            PackCmykHintExt = ((int)ExtCmyka.PackCmykHintExt),
            PointSmoothHint = ((int)GetPName.PointSmoothHint),
            FogHint = ((int)GetPName.FogHint),
            GenerateMipmapHintSgis = ((int)SgisGenerateMipmap.GenerateMipmapHintSgis),
            TextureMultiBufferHintSgix = ((int)SgixTextureMultiBuffer.TextureMultiBufferHintSgix),
        }

        public enum HistogramTargetExt
        {
            ProxyHistogramExt = ((int)ExtHistogram.ProxyHistogramExt),
            HistogramExt = ((int)ExtHistogram.HistogramExt),
        }
        ...
        {
            SingleColor = ((int)Version12.SingleColor),
            SeparateSpecularColor = ((int)Version12.SeparateSpecularColor),
        }

        public enum LightModelParameter
        {
            LightModelColorControl = ((int)Version12.LightModelColorControl),
            LightModelTwoSide = ((int)GetPName.LightModelTwoSide),
            LightModelAmbient = ((int)GetPName.LightModelAmbient),
            LightModelLocalViewer = ((int)GetPName.LightModelLocalViewer),
        }
        ...
        public enum ListNameType
        {
            ...
            Int = ((int)DataType.Int),
            Float = ((int)DataType.Float),
            Gl4Bytes = ((int)DataType.Gl4Bytes),
            Gl3Bytes = ((int)DataType.Gl3Bytes),
            Gl2Bytes = ((int)DataType.Gl2Bytes),
            UnsignedShort = ((int)DataType.UnsignedShort),
        }

        public enum ListParameterName
        {
            ListPrioritySgix = ((int)SgixListPriority.ListPrioritySgix),
        }
        ...
        {
            CmykExt = ((int)ExtCmyka.CmykExt),
            Rgb = ((int)0x1907),
            R5G6B5IccSgix = ((int)SgixIccTexture.R5G6B5IccSgix),
            R5G6B5A8IccSgix = ((int)SgixIccTexture.R5G6B5A8IccSgix),
            Green = ((int)0x1904),
            Blue = ((int)0x1905),
            Alpha16IccSgix = ((int)SgixIccTexture.Alpha16IccSgix),
            Ycrcb444Sgix = ((int)SgixYcrcb.Ycrcb444Sgix),
            Ycrcb422Sgix = ((int)SgixYcrcb.Ycrcb422Sgix),
            Luminance = ((int)0x1909),
            Rgba = ((int)0x1908),
            StencilIndex = ((int)0x1901),
            Red = ((int)0x1903),
            DepthComponent = ((int)0x1902),
            Luminance16IccSgix = ((int)SgixIccTexture.Luminance16IccSgix),
            Luminance16Alpha8IccSgix = ((int)SgixIccTexture.Luminance16Alpha8IccSgix),
            Bgra = ((int)ExtBgra.Bgra),
            Alpha = ((int)0x1906),
            ColorIndex = ((int)0x1900),
            CmykaExt = ((int)ExtCmyka.CmykaExt),
            Bgr = ((int)ExtBgra.Bgr),
            LuminanceAlpha = ((int)0x190a),
            AbgrExt = ((int)ExtAbgr.AbgrExt),
        }

        public enum PixelMap
        {
            PixelMapIToI = ((int)GetPixelMap.PixelMapIToI),
            PixelMapIToA = ((int)GetPixelMap.PixelMapIToA),
            PixelMapIToB = ((int)GetPixelMap.PixelMapIToB),
            PixelMapIToR = ((int)GetPixelMap.PixelMapIToR),
            PixelMapBToB = ((int)GetPixelMap.PixelMapBToB),
            PixelMapRToR = ((int)GetPixelMap.PixelMapRToR),
            PixelMapIToG = ((int)GetPixelMap.PixelMapIToG),
            PixelMapGToG = ((int)GetPixelMap.PixelMapGToG),
            PixelMapAToA = ((int)GetPixelMap.PixelMapAToA),
            PixelMapSToS = ((int)GetPixelMap.PixelMapSToS),
        }

        public enum PixelStoreParameter
        {
            PixelTileGridHeightSgix = ((int)SgixPixelTiles.PixelTileGridHeightSgix),
            UnpackLsbFirst = ((int)GetPName.UnpackLsbFirst),
            UnpackSwapBytes = ((int)GetPName.UnpackSwapBytes),
            UnpackSkipPixels = ((int)GetPName.UnpackSkipPixels),
            UnpackResampleSgix = ((int)SgixResample.UnpackResampleSgix),
            PixelTileGridDepthSgix = ((int)SgixPixelTiles.PixelTileGridDepthSgix),
            PackSkipPixels = ((int)GetPName.PackSkipPixels),
            UnpackSkipVolumesSgis = ((int)SgisTexture4D.UnpackSkipVolumesSgis),
            PackSubsampleRateSgix = ((int)SgixSubsample.PackSubsampleRateSgix),
            PackSwapBytes = ((int)GetPName.PackSwapBytes),
            PackSkipImagesExt = ((int)ExtTexture3D.PackSkipImagesExt),
            UnpackImageHeightExt = ((int)ExtTexture3D.UnpackImageHeightExt),
            PackSkipRows = ((int)GetPName.PackSkipRows),
            PackSkipVolumesSgis = ((int)SgisTexture4D.PackSkipVolumesSgis),
            PackAlignment = ((int)GetPName.PackAlignment),
            PackLsbFirst = ((int)GetPName.PackLsbFirst),
            UnpackSkipRows = ((int)GetPName.UnpackSkipRows),
            PixelTileGridWidthSgix = ((int)SgixPixelTiles.PixelTileGridWidthSgix),
            PackResampleSgix = ((int)SgixResample.PackResampleSgix),
            UnpackRowLength = ((int)GetPName.UnpackRowLength),
            UnpackAlignment = ((int)GetPName.UnpackAlignment),
            UnpackImageDepthSgis = ((int)SgisTexture4D.UnpackImageDepthSgis),
            PackImageDepthSgis = ((int)SgisTexture4D.PackImageDepthSgis),
            PixelTileHeightSgix = ((int)SgixPixelTiles.PixelTileHeightSgix),
            PixelTileWidthSgix = ((int)SgixPixelTiles.PixelTileWidthSgix),
            ...
            PixelTileCacheSizeSgix = ((int)SgixPixelTiles.PixelTileCacheSizeSgix),
            PackImageHeightExt = ((int)ExtTexture3D.PackImageHeightExt),
            PackRowLength = ((int)GetPName.PackRowLength),
        }

        public enum PixelStoreResampleMode
        {
            ResampleZeroFillSgix = ((int)SgixResample.ResampleZeroFillSgix),
            ResampleDecimateSgix = ((int)SgixResample.ResampleDecimateSgix),
            ResampleReplicateSgix = ((int)SgixResample.ResampleReplicateSgix),
        }

        public enum PixelStoreSubsampleRate
        {
            PixelSubsample2424Sgix = ((int)SgixSubsample.PixelSubsample2424Sgix),
            PixelSubsample4444Sgix = ((int)SgixSubsample.PixelSubsample4444Sgix),
            PixelSubsample4242Sgix = ((int)SgixSubsample.PixelSubsample4242Sgix),
        }

        public enum PixelTexGenMode
        {
            LuminanceAlpha = ((int)PixelFormat.LuminanceAlpha),
            PixelTexGenAlphaMsSgix = ((int)SgixImpactPixelTexture.PixelTexGenAlphaMsSgix),
            Rgba = ((int)PixelFormat.Rgba),
            PixelTexGenAlphaReplaceSgix = ((int)SgixImpactPixelTexture.PixelTexGenAlphaReplaceSgix),
            PixelTexGenAlphaNoReplaceSgix = ((int)SgixImpactPixelTexture.PixelTexGenAlphaNoReplaceSgix),
            PixelTexGenAlphaLsSgix = ((int)SgixImpactPixelTexture.PixelTexGenAlphaLsSgix),
        ...
        {
            PixelFragmentRgbSourceSgis = ((int)SgisPixelTexture.PixelFragmentRgbSourceSgis),
            PixelFragmentAlphaSourceSgis = ((int)SgisPixelTexture.PixelFragmentAlphaSourceSgis),
        }
        ...
        public enum PixelTransferParameter
        {
            ...
            PostConvolutionGreenScaleExt = ((int)ExtConvolution.PostConvolutionGreenScaleExt),
            PostConvolutionGreenBiasExt = ((int)ExtConvolution.PostConvolutionGreenBiasExt),
            BlueBias = ((int)GetPName.BlueBias),
            BlueScale = ((int)GetPName.BlueScale),
            PostColorMatrixRedScaleSgi = ((int)SgiColorMatrix.PostColorMatrixRedScaleSgi),
            PostConvolutionRedBiasExt = ((int)ExtConvolution.PostConvolutionRedBiasExt),
            AlphaBias = ((int)GetPName.AlphaBias),
            AlphaScale = ((int)GetPName.AlphaScale),
            GreenScale = ((int)GetPName.GreenScale),
            RedBias = ((int)GetPName.RedBias),
            PostColorMatrixRedBiasSgi = ((int)SgiColorMatrix.PostColorMatrixRedBiasSgi),
            IndexShift = ((int)GetPName.IndexShift),
            RedScale = ((int)GetPName.RedScale),
            PostColorMatrixAlphaBiasSgi = ((int)SgiColorMatrix.PostColorMatrixAlphaBiasSgi),
            MapColor = ((int)GetPName.MapColor),
            PostConvolutionBlueBiasExt = ((int)ExtConvolution.PostConvolutionBlueBiasExt),
            PostConvolutionBlueScaleExt = ((int)ExtConvolution.PostConvolutionBlueScaleExt),
            PostConvolutionRedScaleExt = ((int)ExtConvolution.PostConvolutionRedScaleExt),
            PostColorMatrixGreenScaleSgi = ((int)SgiColorMatrix.PostColorMatrixGreenScaleSgi),
            MapStencil = ((int)GetPName.MapStencil),
            DepthBias = ((int)GetPName.DepthBias),
            IndexOffset = ((int)GetPName.IndexOffset),
            PostConvolutionAlphaScaleExt = ((int)ExtConvolution.PostConvolutionAlphaScaleExt),
            PostColorMatrixBlueScaleSgi = ((int)SgiColorMatrix.PostColorMatrixBlueScaleSgi),
            DepthScale = ((int)GetPName.DepthScale),
            GreenBias = ((int)GetPName.GreenBias),
        }
        ...
        public enum PixelType
        {
            UnsignedByte = ((int)DataType.UnsignedByte),
            Bitmap = ((int)0x1a00),
            UnsignedShort5551Ext = ((int)ExtPackedPixels.UnsignedShort5551Ext),
            UnsignedShort4444Ext = ((int)ExtPackedPixels.UnsignedShort4444Ext),
            Byte = ((int)DataType.Byte),
            UnsignedInt1010102Ext = ((int)ExtPackedPixels.UnsignedInt1010102Ext),
            UnsignedInt = ((int)DataType.UnsignedInt),
            Short = ((int)DataType.Short),
            UnsignedInt8888Ext = ((int)ExtPackedPixels.UnsignedInt8888Ext),
            Int = ((int)DataType.Int),
            Float = ((int)DataType.Float),
            UnsignedByte332Ext = ((int)ExtPackedPixels.UnsignedByte332Ext),
            UnsignedShort = ((int)DataType.UnsignedShort),
        }
        ...
        {
            Gl4pass2Sgis = ((int)SgisMultisample.Gl4pass2Sgis),
            Gl4pass0Sgis = ((int)SgisMultisample.Gl4pass0Sgis),
            Gl2pass1Sgis = ((int)SgisMultisample.Gl2pass1Sgis),
            Gl1passSgis = ((int)SgisMultisample.Gl1passSgis),
            Gl4pass3Sgis = ((int)SgisMultisample.Gl4pass3Sgis),
            Gl4pass1Sgis = ((int)SgisMultisample.Gl4pass1Sgis),
            Gl2pass0Sgis = ((int)SgisMultisample.Gl2pass0Sgis),
        }
        ...
        public enum TextureEnvMode
        {
            ...
            Add = ((int)AccumOp.Add),
            Blend = ((int)GetPName.Blend),
            ReplaceExt = ((int)ExtTexture.ReplaceExt),
        ...
        {
            Filter4Sgis = ((int)SgisTextureFilter4.Filter4Sgis),
        }
        ...
        public enum TextureGenMode
        {
            ...
            ObjectDistanceToPointSgis = ((int)SgisPointLineTexgen.ObjectDistanceToPointSgis),
            ObjectDistanceToLineSgis = ((int)SgisPointLineTexgen.ObjectDistanceToLineSgis),
            SphereMap = ((int)0x2402),
            EyeDistanceToLineSgis = ((int)SgisPointLineTexgen.EyeDistanceToLineSgis),
            EyeDistanceToPointSgis = ((int)SgisPointLineTexgen.EyeDistanceToPointSgis),
        }
        ...
        public enum TextureGenParameter
        {
            ...
            EyePlane = ((int)0x2502),
            EyePointSgis = ((int)SgisPointLineTexgen.EyePointSgis),
            ObjectPointSgis = ((int)SgisPointLineTexgen.ObjectPointSgis),
            TextureGenMode = ((int)0x2500),
            ObjectLineSgis = ((int)SgisPointLineTexgen.ObjectLineSgis),
            EyeLineSgis = ((int)SgisPointLineTexgen.EyeLineSgis),
        }

        public enum TextureMagFilter
        {
            PixelTexGenQCeilingSgix = ((int)SgixImpactPixelTexture.PixelTexGenQCeilingSgix),
            Filter4Sgis = ((int)SgisTextureFilter4.Filter4Sgis),
            LinearDetailSgis = ((int)SgisDetailTexture.LinearDetailSgis),
            LinearSharpenSgis = ((int)SgisSharpenTexture.LinearSharpenSgis),
            Linear = ((int)0x2601),
            LinearSharpenColorSgis = ((int)SgisSharpenTexture.LinearSharpenColorSgis),
            PixelTexGenQRoundSgix = ((int)SgixImpactPixelTexture.PixelTexGenQRoundSgix),
            Nearest = ((int)0x2600),
            LinearSharpenAlphaSgis = ((int)SgisSharpenTexture.LinearSharpenAlphaSgis),
            LinearDetailColorSgis = ((int)SgisDetailTexture.LinearDetailColorSgis),
            PixelTexGenQFloorSgix = ((int)SgixImpactPixelTexture.PixelTexGenQFloorSgix),
            LinearDetailAlphaSgis = ((int)SgisDetailTexture.LinearDetailAlphaSgis),
        }

        public enum TextureMinFilter
        {
            LinearClipmapNearestSgix = ((int)SgixClipmap.LinearClipmapNearestSgix),
            Filter4Sgis = ((int)SgisTextureFilter4.Filter4Sgis),
            LinearClipmapLinearSgix = ((int)SgixClipmap.LinearClipmapLinearSgix),
            NearestMipmapLinear = ((int)0x2702),
            NearestClipmapNearestSgix = ((int)SgixClipmap.NearestClipmapNearestSgix),
            Linear = ((int)TextureMagFilter.Linear),
            ...
            NearestClipmapLinearSgix = ((int)SgixClipmap.NearestClipmapLinearSgix),
        ...
        {
            TextureLodBiasTSgix = ((int)SgixTextureLodBias.TextureLodBiasTSgix),
            TexturePriority = ((int)GetTextureParameter.TexturePriority),
            TextureCompareSgix = ((int)SgixShadow.TextureCompareSgix),
            TextureLodBiasRSgix = ((int)SgixTextureLodBias.TextureLodBiasRSgix),
            QuadTextureSelectSgis = ((int)SgisTextureSelect.QuadTextureSelectSgis),
            TextureCompareOperatorSgix = ((int)SgixShadow.TextureCompareOperatorSgix),
            ...
            TextureMaxClampTSgix = ((int)SgixTextureCoordinateClamp.TextureMaxClampTSgix),
            TextureBorderColor = ((int)GetTextureParameter.TextureBorderColor),
            DualTextureSelectSgis = ((int)SgisTextureSelect.DualTextureSelectSgis),
        }
        ...
        {
            TextureMaxLevelSgis = ((int)SgisTextureLod.TextureMaxLevelSgis),
            TextureRectangleNv = ((int)NvTextureRectangle.TextureRectangleNv),
            ProxyTexture2d = ((int)0x8064),
            ProxyTexture1d = ((int)0x8063),
            TextureMaxLodSgis = ((int)SgisTextureLod.TextureMaxLodSgis),
            Texture3dExt = ((int)ExtTexture3D.Texture3dExt),
            ProxyTexture3dExt = ((int)ExtTexture3D.ProxyTexture3dExt),
            TextureRectangleArb = ((int)ArbTextureRectangle.TextureRectangleArb),
            DetailTexture2dSgis = ((int)SgisDetailTexture.DetailTexture2dSgis),
            Texture4dSgis = ((int)SgisTexture4D.Texture4dSgis),
            Texture2d = ((int)GetPName.Texture2d),
            TextureMinLodSgis = ((int)SgisTextureLod.TextureMinLodSgis),
            Texture1d = ((int)GetPName.Texture1d),
            TextureBaseLevelSgis = ((int)SgisTextureLod.TextureBaseLevelSgis),
            ProxyTexture4dSgis = ((int)SgisTexture4D.ProxyTexture4dSgis),
        }

        public enum TextureWrapMode
        {
            ClampToBorder = ((int)Version13.ClampToBorder),
            ClampToEdge = ((int)Version12.ClampToEdge),
            Clamp = ((int)0x2900),
            Repeat = ((int)0x2901),
        }
        ...
        {
            LuminanceAlphaIccSgix = ((int)SgixIccTexture.LuminanceAlphaIccSgix),
            Rgb4 = ((int)0x804f),
            Intensity16IccSgix = ((int)SgixIccTexture.Intensity16IccSgix),
            Alpha8 = ((int)0x803c),
            LuminanceAlpha = ((int)PixelFormat.LuminanceAlpha),
            DualIntensity4Sgis = ((int)SgisTextureSelect.DualIntensity4Sgis),
            QuadLuminance4Sgis = ((int)SgisTextureSelect.QuadLuminance4Sgis),
            Rgb2Ext = ((int)ExtTexture.Rgb2Ext),
            RgbaIccSgix = ((int)SgixIccTexture.RgbaIccSgix),
            Alpha16IccSgix = ((int)SgixIccTexture.Alpha16IccSgix),
            Luminance12Alpha12 = ((int)0x8047),
            Luminance6Alpha2 = ((int)0x8044),
            Alpha12 = ((int)0x803d),
            QuadLuminance8Sgis = ((int)SgisTextureSelect.QuadLuminance8Sgis),
            Alpha16 = ((int)0x803e),
            Rgba2 = ((int)0x8055),
            ...
            Alpha4 = ((int)0x803b),
            DepthComponent32Sgix = ((int)SgixDepthTexture.DepthComponent32Sgix),
            Luminance16Alpha8IccSgix = ((int)SgixIccTexture.Luminance16Alpha8IccSgix),
            DualIntensity8Sgis = ((int)SgisTextureSelect.DualIntensity8Sgis),
            Rgba8 = ((int)0x8058),
            ...
            DepthComponent16Sgix = ((int)SgixDepthTexture.DepthComponent16Sgix),
            DualAlpha16Sgis = ((int)SgisTextureSelect.DualAlpha16Sgis),
            Luminance12 = ((int)0x8041),
            Luminance16Alpha16 = ((int)0x8048),
            Intensity4 = ((int)0x804a),
            LuminanceIccSgix = ((int)SgixIccTexture.LuminanceIccSgix),
            DualLuminance4Sgis = ((int)SgisTextureSelect.DualLuminance4Sgis),
            DualLuminanceAlpha8Sgis = ((int)SgisTextureSelect.DualLuminanceAlpha8Sgis),
            DualAlpha12Sgis = ((int)SgisTextureSelect.DualAlpha12Sgis),
            Four = ((int)4),
            QuadIntensity4Sgis = ((int)SgisTextureSelect.QuadIntensity4Sgis),
            Rgb5A1 = ((int)0x8057),
            Luminance16IccSgix = ((int)SgixIccTexture.Luminance16IccSgix),
            DualLuminance8Sgis = ((int)SgisTextureSelect.DualLuminance8Sgis),
            Rgba16 = ((int)0x805b),
            RgbIccSgix = ((int)SgixIccTexture.RgbIccSgix),
            Intensity = ((int)0x8049),
            DualLuminance12Sgis = ((int)SgisTextureSelect.DualLuminance12Sgis),
            Rgb10A2 = ((int)0x8059),
            DualAlpha4Sgis = ((int)SgisTextureSelect.DualAlpha4Sgis),
            Rgb5 = ((int)0x8050),
            Luminance = ((int)PixelFormat.Luminance),
            One = ((int)1),
            AlphaIccSgix = ((int)SgixIccTexture.AlphaIccSgix),
            Rgb8 = ((int)0x8051),
            Rgb10 = ((int)0x8052),
            Three = ((int)3),
            Rgb16 = ((int)0x8054),
            Rgba12 = ((int)0x805a),
            DualLuminanceAlpha4Sgis = ((int)SgisTextureSelect.DualLuminanceAlpha4Sgis),
            IntensityIccSgix = ((int)SgixIccTexture.IntensityIccSgix),
            DualAlpha8Sgis = ((int)SgisTextureSelect.DualAlpha8Sgis),
            QuadIntensity8Sgis = ((int)SgisTextureSelect.QuadIntensity8Sgis),
            DualLuminance16Sgis = ((int)SgisTextureSelect.DualLuminance16Sgis),
            Luminance12Alpha4 = ((int)0x8046),
            QuadAlpha8Sgis = ((int)SgisTextureSelect.QuadAlpha8Sgis),
            DepthComponent24Sgix = ((int)SgixDepthTexture.DepthComponent24Sgix),
            DualIntensity12Sgis = ((int)SgisTextureSelect.DualIntensity12Sgis),
            Rgb = ((int)PixelFormat.Rgb),
            Luminance8 = ((int)0x8040),
            DualIntensity16Sgis = ((int)SgisTextureSelect.DualIntensity16Sgis),
            Intensity12 = ((int)0x804c),
            QuadAlpha4Sgis = ((int)SgisTextureSelect.QuadAlpha4Sgis),
        ...
        public enum All
        {
            ...
            ColorTableLuminanceSizeSgi = ((int)0x80de),
            Convolution1dExt = ((int)0x8010),
            BlendEquationRgbExt = ((int)ArbImaging.BlendEquation),
            IndexBits = ((int)0x0d51),
            ...
            WExt = ((int)0x87d8),
            Modelview0Ext = ((int)All.Modelview),
            ...
            OffsetTexture2dBiasNv = ((int)NvTextureShader.OffsetTextureBiasNv),
            ...
            LogicOp = ((int)0x0bf1),
            Reg21Ati = ((int)0x8936),
            OffsetTexture2dScaleNv = ((int)NvTextureShader.OffsetTextureScaleNv),
            ConvolutionBorderMode = ((int)0x8013),
            ...
            ReadFramebufferBindingExt = ((int)ExtFramebufferObject.FramebufferBindingExt),
            Zero = ((int)0),
            ...
            Modelview0MatrixExt = ((int)All.ModelviewMatrix),
            ...
            OffsetTexture2dMatrixNv = ((int)NvTextureShader.OffsetTextureMatrixNv),
            ColorArrayStride = ((int)0x8083),
            Map1Index = ((int)0x0d91),
            ...
            Modelview0StackDepthExt = ((int)All.ModelviewStackDepth),
            ...
            EdgeFlagArrayCountExt = ((int)0x808d),
            PostTextureFilterScaleSgix = ((int)0x817a),
            FogCoordArrayBufferBinding = ((int)Version15.FogCoordinateArrayBufferBinding),
            ...
            BlendEquationRgb = ((int)ArbImaging.BlendEquation),
            LinearDetailSgis = ((int)0x8097),
            LuminanceAlphaIccSgix = ((int)0x8465),
            TextureLodBiasSSgix = ((int)0x818e),
        ...
        {
            ShadowAttenuationExt = ((int)0x834e),
            FragmentDepthExt = ((int)ExtFogCoord.FragmentDepthExt),
            TextureLightExt = ((int)0x8350),
            AttenuationExt = ((int)0x834d),
            TextureMaterialParameterExt = ((int)0x8352),
            FragmentMaterialExt = ((int)0x8349),
        ...
        public enum NvRegisterCombiners
        {
            ...
            Combiner7Nv = ((int)0x8557),
            Combiner4Nv = ((int)0x8554),
            Texture1Arb = ((int)ArbMultitexture.Texture1Arb),
            HalfBiasNegateNv = ((int)0x853b),
            VariableANv = ((int)0x8523),
            CombinerComponentUsageNv = ((int)0x8544),
            CombinerSumOutputNv = ((int)0x854c),
            ...
            Combiner2Nv = ((int)0x8552),
            ConstantColor0Nv = ((int)0x852a),
            Texture0Arb = ((int)ArbMultitexture.Texture0Arb),
            Combiner6Nv = ((int)0x8556),
            DiscardNv = ((int)0x8530),
            VariableFNv = ((int)0x8528),
            ExpandNegateNv = ((int)0x8539),
        ...
        {
            EyeRadialNv = ((int)0x855b),
            EyePlane = ((int)TextureGenParameter.EyePlane),
            EyePlaneAbsoluteNv = ((int)0x855c),
            FogDistanceModeNv = ((int)0x855a),
        }
        ...
        {
            MaxProgramCallDepthNv = ((int)NvFragmentProgram2.MaxProgramCallDepthNv),
            MaxProgramExecInstructionsNv = ((int)NvFragmentProgram2.MaxProgramExecInstructionsNv),
        }

        public enum NvVertexProgram3
        {
            MaxVertexTextureImageUnitsArb = ((int)ArbVertexShader.MaxVertexTextureImageUnitsArb),
        }
        ...
        {
            TriangleStripAdjacencyExt = ((int)NvGeometryProgram4.TriangleStripAdjacencyExt),
            MaxGeometryUniformComponentsExt = ((int)0x8ddf),
            MaxGeometryTotalOutputComponentsExt = ((int)0x8de1),
            FramebufferAttachmentTextureLayerExt = ((int)NvGeometryProgram4.FramebufferAttachmentTextureLayerExt),
            GeometryOutputTypeExt = ((int)NvGeometryProgram4.GeometryOutputTypeExt),
            FramebufferAttachmentLayeredExt = ((int)NvGeometryProgram4.FramebufferAttachmentLayeredExt),
            TrianglesAdjacencyExt = ((int)NvGeometryProgram4.TrianglesAdjacencyExt),
            GeometryInputTypeExt = ((int)NvGeometryProgram4.GeometryInputTypeExt),
            MaxGeometryOutputVerticesExt = ((int)0x8de0),
            GeometryShaderExt = ((int)0x8dd9),
            LineStripAdjacencyExt = ((int)NvGeometryProgram4.LineStripAdjacencyExt),
            MaxVaryingComponentsExt = ((int)0x8b4b),
            FramebufferIncompleteLayerTargetsExt = ((int)NvGeometryProgram4.FramebufferIncompleteLayerTargetsExt),
            MaxVertexVaryingComponentsExt = ((int)0x8dde),
            MaxGeometryTextureImageUnitsExt = ((int)NvGeometryProgram4.MaxGeometryTextureImageUnitsExt),
            MaxGeometryVaryingComponentsExt = ((int)0x8ddd),
            ProgramPointSizeExt = ((int)NvGeometryProgram4.ProgramPointSizeExt),
            FramebufferIncompleteLayerCountExt = ((int)NvGeometryProgram4.FramebufferIncompleteLayerCountExt),
            LinesAdjacencyExt = ((int)NvGeometryProgram4.LinesAdjacencyExt),
            GeometryVerticesOutExt = ((int)NvGeometryProgram4.GeometryVerticesOutExt),
        }
