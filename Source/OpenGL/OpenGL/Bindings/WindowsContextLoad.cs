...
namespace OpenTK.OpenGL.Platform
{
    public partial class WindowsContext
    {
        ...
        public override void Load()
        {
            ...
            GL.DrawRangeElements = (GL.Delegates.DrawRangeElements) GetAddress("glDrawRangeElements", typeof(GL.Delegates.DrawRangeElements));
            GL.ColorTable = (GL.Delegates.ColorTable) GetAddress("glColorTable", typeof(GL.Delegates.ColorTable));
            ...
            GL.GetColorTable = (GL.Delegates.GetColorTable) GetAddress("glGetColorTable", typeof(GL.Delegates.GetColorTable));
            ...
            GL.ColorSubTable = (GL.Delegates.ColorSubTable) GetAddress("glColorSubTable", typeof(GL.Delegates.ColorSubTable));
            GL.CopyColorSubTable = (GL.Delegates.CopyColorSubTable) GetAddress("glCopyColorSubTable", typeof(GL.Delegates.CopyColorSubTable));
            GL.ConvolutionFilter1D = (GL.Delegates.ConvolutionFilter1D) GetAddress("glConvolutionFilter1D", typeof(GL.Delegates.ConvolutionFilter1D));
            GL.ConvolutionFilter2D = (GL.Delegates.ConvolutionFilter2D) GetAddress("glConvolutionFilter2D", typeof(GL.Delegates.ConvolutionFilter2D));
            ...
            GL.GetConvolutionFilter = (GL.Delegates.GetConvolutionFilter) GetAddress("glGetConvolutionFilter", typeof(GL.Delegates.GetConvolutionFilter));
            ...
            GL.GetSeparableFilter = (GL.Delegates.GetSeparableFilter) GetAddress("glGetSeparableFilter", typeof(GL.Delegates.GetSeparableFilter));
            GL.SeparableFilter2D = (GL.Delegates.SeparableFilter2D) GetAddress("glSeparableFilter2D", typeof(GL.Delegates.SeparableFilter2D));
            GL.GetHistogram = (GL.Delegates.GetHistogram) GetAddress("glGetHistogram", typeof(GL.Delegates.GetHistogram));
            ...
            GL.GetMinmax = (GL.Delegates.GetMinmax) GetAddress("glGetMinmax", typeof(GL.Delegates.GetMinmax));
            ...
            GL.FogCoordPointer = (GL.Delegates.FogCoordPointer) GetAddress("glFogCoordPointer", typeof(GL.Delegates.FogCoordPointer));
            ...
            GL.SecondaryColorPointer = (GL.Delegates.SecondaryColorPointer) GetAddress("glSecondaryColorPointer", typeof(GL.Delegates.SecondaryColorPointer));
