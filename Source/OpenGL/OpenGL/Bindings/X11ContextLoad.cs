...
namespace OpenTK.OpenGL.Platform
{
    public partial class X11Context
    {
        ...
        internal class Imports
        {
            ...
            [DllImport(_dll_name, EntryPoint = "glGenQueries")]
            public static extern void GenQueries(int n, out uint[] ids);

            [DllImport(_dll_name, EntryPoint = "glDeleteQueries")]
            public static extern void DeleteQueries(int n, uint[] ids);

            [DllImport(_dll_name, EntryPoint = "glIsQuery")]
            public static extern bool IsQuery(uint id);

            [DllImport(_dll_name, EntryPoint = "glBeginQuery")]
            public static extern void BeginQuery(uint target, uint id);

            [DllImport(_dll_name, EntryPoint = "glEndQuery")]
            public static extern void EndQuery(uint target);

            [DllImport(_dll_name, EntryPoint = "glGetQueryiv")]
            public static extern void GetQueryiv(uint target, uint pname, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetQueryObjectiv")]
            public static extern void GetQueryObjectiv(uint id, uint pname, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetQueryObjectuiv")]
            public static extern void GetQueryObjectuiv(uint id, uint pname, out uint[] parameters);

            [DllImport(_dll_name, EntryPoint = "glBindBuffer")]
            public static extern void BindBuffer(uint target, uint buffer);

            [DllImport(_dll_name, EntryPoint = "glDeleteBuffers")]
            public static extern void DeleteBuffers(int n, uint[] buffers);

            [DllImport(_dll_name, EntryPoint = "glGenBuffers")]
            public static extern void GenBuffers(int n, out uint[] buffers);

            [DllImport(_dll_name, EntryPoint = "glIsBuffer")]
            public static extern bool IsBuffer(uint buffer);

            [DllImport(_dll_name, EntryPoint = "glBufferData")]
            public static extern void BufferData(uint target, IntPtr size, [MarshalAs(UnmanagedType.AsAny)] object data, uint usage);

            [DllImport(_dll_name, EntryPoint = "glBufferSubData")]
            public static extern void BufferSubData(uint target, IntPtr offset, IntPtr size, [MarshalAs(UnmanagedType.AsAny)] object data);

            [DllImport(_dll_name, EntryPoint = "glGetBufferSubData")]
            public static extern void GetBufferSubData(uint target, IntPtr offset, IntPtr size, out object data);

            [DllImport(_dll_name, EntryPoint = "glMapBuffer_")]
            public static extern IntPtr MapBuffer_(uint target, uint access);

            [DllImport(_dll_name, EntryPoint = "glUnmapBuffer")]
            public static extern bool UnmapBuffer(uint target);

            [DllImport(_dll_name, EntryPoint = "glGetBufferParameteriv")]
            public static extern void GetBufferParameteriv(uint target, uint pname, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetBufferPointerv")]
            public static extern void GetBufferPointerv(uint target, uint pname, out object parameters);

            [DllImport(_dll_name, EntryPoint = "glBlendEquationSeparate")]
            public static extern void BlendEquationSeparate(Enums.BlendEquationModeEXT modeRGB, Enums.BlendEquationModeEXT modeAlpha);

            [DllImport(_dll_name, EntryPoint = "glDrawBuffers")]
            public static extern void DrawBuffers(int n, Enums.DrawBufferMode[] bufs);

            [DllImport(_dll_name, EntryPoint = "glStencilOpSeparate")]
            public static extern void StencilOpSeparate(uint face, Enums.StencilOp sfail, Enums.StencilOp dpfail, Enums.StencilOp dppass);

            [DllImport(_dll_name, EntryPoint = "glStencilFuncSeparate")]
            public static extern void StencilFuncSeparate(Enums.StencilFunction frontfunc, Enums.StencilFunction backfunc, int reference, uint mask);

            [DllImport(_dll_name, EntryPoint = "glStencilMaskSeparate")]
            public static extern void StencilMaskSeparate(uint face, uint mask);

            [DllImport(_dll_name, EntryPoint = "glAttachShader")]
            public static extern void AttachShader(uint program, uint shader);

            [DllImport(_dll_name, EntryPoint = "glBindAttribLocation")]
            public static extern void BindAttribLocation(uint program, uint index, char[] name);

            [DllImport(_dll_name, EntryPoint = "glCompileShader")]
            public static extern void CompileShader(uint shader);

            [DllImport(_dll_name, EntryPoint = "glCreateProgram")]
            public static extern uint CreateProgram();

            [DllImport(_dll_name, EntryPoint = "glCreateShader")]
            public static extern uint CreateShader(uint type);

            [DllImport(_dll_name, EntryPoint = "glDeleteProgram")]
            public static extern void DeleteProgram(uint program);

            [DllImport(_dll_name, EntryPoint = "glDeleteShader")]
            public static extern void DeleteShader(uint shader);

            [DllImport(_dll_name, EntryPoint = "glDetachShader")]
            public static extern void DetachShader(uint program, uint shader);

            [DllImport(_dll_name, EntryPoint = "glDisableVertexAttribArray")]
            public static extern void DisableVertexAttribArray(uint index);

            [DllImport(_dll_name, EntryPoint = "glEnableVertexAttribArray")]
            public static extern void EnableVertexAttribArray(uint index);

            [DllImport(_dll_name, EntryPoint = "glGetActiveAttrib")]
            public static extern void GetActiveAttrib(uint program, uint index, int bufSize, out int[] length, out int[] size, out uint[] type, out char[] name);

            [DllImport(_dll_name, EntryPoint = "glGetActiveUniform")]
            public static extern void GetActiveUniform(uint program, uint index, int bufSize, out int[] length, out int[] size, out uint[] type, out char[] name);

            [DllImport(_dll_name, EntryPoint = "glGetAttachedShaders")]
            public static extern void GetAttachedShaders(uint program, int maxCount, out int[] count, out uint[] obj);

            [DllImport(_dll_name, EntryPoint = "glGetAttribLocation")]
            public static extern int GetAttribLocation(uint program, char[] name);

            [DllImport(_dll_name, EntryPoint = "glGetProgramiv")]
            public static extern void GetProgramiv(uint program, uint pname, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetProgramInfoLog")]
            public static extern void GetProgramInfoLog(uint program, int bufSize, out int[] length, out char[] infoLog);

            [DllImport(_dll_name, EntryPoint = "glGetShaderiv")]
            public static extern void GetShaderiv(uint shader, uint pname, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetShaderInfoLog")]
            public static extern void GetShaderInfoLog(uint shader, int bufSize, out int[] length, out char[] infoLog);

            [DllImport(_dll_name, EntryPoint = "glGetShaderSource")]
            public static extern void GetShaderSource(uint shader, int bufSize, out int[] length, out char[] source);

            [DllImport(_dll_name, EntryPoint = "glGetUniformLocation")]
            public static extern int GetUniformLocation(uint program, char[] name);

            [DllImport(_dll_name, EntryPoint = "glGetUniformfv")]
            public static extern void GetUniformfv(uint program, int location, out float[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetUniformiv")]
            public static extern void GetUniformiv(uint program, int location, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetVertexAttribdv")]
            public static extern void GetVertexAttribdv(uint index, uint pname, out double[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetVertexAttribfv")]
            public static extern void GetVertexAttribfv(uint index, uint pname, out float[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetVertexAttribiv")]
            public static extern void GetVertexAttribiv(uint index, uint pname, out int[] parameters);

            [DllImport(_dll_name, EntryPoint = "glGetVertexAttribPointerv")]
            public static extern void GetVertexAttribPointerv(uint index, uint pname, out object pointer);

            [DllImport(_dll_name, EntryPoint = "glIsProgram")]
            public static extern bool IsProgram(uint program);

            [DllImport(_dll_name, EntryPoint = "glIsShader")]
            public static extern bool IsShader(uint shader);

            [DllImport(_dll_name, EntryPoint = "glLinkProgram")]
            public static extern void LinkProgram(uint program);

            [DllImport(_dll_name, EntryPoint = "glShaderSource")]
            public static extern void ShaderSource(uint shader, int count, string[] @string, int[] length);

            [DllImport(_dll_name, EntryPoint = "glUseProgram")]
            public static extern void UseProgram(uint program);

            [DllImport(_dll_name, EntryPoint = "glUniform1f")]
            public static extern void Uniform1f(int location, float v0);

            [DllImport(_dll_name, EntryPoint = "glUniform2f")]
            public static extern void Uniform2f(int location, float v0, float v1);

            [DllImport(_dll_name, EntryPoint = "glUniform3f")]
            public static extern void Uniform3f(int location, float v0, float v1, float v2);

            [DllImport(_dll_name, EntryPoint = "glUniform4f")]
            public static extern void Uniform4f(int location, float v0, float v1, float v2, float v3);

            [DllImport(_dll_name, EntryPoint = "glUniform1i")]
            public static extern void Uniform1i(int location, int v0);

            [DllImport(_dll_name, EntryPoint = "glUniform2i")]
            public static extern void Uniform2i(int location, int v0, int v1);

            [DllImport(_dll_name, EntryPoint = "glUniform3i")]
            public static extern void Uniform3i(int location, int v0, int v1, int v2);

            [DllImport(_dll_name, EntryPoint = "glUniform4i")]
            public static extern void Uniform4i(int location, int v0, int v1, int v2, int v3);

            [DllImport(_dll_name, EntryPoint = "glUniform1fv")]
            public static extern void Uniform1fv(int location, int count, float[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform2fv")]
            public static extern void Uniform2fv(int location, int count, float[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform3fv")]
            public static extern void Uniform3fv(int location, int count, float[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform4fv")]
            public static extern void Uniform4fv(int location, int count, float[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform1iv")]
            public static extern void Uniform1iv(int location, int count, int[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform2iv")]
            public static extern void Uniform2iv(int location, int count, int[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform3iv")]
            public static extern void Uniform3iv(int location, int count, int[] value);

            [DllImport(_dll_name, EntryPoint = "glUniform4iv")]
            public static extern void Uniform4iv(int location, int count, int[] value);

            [DllImport(_dll_name, EntryPoint = "glUniformMatrix2fv")]
            public static extern void UniformMatrix2fv(int location, int count, bool transpose, float[] value);

            [DllImport(_dll_name, EntryPoint = "glUniformMatrix3fv")]
            public static extern void UniformMatrix3fv(int location, int count, bool transpose, float[] value);

            [DllImport(_dll_name, EntryPoint = "glUniformMatrix4fv")]
            public static extern void UniformMatrix4fv(int location, int count, bool transpose, float[] value);

            [DllImport(_dll_name, EntryPoint = "glValidateProgram")]
            public static extern void ValidateProgram(uint program);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib1d")]
            public static extern void VertexAttrib1d(uint index, double x);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib1dv")]
            public static extern void VertexAttrib1dv(uint index, double[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib1f")]
            public static extern void VertexAttrib1f(uint index, float x);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib1fv")]
            public static extern void VertexAttrib1fv(uint index, float[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib1s")]
            public static extern void VertexAttrib1s(uint index, short x);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib1sv")]
            public static extern void VertexAttrib1sv(uint index, short[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib2d")]
            public static extern void VertexAttrib2d(uint index, double x, double y);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib2dv")]
            public static extern void VertexAttrib2dv(uint index, double[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib2f")]
            public static extern void VertexAttrib2f(uint index, float x, float y);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib2fv")]
            public static extern void VertexAttrib2fv(uint index, float[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib2s")]
            public static extern void VertexAttrib2s(uint index, short x, short y);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib2sv")]
            public static extern void VertexAttrib2sv(uint index, short[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib3d")]
            ...
            [DllImport(_dll_name, EntryPoint = "glVertexAttrib3f")]
            public static extern void VertexAttrib3f(uint index, float x, float y, float z);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib3fv")]
            public static extern void VertexAttrib3fv(uint index, float[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib3s")]
            public static extern void VertexAttrib3s(uint index, short x, short y, short z);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib3sv")]
            public static extern void VertexAttrib3sv(uint index, short[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Nbv")]
            public static extern void VertexAttrib4Nbv(uint index, byte[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Niv")]
            public static extern void VertexAttrib4Niv(uint index, int[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Nsv")]
            public static extern void VertexAttrib4Nsv(uint index, short[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Nub")]
            public static extern void VertexAttrib4Nub(uint index, byte x, byte y, byte z, byte w);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Nubv")]
            public static extern void VertexAttrib4Nubv(uint index, byte[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Nuiv")]
            public static extern void VertexAttrib4Nuiv(uint index, uint[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4Nusv")]
            public static extern void VertexAttrib4Nusv(uint index, ushort[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4bv")]
            public static extern void VertexAttrib4bv(uint index, byte[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4d")]
            public static extern void VertexAttrib4d(uint index, double x, double y, double z, double w);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4dv")]
            public static extern void VertexAttrib4dv(uint index, double[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4f")]
            public static extern void VertexAttrib4f(uint index, float x, float y, float z, float w);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4fv")]
            public static extern void VertexAttrib4fv(uint index, float[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4iv")]
            public static extern void VertexAttrib4iv(uint index, int[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4s")]
            public static extern void VertexAttrib4s(uint index, short x, short y, short z, short w);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4sv")]
            public static extern void VertexAttrib4sv(uint index, short[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4ubv")]
            public static extern void VertexAttrib4ubv(uint index, byte[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4uiv")]
            public static extern void VertexAttrib4uiv(uint index, uint[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttrib4usv")]
            public static extern void VertexAttrib4usv(uint index, ushort[] v);

            [DllImport(_dll_name, EntryPoint = "glVertexAttribPointer")]
            public static extern void VertexAttribPointer(uint index, int size, uint type, bool normalized, int stride, [MarshalAs(UnmanagedType.AsAny)] object pointer);
        ...
        public override void Load()
        {
            ...
            GL.GenQueries = new GL.Delegates.GenQueries(Imports.GenQueries);
            GL.DeleteQueries = new GL.Delegates.DeleteQueries(Imports.DeleteQueries);
            GL.IsQuery = new GL.Delegates.IsQuery(Imports.IsQuery);
            GL.BeginQuery = new GL.Delegates.BeginQuery(Imports.BeginQuery);
            GL.EndQuery = new GL.Delegates.EndQuery(Imports.EndQuery);
            GL.GetQueryiv = new GL.Delegates.GetQueryiv(Imports.GetQueryiv);
            GL.GetQueryObjectiv = new GL.Delegates.GetQueryObjectiv(Imports.GetQueryObjectiv);
            GL.GetQueryObjectuiv = new GL.Delegates.GetQueryObjectuiv(Imports.GetQueryObjectuiv);
            GL.BindBuffer = new GL.Delegates.BindBuffer(Imports.BindBuffer);
            GL.DeleteBuffers = new GL.Delegates.DeleteBuffers(Imports.DeleteBuffers);
            GL.GenBuffers = new GL.Delegates.GenBuffers(Imports.GenBuffers);
            GL.IsBuffer = new GL.Delegates.IsBuffer(Imports.IsBuffer);
            GL.BufferData = new GL.Delegates.BufferData(Imports.BufferData);
            GL.BufferSubData = new GL.Delegates.BufferSubData(Imports.BufferSubData);
            GL.GetBufferSubData = new GL.Delegates.GetBufferSubData(Imports.GetBufferSubData);
            GL.MapBuffer_ = new GL.Delegates.MapBuffer_(Imports.MapBuffer_);
            GL.UnmapBuffer = new GL.Delegates.UnmapBuffer(Imports.UnmapBuffer);
            GL.GetBufferParameteriv = new GL.Delegates.GetBufferParameteriv(Imports.GetBufferParameteriv);
            GL.GetBufferPointerv = new GL.Delegates.GetBufferPointerv(Imports.GetBufferPointerv);
            GL.BlendEquationSeparate = new GL.Delegates.BlendEquationSeparate(Imports.BlendEquationSeparate);
            GL.DrawBuffers = new GL.Delegates.DrawBuffers(Imports.DrawBuffers);
            GL.StencilOpSeparate = new GL.Delegates.StencilOpSeparate(Imports.StencilOpSeparate);
            GL.StencilFuncSeparate = new GL.Delegates.StencilFuncSeparate(Imports.StencilFuncSeparate);
            GL.StencilMaskSeparate = new GL.Delegates.StencilMaskSeparate(Imports.StencilMaskSeparate);
            GL.AttachShader = new GL.Delegates.AttachShader(Imports.AttachShader);
            GL.BindAttribLocation = new GL.Delegates.BindAttribLocation(Imports.BindAttribLocation);
            GL.CompileShader = new GL.Delegates.CompileShader(Imports.CompileShader);
            GL.CreateProgram = new GL.Delegates.CreateProgram(Imports.CreateProgram);
            GL.CreateShader = new GL.Delegates.CreateShader(Imports.CreateShader);
            GL.DeleteProgram = new GL.Delegates.DeleteProgram(Imports.DeleteProgram);
            GL.DeleteShader = new GL.Delegates.DeleteShader(Imports.DeleteShader);
            GL.DetachShader = new GL.Delegates.DetachShader(Imports.DetachShader);
            GL.DisableVertexAttribArray = new GL.Delegates.DisableVertexAttribArray(Imports.DisableVertexAttribArray);
            GL.EnableVertexAttribArray = new GL.Delegates.EnableVertexAttribArray(Imports.EnableVertexAttribArray);
            GL.GetActiveAttrib = new GL.Delegates.GetActiveAttrib(Imports.GetActiveAttrib);
            GL.GetActiveUniform = new GL.Delegates.GetActiveUniform(Imports.GetActiveUniform);
            GL.GetAttachedShaders = new GL.Delegates.GetAttachedShaders(Imports.GetAttachedShaders);
            GL.GetAttribLocation = new GL.Delegates.GetAttribLocation(Imports.GetAttribLocation);
            GL.GetProgramiv = new GL.Delegates.GetProgramiv(Imports.GetProgramiv);
            GL.GetProgramInfoLog = new GL.Delegates.GetProgramInfoLog(Imports.GetProgramInfoLog);
            GL.GetShaderiv = new GL.Delegates.GetShaderiv(Imports.GetShaderiv);
            GL.GetShaderInfoLog = new GL.Delegates.GetShaderInfoLog(Imports.GetShaderInfoLog);
            GL.GetShaderSource = new GL.Delegates.GetShaderSource(Imports.GetShaderSource);
            GL.GetUniformLocation = new GL.Delegates.GetUniformLocation(Imports.GetUniformLocation);
            GL.GetUniformfv = new GL.Delegates.GetUniformfv(Imports.GetUniformfv);
            GL.GetUniformiv = new GL.Delegates.GetUniformiv(Imports.GetUniformiv);
            GL.GetVertexAttribdv = new GL.Delegates.GetVertexAttribdv(Imports.GetVertexAttribdv);
            GL.GetVertexAttribfv = new GL.Delegates.GetVertexAttribfv(Imports.GetVertexAttribfv);
            GL.GetVertexAttribiv = new GL.Delegates.GetVertexAttribiv(Imports.GetVertexAttribiv);
            GL.GetVertexAttribPointerv = new GL.Delegates.GetVertexAttribPointerv(Imports.GetVertexAttribPointerv);
            GL.IsProgram = new GL.Delegates.IsProgram(Imports.IsProgram);
            GL.IsShader = new GL.Delegates.IsShader(Imports.IsShader);
            GL.LinkProgram = new GL.Delegates.LinkProgram(Imports.LinkProgram);
            GL.ShaderSource = new GL.Delegates.ShaderSource(Imports.ShaderSource);
            GL.UseProgram = new GL.Delegates.UseProgram(Imports.UseProgram);
            GL.Uniform1f = new GL.Delegates.Uniform1f(Imports.Uniform1f);
            GL.Uniform2f = new GL.Delegates.Uniform2f(Imports.Uniform2f);
            GL.Uniform3f = new GL.Delegates.Uniform3f(Imports.Uniform3f);
            GL.Uniform4f = new GL.Delegates.Uniform4f(Imports.Uniform4f);
            GL.Uniform1i = new GL.Delegates.Uniform1i(Imports.Uniform1i);
            GL.Uniform2i = new GL.Delegates.Uniform2i(Imports.Uniform2i);
            GL.Uniform3i = new GL.Delegates.Uniform3i(Imports.Uniform3i);
            GL.Uniform4i = new GL.Delegates.Uniform4i(Imports.Uniform4i);
            GL.Uniform1fv = new GL.Delegates.Uniform1fv(Imports.Uniform1fv);
            GL.Uniform2fv = new GL.Delegates.Uniform2fv(Imports.Uniform2fv);
            GL.Uniform3fv = new GL.Delegates.Uniform3fv(Imports.Uniform3fv);
            GL.Uniform4fv = new GL.Delegates.Uniform4fv(Imports.Uniform4fv);
            GL.Uniform1iv = new GL.Delegates.Uniform1iv(Imports.Uniform1iv);
            GL.Uniform2iv = new GL.Delegates.Uniform2iv(Imports.Uniform2iv);
            GL.Uniform3iv = new GL.Delegates.Uniform3iv(Imports.Uniform3iv);
            GL.Uniform4iv = new GL.Delegates.Uniform4iv(Imports.Uniform4iv);
            GL.UniformMatrix2fv = new GL.Delegates.UniformMatrix2fv(Imports.UniformMatrix2fv);
            GL.UniformMatrix3fv = new GL.Delegates.UniformMatrix3fv(Imports.UniformMatrix3fv);
            GL.UniformMatrix4fv = new GL.Delegates.UniformMatrix4fv(Imports.UniformMatrix4fv);
            GL.ValidateProgram = new GL.Delegates.ValidateProgram(Imports.ValidateProgram);
            GL.VertexAttrib1d = new GL.Delegates.VertexAttrib1d(Imports.VertexAttrib1d);
            GL.VertexAttrib1dv = new GL.Delegates.VertexAttrib1dv(Imports.VertexAttrib1dv);
            GL.VertexAttrib1f = new GL.Delegates.VertexAttrib1f(Imports.VertexAttrib1f);
            GL.VertexAttrib1fv = new GL.Delegates.VertexAttrib1fv(Imports.VertexAttrib1fv);
            GL.VertexAttrib1s = new GL.Delegates.VertexAttrib1s(Imports.VertexAttrib1s);
            GL.VertexAttrib1sv = new GL.Delegates.VertexAttrib1sv(Imports.VertexAttrib1sv);
            GL.VertexAttrib2d = new GL.Delegates.VertexAttrib2d(Imports.VertexAttrib2d);
            GL.VertexAttrib2dv = new GL.Delegates.VertexAttrib2dv(Imports.VertexAttrib2dv);
            GL.VertexAttrib2f = new GL.Delegates.VertexAttrib2f(Imports.VertexAttrib2f);
            GL.VertexAttrib2fv = new GL.Delegates.VertexAttrib2fv(Imports.VertexAttrib2fv);
            GL.VertexAttrib2s = new GL.Delegates.VertexAttrib2s(Imports.VertexAttrib2s);
            GL.VertexAttrib2sv = new GL.Delegates.VertexAttrib2sv(Imports.VertexAttrib2sv);
            GL.VertexAttrib3d = new GL.Delegates.VertexAttrib3d(Imports.VertexAttrib3d);
            GL.VertexAttrib3dv = new GL.Delegates.VertexAttrib3dv(Imports.VertexAttrib3dv);
            GL.VertexAttrib3f = new GL.Delegates.VertexAttrib3f(Imports.VertexAttrib3f);
            GL.VertexAttrib3fv = new GL.Delegates.VertexAttrib3fv(Imports.VertexAttrib3fv);
            GL.VertexAttrib3s = new GL.Delegates.VertexAttrib3s(Imports.VertexAttrib3s);
            GL.VertexAttrib3sv = new GL.Delegates.VertexAttrib3sv(Imports.VertexAttrib3sv);
            GL.VertexAttrib4Nbv = new GL.Delegates.VertexAttrib4Nbv(Imports.VertexAttrib4Nbv);
            GL.VertexAttrib4Niv = new GL.Delegates.VertexAttrib4Niv(Imports.VertexAttrib4Niv);
            GL.VertexAttrib4Nsv = new GL.Delegates.VertexAttrib4Nsv(Imports.VertexAttrib4Nsv);
            GL.VertexAttrib4Nub = new GL.Delegates.VertexAttrib4Nub(Imports.VertexAttrib4Nub);
            GL.VertexAttrib4Nubv = new GL.Delegates.VertexAttrib4Nubv(Imports.VertexAttrib4Nubv);
            GL.VertexAttrib4Nuiv = new GL.Delegates.VertexAttrib4Nuiv(Imports.VertexAttrib4Nuiv);
            GL.VertexAttrib4Nusv = new GL.Delegates.VertexAttrib4Nusv(Imports.VertexAttrib4Nusv);
            GL.VertexAttrib4bv = new GL.Delegates.VertexAttrib4bv(Imports.VertexAttrib4bv);
            GL.VertexAttrib4d = new GL.Delegates.VertexAttrib4d(Imports.VertexAttrib4d);
            GL.VertexAttrib4dv = new GL.Delegates.VertexAttrib4dv(Imports.VertexAttrib4dv);
            GL.VertexAttrib4f = new GL.Delegates.VertexAttrib4f(Imports.VertexAttrib4f);
            GL.VertexAttrib4fv = new GL.Delegates.VertexAttrib4fv(Imports.VertexAttrib4fv);
            GL.VertexAttrib4iv = new GL.Delegates.VertexAttrib4iv(Imports.VertexAttrib4iv);
            GL.VertexAttrib4s = new GL.Delegates.VertexAttrib4s(Imports.VertexAttrib4s);
            GL.VertexAttrib4sv = new GL.Delegates.VertexAttrib4sv(Imports.VertexAttrib4sv);
            GL.VertexAttrib4ubv = new GL.Delegates.VertexAttrib4ubv(Imports.VertexAttrib4ubv);
            GL.VertexAttrib4uiv = new GL.Delegates.VertexAttrib4uiv(Imports.VertexAttrib4uiv);
            GL.VertexAttrib4usv = new GL.Delegates.VertexAttrib4usv(Imports.VertexAttrib4usv);
            GL.VertexAttribPointer = new GL.Delegates.VertexAttribPointer(Imports.VertexAttribPointer);
        CoreLoaded = true;
        }
